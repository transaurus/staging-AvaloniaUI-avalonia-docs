...
Source:[ControlAutomationPeer.cs](https://github.com/AvaloniaUI/Avalonia/blob/649891b3481c6e1581f42efc8f5f106f86ef6119/src/Avalonia.Controls/Automation/Peers/ControlAutomationPeer.cs)
...
Inheritance: object -> [AutomationPeer](automationpeer) -> ControlAutomationPeer

Derived types: [ContentControlAutomationPeer](contentcontrolautomationpeer), [ContentPageAutomationPeer](contentpageautomationpeer), [DatePickerAutomationPeer](datepickerautomationpeer), [DrawerPageAutomationPeer](drawerpageautomationpeer), [ItemsControlAutomationPeer](itemscontrolautomationpeer), [MenuItemAutomationPeer](menuitemautomationpeer), [NavigationPageAutomationPeer](navigationpageautomationpeer), [NoneAutomationPeer](noneautomationpeer), [PopupAutomationPeer](popupautomationpeer), [RangeBaseAutomationPeer](rangebaseautomationpeer), [ScrollViewerAutomationPeer](scrollviewerautomationpeer), [TabbedPageAutomationPeer](tabbedpageautomationpeer), [TextBlockAutomationPeer](textblockautomationpeer), [TextBoxAutomationPeer](textboxautomationpeer), [TimePickerAutomationPeer](timepickerautomationpeer), [WindowBaseAutomationPeer](windowbaseautomationpeer), [ExpanderAutomationPeer](../../controls/automation/peers/expanderautomationpeer), [ImageAutomationPeer](../../controls/automation/peers/imageautomationpeer), [LabelAutomationPeer](../../controls/automation/peers/labelautomationpeer), [ThumbAutomationPeer](../../controls/automation/peers/thumbautomationpeer), [UserControlAutomationPeer](../../controls/automation/peers/usercontrolautomationpeer)
...
### ControlAutomationPeer Constructor[​](#controlautomationpeer-constructor "Direct link to ControlAutomationPeer Constructor")
...
### CreatePeerForElement Method[​](#createpeerforelement-method "Direct link to CreatePeerForElement Method")

Gets the [Avalonia.Automation.Peers.AutomationPeer](xref:Avalonia.Automation.Peers.AutomationPeer) for a [Avalonia.Controls.Control](xref:Avalonia.Controls.Control), creating it if necessary.
...
### FromElement Method[​](#fromelement-method "Direct link to FromElement Method")
