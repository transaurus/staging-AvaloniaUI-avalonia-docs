...
Source:[Border.cs](https://github.com/AvaloniaUI/Avalonia/blob/649891b3481c6e1581f42efc8f5f106f86ef6119/src/Avalonia.Controls/Border.cs)
...
Inheritance: object -> [AvaloniaObject](../avaloniaobject) -> [Animatable](../animation/animatable) -> [StyledElement](../styledelement) -> [Visual](../visual) -> [Layoutable](../layout/layoutable) -> [Interactive](../interactivity/interactive) -> [InputElement](../input/inputelement) -> [Control](control) -> [Decorator](decorator) -> Border

Derived types:[TreeDataGridPresenterBase\<TItem>](primitives/treedatagridpresenterbase-1)

Implements: IVisualWithRoundRectClip
...
### Border Constructor[​](#border-constructor "Direct link to Border Constructor")
...
| [Child](/api/avalonia/controls/decorator.md#uid-b637e8f88d)                 | Gets or sets the decorated control. Inherited from [Decorator](/api/avalonia/controls/decorator.md).                                                                                                                                              |
| [Padding](/api/avalonia/controls/decorator.md#uid-a9e4741de0)               | Gets or sets the padding to place around the [Avalonia.Controls.Decorator.Child](xref:Avalonia.Controls.Decorator.Child) control. Inherited from [Decorator](/api/avalonia/controls/decorator.md).                                                |
...
### ClipToBoundsRadius Property[​](#cliptoboundsradius-property "Direct link to ClipToBoundsRadius Property")
...
| [ChildProperty](/api/avalonia/controls/decorator.md#uid-a30ba30cb8)                       | Defines the [Avalonia.Controls.Decorator.Child](xref:Avalonia.Controls.Decorator.Child) property. Inherited from [Decorator](/api/avalonia/controls/decorator.md).                                                   |
| [PaddingProperty](/api/avalonia/controls/decorator.md#uid-f15a902427)                     | Defines the [Avalonia.Controls.Decorator.Padding](xref:Avalonia.Controls.Decorator.Padding) property. Inherited from [Decorator](/api/avalonia/controls/decorator.md).                                               |
