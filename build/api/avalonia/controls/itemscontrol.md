...
Source:[ItemsControl.cs](https://github.com/AvaloniaUI/Avalonia/blob/649891b3481c6e1581f42efc8f5f106f86ef6119/src/Avalonia.Controls/ItemsControl.cs)
...
Inheritance: object -> [AvaloniaObject](../avaloniaobject) -> [Animatable](../animation/animatable) -> [StyledElement](../styledelement) -> [Visual](../visual) -> [Layoutable](../layout/layoutable) -> [Interactive](../interactivity/interactive) -> [InputElement](../input/inputelement) -> [Control](control) -> [TemplatedControl](primitives/templatedcontrol) -> ItemsControl

Derived types: [HeaderedItemsControl](primitives/headereditemscontrol), [SelectingItemsControl](primitives/selectingitemscontrol), [TreeView](treeview)
...
### ItemsControl Constructor[​](#itemscontrol-constructor "Direct link to ItemsControl Constructor")
...
### ContainerFromIndex Method[​](#containerfromindex-method "Direct link to ContainerFromIndex Method")
...
### ContainerFromItem Method[​](#containerfromitem-method "Direct link to ContainerFromItem Method")
...
### GetRealizedContainers Method[​](#getrealizedcontainers-method "Direct link to GetRealizedContainers Method")
...
### IndexFromContainer Method[​](#indexfromcontainer-method "Direct link to IndexFromContainer Method")
...
### ItemFromContainer Method[​](#itemfromcontainer-method "Direct link to ItemFromContainer Method")
...
### ScrollIntoView overloads[​](#scrollintoview-overloads "Direct link to ScrollIntoView overloads")

#### ScrollIntoView Method[​](#scrollintoview-method "Direct link to ScrollIntoView Method")
...
#### ScrollIntoView Method[​](#scrollintoview-method-1 "Direct link to ScrollIntoView Method")
...
### DisplayMemberBinding Property[​](#displaymemberbinding-property "Direct link to DisplayMemberBinding Property")
...
### ItemContainerGenerator Property[​](#itemcontainergenerator-property "Direct link to ItemContainerGenerator Property")
...
### ItemCount Property[​](#itemcount-property "Direct link to ItemCount Property")
...
You use either the [Avalonia.Controls.ItemsControl.Items](xref:Avalonia.Controls.ItemsControl.Items) or the [Avalonia.Controls.ItemsControl.ItemsSource](xref:Avalonia.Controls.ItemsControl.ItemsSource) property to specify the collection that should be used to generate the content of your [Avalonia.Controls.ItemsControl](xref:Avalonia.Controls.ItemsControl). When the [Avalonia.Controls.ItemsControl.ItemsSource](xref:Avalonia.Controls.ItemsControl.ItemsSource) property is set, the [Avalonia.Controls.ItemsControl.Items](xref:Avalonia.Controls.ItemsControl.Items) collection is made read-only and fixed-size.

When [Avalonia.Controls.ItemsControl.ItemsSource](xref:Avalonia.Controls.ItemsControl.ItemsSource) is in use, setting the [Avalonia.Controls.ItemsControl.ItemsSource](xref:Avalonia.Controls.ItemsControl.ItemsSource) property to null removes the collection and restores usage to [Avalonia.Controls.ItemsControl.Items](xref:Avalonia.Controls.ItemsControl.Items), which will be an empty [Avalonia.Controls.ItemCollection](xref:Avalonia.Controls.ItemCollection).

### ItemsPanel Property[​](#itemspanel-property "Direct link to ItemsPanel Property")
...
### ItemsPanelRoot Property[​](#itemspanelroot-property "Direct link to ItemsPanelRoot Property")
...
A common scenario is to use an [Avalonia.Controls.ItemsControl](xref:Avalonia.Controls.ItemsControl) such as a [Avalonia.Controls.ListBox](xref:Avalonia.Controls.ListBox) to display a data collection, or to bind an [Avalonia.Controls.ItemsControl](xref:Avalonia.Controls.ItemsControl) to a collection object. To bind an [Avalonia.Controls.ItemsControl](xref:Avalonia.Controls.ItemsControl) to a collection object, use the [Avalonia.Controls.ItemsControl.ItemsSource](xref:Avalonia.Controls.ItemsControl.ItemsSource) property.

When the [Avalonia.Controls.ItemsControl.ItemsSource](xref:Avalonia.Controls.ItemsControl.ItemsSource) property is set, the [Avalonia.Controls.ItemsControl.Items](xref:Avalonia.Controls.ItemsControl.Items) collection is made read-only and fixed-size.
...
### ItemsView Property[​](#itemsview-property "Direct link to ItemsView Property")
...
### Presenter Property[​](#presenter-property "Direct link to Presenter Property")
...
### DisplayMemberBindingProperty Field[​](#displaymemberbindingproperty-field "Direct link to DisplayMemberBindingProperty Field")
...
### ItemCountProperty Field[​](#itemcountproperty-field "Direct link to ItemCountProperty Field")
...
### ItemsPanelProperty Field[​](#itemspanelproperty-field "Direct link to ItemsPanelProperty Field")
...
### ContainerClearing Event[​](#containerclearing-event "Direct link to ContainerClearing Event")
...
### ContainerIndexChanged Event[​](#containerindexchanged-event "Direct link to ContainerIndexChanged Event")
...
### ContainerPrepared Event[​](#containerprepared-event "Direct link to ContainerPrepared Event")
...
### PreparingContainer Event[​](#preparingcontainer-event "Direct link to PreparingContainer Event")
