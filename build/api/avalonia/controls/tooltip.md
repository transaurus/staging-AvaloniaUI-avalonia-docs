...
Source:[ToolTip.cs](https://github.com/AvaloniaUI/Avalonia/blob/649891b3481c6e1581f42efc8f5f106f86ef6119/src/Avalonia.Controls/ToolTip.cs)
...
You will probably not want to create a [Avalonia.Controls.ToolTip](xref:Avalonia.Controls.ToolTip) control directly: if added to the tree it will act as a simple [Avalonia.Controls.ContentControl](xref:Avalonia.Controls.ContentControl) styled to look like a tooltip. To add a tooltip to a control, use the [Avalonia.Controls.ToolTip.TipProperty](xref:Avalonia.Controls.ToolTip.TipProperty) attached property, assigning the content that you want displayed.
...
### ToolTip Constructor[​](#tooltip-constructor "Direct link to ToolTip Constructor")
...
### AddToolTipClosingHandler Method[​](#addtooltipclosinghandler-method "Direct link to AddToolTipClosingHandler Method")
...
### AddToolTipOpeningHandler Method[​](#addtooltipopeninghandler-method "Direct link to AddToolTipOpeningHandler Method")
...
### GetBetweenShowDelay Method[​](#getbetweenshowdelay-method "Direct link to GetBetweenShowDelay Method")

Gets the number of milliseconds since the last tooltip closed during which the tooltip of `element` will open immediately, or a negative value indicating that the tooltip will always wait for [Avalonia.Controls.ToolTip.ShowDelayProperty](xref:Avalonia.Controls.ToolTip.ShowDelayProperty) before opening.
...
### GetCustomPopupPlacementCallback Method[​](#getcustompopupplacementcallback-method "Direct link to GetCustomPopupPlacementCallback Method")
...
### GetHorizontalOffset Method[​](#gethorizontaloffset-method "Direct link to GetHorizontalOffset Method")
...
### GetIsOpen Method[​](#getisopen-method "Direct link to GetIsOpen Method")
...
### GetPlacement Method[​](#getplacement-method "Direct link to GetPlacement Method")
...
### GetServiceEnabled Method[​](#getserviceenabled-method "Direct link to GetServiceEnabled Method")
...
### GetShowDelay Method[​](#getshowdelay-method "Direct link to GetShowDelay Method")
...
### GetShowOnDisabled Method[​](#getshowondisabled-method "Direct link to GetShowOnDisabled Method")
...
### GetTip Method[​](#gettip-method "Direct link to GetTip Method")
...
### GetVerticalOffset Method[​](#getverticaloffset-method "Direct link to GetVerticalOffset Method")
...
### RemoveToolTipClosingHandler Method[​](#removetooltipclosinghandler-method "Direct link to RemoveToolTipClosingHandler Method")
...
### RemoveToolTipOpeningHandler Method[​](#removetooltipopeninghandler-method "Direct link to RemoveToolTipOpeningHandler Method")
...
### SetBetweenShowDelay Method[​](#setbetweenshowdelay-method "Direct link to SetBetweenShowDelay Method")
...
Setting a negative value disables the immediate opening behaviour. The tooltip of `element` will then always wait until [Avalonia.Controls.ToolTip.ShowDelayProperty](xref:Avalonia.Controls.ToolTip.ShowDelayProperty) elapses before showing.

### SetCustomPopupPlacementCallback Method[​](#setcustompopupplacementcallback-method "Direct link to SetCustomPopupPlacementCallback Method")
...
### SetHorizontalOffset Method[​](#sethorizontaloffset-method "Direct link to SetHorizontalOffset Method")
...
### SetIsOpen Method[​](#setisopen-method "Direct link to SetIsOpen Method")
...
### SetPlacement Method[​](#setplacement-method "Direct link to SetPlacement Method")
...
### SetServiceEnabled Method[​](#setserviceenabled-method "Direct link to SetServiceEnabled Method")
...
### SetShowDelay Method[​](#setshowdelay-method "Direct link to SetShowDelay Method")
...
### SetShowOnDisabled Method[​](#setshowondisabled-method "Direct link to SetShowOnDisabled Method")
...
### SetTip Method[​](#settip-method "Direct link to SetTip Method")
...
### SetVerticalOffset Method[​](#setverticaloffset-method "Direct link to SetVerticalOffset Method")
...
### BetweenShowDelayProperty Field[​](#betweenshowdelayproperty-field "Direct link to BetweenShowDelayProperty Field")
...
### ServiceEnabledProperty Field[​](#serviceenabledproperty-field "Direct link to ServiceEnabledProperty Field")
...
### ShowDelayProperty Field[​](#showdelayproperty-field "Direct link to ShowDelayProperty Field")
...
### ShowOnDisabledProperty Field[​](#showondisabledproperty-field "Direct link to ShowOnDisabledProperty Field")
...
### TipProperty Field[​](#tipproperty-field "Direct link to TipProperty Field")
...
### ToolTipClosingEvent Field[​](#tooltipclosingevent-field "Direct link to ToolTipClosingEvent Field")
...
### ToolTipOpeningEvent Field[​](#tooltipopeningevent-field "Direct link to ToolTipOpeningEvent Field")
...
To prevent a tooltip from appearing in the UI, your handler for ToolTipOpening can mark the event data handled. Otherwise, the tooltip is displayed, using the value of the [ToolTip](xref:Avalonia.Controls.ToolTip) property as the tooltip content. Another possible scenario is that you could write a handler that resets the value of the [ToolTip](xref:Avalonia.Controls.ToolTip) property for the element that is the event source, just before the tooltip is displayed. ToolTipOpening will not be raised if the value of [ToolTip](xref:Avalonia.Controls.ToolTip) is null or otherwise unset. Do not deliberately set [ToolTip](xref:Avalonia.Controls.ToolTip) to null while a tooltip is open or opening; this will not have the effect of closing the tooltip, and will instead create an undesirable visual artifact in the UI.
