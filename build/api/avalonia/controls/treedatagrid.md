...
Represents a control that displays hierarchical and tabular data together in a single view. It is a combination of a [TreeView](xref:Avalonia.Controls.TreeView) and DataGrid control.
...
Inheritance: object -> [AvaloniaObject](../avaloniaobject) -> [Animatable](../animation/animatable) -> [StyledElement](../styledelement) -> [Visual](../visual) -> [Layoutable](../layout/layoutable) -> [Interactive](../interactivity/interactive) -> [InputElement](../input/inputelement) -> [Control](control) -> [TemplatedControl](primitives/templatedcontrol) -> TreeDataGrid

## Remarks[​](#remarks "Direct link to Remarks")

The [TreeDataGrid](xref:Avalonia.Controls.TreeDataGrid) supports both flat (2D table) and hierarchical (tree with columns) layouts, making it suitable for a variety of data visualization needs.
...
### TreeDataGrid Constructor[​](#treedatagrid-constructor "Direct link to TreeDataGrid Constructor")
...
### TryGetCell overloads[​](#trygetcell-overloads "Direct link to TryGetCell overloads")

#### TryGetCell Method[​](#trygetcell-method "Direct link to TryGetCell Method")
...
#### TryGetCell Method[​](#trygetcell-method-1 "Direct link to TryGetCell Method")
...
The row and column indices are based upon the data currently displayed in the [TreeDataGrid](xref:Avalonia.Controls.TreeDataGrid), and not the underlying data source. For example, if the data is sorted, filtered or contains expanded hierarchical rows, the indices may not correspond directly to the data source. In addition, if the specified cell is not currently visible (e.g. scrolled out of view), this method will return null.

### TryGetRow overloads[​](#trygetrow-overloads "Direct link to TryGetRow overloads")

#### TryGetRow Method[​](#trygetrow-method "Direct link to TryGetRow Method")
...
#### TryGetRow Method[​](#trygetrow-method-1 "Direct link to TryGetRow Method")
...
### TryGetRowModel Method[​](#trygetrowmodel-method "Direct link to TryGetRowModel Method")
...
This behavior only applies if [Avalonia.Controls.TreeDataGrid.CanUserSortColumns](xref:Avalonia.Controls.TreeDataGrid.CanUserSortColumns) is true. Individual columns can override this behavior via their [Avalonia.Controls.Models.TreeDataGrid.ColumnOptions\<T>.AllowTriStateSorting](xref:Avalonia.Controls.Models.TreeDataGrid.ColumnOptions%601.AllowTriStateSorting) property.

### AutoDragDropRows Property[​](#autodragdroprows-property "Direct link to AutoDragDropRows Property")

Gets or sets a value indicating whether rows can be automatically dragged and dropped within the [TreeDataGrid](xref:Avalonia.Controls.TreeDataGrid).
...
### CanUserResizeColumns Property[​](#canuserresizecolumns-property "Direct link to CanUserResizeColumns Property")
...
### CanUserSortColumns Property[​](#canusersortcolumns-property "Direct link to CanUserSortColumns Property")
...
### ColumnHeaderTheme Property[​](#columnheadertheme-property "Direct link to ColumnHeaderTheme Property")
...
### ColumnHeadersPresenter Property[​](#columnheaderspresenter-property "Direct link to ColumnHeadersPresenter Property")
...
The column headers presenter is defined in the control template and is responsible for rendering the column headers at the top of the [TreeDataGrid](xref:Avalonia.Controls.TreeDataGrid).

### ColumnSelection Property[​](#columnselection-property "Direct link to ColumnSelection Property")
...
### ElementFactory Property[​](#elementfactory-property "Direct link to ElementFactory Property")
...
The element factory is responsible for creating the visual elements that represent rows, cells, and other components of the [TreeDataGrid](xref:Avalonia.Controls.TreeDataGrid).
...
### RowTheme Property[​](#rowtheme-property "Direct link to RowTheme Property")
...
### RowsPresenter Property[​](#rowspresenter-property "Direct link to RowsPresenter Property")
...
The rows presenter is defined in the control template and is responsible for rendering the rows of data in the [TreeDataGrid](xref:Avalonia.Controls.TreeDataGrid).

### Scroll Property[​](#scroll-property "Direct link to Scroll Property")
...
The scroll viewer is defined in the control template and provides vertical and horizontal scrolling capabilities for the [TreeDataGrid](xref:Avalonia.Controls.TreeDataGrid).

### ShowColumnHeaders Property[​](#showcolumnheaders-property "Direct link to ShowColumnHeaders Property")
...
Use [Avalonia.Controls.FlatTreeDataGridSource\<T>](xref:Avalonia.Controls.FlatTreeDataGridSource%601) for flat data or [Avalonia.Controls.HierarchicalTreeDataGridSource\<T>](xref:Avalonia.Controls.HierarchicalTreeDataGridSource%601) for hierarchical data.
...
### AllowTriStateSortingProperty Field[​](#allowtristatesortingproperty-field "Direct link to AllowTriStateSortingProperty Field")
...
### AutoDragDropRowsProperty Field[​](#autodragdroprowsproperty-field "Direct link to AutoDragDropRowsProperty Field")
...
### CanUserResizeColumnsProperty Field[​](#canuserresizecolumnsproperty-field "Direct link to CanUserResizeColumnsProperty Field")
...
### CanUserSortColumnsProperty Field[​](#canusersortcolumnsproperty-field "Direct link to CanUserSortColumnsProperty Field")
...
### ColumnHeaderThemeProperty Field[​](#columnheaderthemeproperty-field "Direct link to ColumnHeaderThemeProperty Field")
...
### ElementFactoryProperty Field[​](#elementfactoryproperty-field "Direct link to ElementFactoryProperty Field")
...
### RowDragOverEvent Field[​](#rowdragoverevent-field "Direct link to RowDragOverEvent Field")
...
### RowDragStartedEvent Field[​](#rowdragstartedevent-field "Direct link to RowDragStartedEvent Field")
...
### RowDropEvent Field[​](#rowdropevent-field "Direct link to RowDropEvent Field")
...
### RowThemeProperty Field[​](#rowthemeproperty-field "Direct link to RowThemeProperty Field")
...
### ScrollProperty Field[​](#scrollproperty-field "Direct link to ScrollProperty Field")
...
### ShowColumnHeadersProperty Field[​](#showcolumnheadersproperty-field "Direct link to ShowColumnHeadersProperty Field")
...
### CellClearing Event[​](#cellclearing-event "Direct link to CellClearing Event")
...
### CellPrepared Event[​](#cellprepared-event "Direct link to CellPrepared Event")
...
### CellValueChanged Event[​](#cellvaluechanged-event "Direct link to CellValueChanged Event")
...
### RowClearing Event[​](#rowclearing-event "Direct link to RowClearing Event")
...
#### Remarks[​](#remarks-23 "Direct link to Remarks")
...
### RowDragOver Event[​](#rowdragover-event "Direct link to RowDragOver Event")
...
### RowDragStarted Event[​](#rowdragstarted-event "Direct link to RowDragStarted Event")
...
### RowDrop Event[​](#rowdrop-event "Direct link to RowDrop Event")
...
### RowPrepared Event[​](#rowprepared-event "Direct link to RowPrepared Event")
...
#### Remarks[​](#remarks-24 "Direct link to Remarks")
...
### SelectionChanging Event[​](#selectionchanging-event "Direct link to SelectionChanging Event")
...
#### Remarks[​](#remarks-25 "Direct link to Remarks")
