...
Source: [CalendarDatePicker.Properties.cs](https://github.com/AvaloniaUI/Avalonia/blob/649891b3481c6e1581f42efc8f5f106f86ef6119/src/Avalonia.Controls/CalendarDatePicker/CalendarDatePicker.Properties.cs), [CalendarDatePicker.cs](https://github.com/AvaloniaUI/Avalonia/blob/649891b3481c6e1581f42efc8f5f106f86ef6119/src/Avalonia.Controls/CalendarDatePicker/CalendarDatePicker.cs)
...
### CalendarDatePicker Constructor[​](#calendardatepicker-constructor "Direct link to CalendarDatePicker Constructor")
...
### CustomDateFormatString Property[​](#customdateformatstring-property "Direct link to CustomDateFormatString Property")
...
* [The specified date is not in the range defined by \[Avalonia.Controls.CalendarDatePicker.DisplayDateStart\](xref](xref:System.ArgumentOutOfRangeException)
  <!-- -->
  [:Avalonia](xref:System.ArgumentOutOfRangeException)
  <!-- -->
  [.Controls.CalendarDatePicker.DisplayDateStart) and \[Avalonia.Controls.CalendarDatePicker.DisplayDateEnd\](xref](xref:System.ArgumentOutOfRangeException)
  <!-- -->
  [:Avalonia](xref:System.ArgumentOutOfRangeException)
  <!-- -->
  [.Controls.CalendarDatePicker.DisplayDateEnd).](xref:System.ArgumentOutOfRangeException)
...
Gets or sets a value indicating whether the drop-down [Avalonia.Controls.Calendar](xref:Avalonia.Controls.Calendar) is open or closed.
...
True if the [Avalonia.Controls.Calendar](xref:Avalonia.Controls.Calendar) is open; otherwise, false. The default is false.
...
* [The specified date is not in the range defined by \[Avalonia.Controls.CalendarDatePicker.DisplayDateStart\](xref](xref:System.ArgumentOutOfRangeException)
  ...
  [:Avalonia](xref:System.ArgumentOutOfRangeException)
  <!-- -->
  [.Controls.CalendarDatePicker.DisplayDateEnd), or the specified date is in the \[Avalonia.Controls.CalendarDatePicker.BlackoutDates\](xref](xref:System.ArgumentOutOfRangeException)
  <!-- -->
  [:Avalonia](xref:System.ArgumentOutOfRangeException)
  <!-- -->
  [.Controls.CalendarDatePicker.BlackoutDates) collection.](xref:System.ArgumentOutOfRangeException)

### SelectedDateFormat Property[​](#selecteddateformat-property "Direct link to SelectedDateFormat Property")
...
The format that is used to display the selected date. The default is [Avalonia.Controls.CalendarDatePickerFormat.Short](xref:Avalonia.Controls.CalendarDatePickerFormat.Short).
...
* [The text entered cannot be parsed to a valid date, and the exception is not suppressed.](xref:System.FormatException)
...
### CustomDateFormatStringProperty Field[​](#customdateformatstringproperty-field "Direct link to CustomDateFormatStringProperty Field")
...
### SelectedDateFormatProperty Field[​](#selecteddateformatproperty-field "Direct link to SelectedDateFormatProperty Field")
...
### CalendarClosed Event[​](#calendarclosed-event "Direct link to CalendarClosed Event")

Occurs when the drop-down [Avalonia.Controls.Calendar](xref:Avalonia.Controls.Calendar) is closed.
...
### CalendarOpened Event[​](#calendaropened-event "Direct link to CalendarOpened Event")

Occurs when the drop-down [Avalonia.Controls.Calendar](xref:Avalonia.Controls.Calendar) is opened.
...
### DateValidationError Event[​](#datevalidationerror-event "Direct link to DateValidationError Event")

Occurs when [Avalonia.Controls.DatePicker.Text](xref:Avalonia.Controls.DatePicker.Text) is assigned a value that cannot be interpreted as a date.
...
### SelectedDateChanged Event[​](#selecteddatechanged-event "Direct link to SelectedDateChanged Event")

Occurs when the [Avalonia.Controls.CalendarDatePicker.SelectedDate](xref:Avalonia.Controls.CalendarDatePicker.SelectedDate) property is changed.
