...
Inheritance: object -> [AvaloniaObject](../avaloniaobject) -> [Animatable](../animation/animatable) -> [StyledElement](../styledelement) -> [Visual](../visual) -> [Layoutable](../layout/layoutable) -> [Interactive](../interactivity/interactive) -> [InputElement](../input/inputelement) -> [Control](control) -> [TemplatedControl](primitives/templatedcontrol) -> Calendar

## Remarks[​](#remarks "Direct link to Remarks")

A Calendar control can be used on its own, or as a drop-down part of a [DatePicker](xref:Avalonia.Controls.DatePicker) control. For more information, see [DatePicker](xref:Avalonia.Controls.DatePicker). A Calendar displays either the days of a month, the months of a year, or the years of a decade, depending on the value of the DisplayMode property. When displaying the days of a month, the user can select a date, a range of dates, or multiple ranges of dates. The kinds of selections that are allowed are controlled by the [SelectionMode](xref:Avalonia.Controls.SelectionMode) property.
...
SHIFT+ARROW Any If [SelectionMode](xref:Avalonia.Controls.SelectionMode) is not set to SingleDate or None begin selecting a range of dates.
...
### Calendar Constructor[​](#calendar-constructor "Direct link to Calendar Constructor")

Initializes a new instance of the [System.Windows.Controls.Calendar](xref:System.Windows.Controls.Calendar) class.
...
### AllowTapRangeSelection Property[​](#allowtaprangeselection-property "Direct link to AllowTapRangeSelection Property")
...
This feature only works when [SelectionMode](xref:Avalonia.Controls.SelectionMode) is set to SingleRange. When enabled, the first tap selects the start date, and the second tap selects the end date to complete the range. Tapping a third date starts a new range.

### BlackoutDates Property[​](#blackoutdates-property "Direct link to BlackoutDates Property")
...
* [Adding a date to this collection when it is already selected or adding a date outside the range specified by DisplayDateStart and DisplayDateEnd.](xref:System.ArgumentOutOfRangeException)

### DisplayDate Property[​](#displaydate-property "Direct link to DisplayDate Property")
...
* [The given date is not in the range specified by \[System.Windows.Controls.Calendar.DisplayDateStart\](xref](xref:System.ArgumentOutOfRangeException)
  <!-- -->
  [:System](xref:System.ArgumentOutOfRangeException)
  <!-- -->
  [.Windows.Controls.Calendar.DisplayDateStart) and \[System.Windows.Controls.Calendar.DisplayDateEnd\](xref](xref:System.ArgumentOutOfRangeException)
  <!-- -->
  [:System](xref:System.ArgumentOutOfRangeException)
  <!-- -->
  [.Windows.Controls.Calendar.DisplayDateEnd).](xref:System.ArgumentOutOfRangeException)

### DisplayDateEnd Property[​](#displaydateend-property "Direct link to DisplayDateEnd Property")
...
### DisplayDateStart Property[​](#displaydatestart-property "Direct link to DisplayDateStart Property")
...
A value indicating what length of time the [System.Windows.Controls.Calendar](xref:System.Windows.Controls.Calendar) should display.

### FirstDayOfWeek Property[​](#firstdayofweek-property "Direct link to FirstDayOfWeek Property")
...
A [DayOfWeek](xref:System.DayOfWeek) representing the beginning of the week. The default is [DayOfWeek.Sunday](xref:System.DayOfWeek.Sunday).

### HeaderBackground Property[​](#headerbackground-property "Direct link to HeaderBackground Property")
...
### IsTodayHighlighted Property[​](#istodayhighlighted-property "Direct link to IsTodayHighlighted Property")
...
### SelectedDate Property[​](#selecteddate-property "Direct link to SelectedDate Property")
...
Use this property when [SelectionMode](xref:Avalonia.Controls.SelectionMode) is set to SingleDate. In other modes, this property will always be the first date in SelectedDates.

#### Exceptions[​](#exceptions-2 "Direct link to Exceptions")

* [The given date is outside the range specified by \[System.Windows.Controls.Calendar.DisplayDateStart\](xref](xref:System.ArgumentOutOfRangeException)
  <!-- -->
  [:System](xref:System.ArgumentOutOfRangeException)
  <!-- -->
  [.Windows.Controls.Calendar.DisplayDateStart) and \[System.Windows.Controls.Calendar.DisplayDateEnd\](xref](xref:System.ArgumentOutOfRangeException)
  ...
  [:System](xref:System.ArgumentOutOfRangeException)
  <!-- -->
  [.Windows.Controls.Calendar.DisplayDateEnd) -or- The given date is in the \[System.Windows.Controls.Calendar.BlackoutDates\](xref](xref:System.ArgumentOutOfRangeException)
  <!-- -->
  [:System](xref:System.ArgumentOutOfRangeException)
  <!-- -->
  [.Windows.Controls.Calendar.BlackoutDates) collection.](xref:System.ArgumentOutOfRangeException)
* [If set to anything other than null when \[System.Windows.Controls.Calendar.SelectionMode\](xref](xref:System.InvalidOperationException)
  <!-- -->
  [:System](xref:System.InvalidOperationException)
  <!-- -->
  [.Windows.Controls.Calendar.SelectionMode) is set to \[System.Windows.Controls.CalendarSelectionMode.None\](xref](xref:System.InvalidOperationException)
  <!-- -->
  [:System](xref:System.InvalidOperationException)
  <!-- -->
  [.Windows.Controls.CalendarSelectionMode.None).](xref:System.InvalidOperationException)

### SelectedDates Property[​](#selecteddates-property "Direct link to SelectedDates Property")
...
A [System.Windows.Controls.SelectedDatesCollection](xref:System.Windows.Controls.SelectedDatesCollection) object that contains the currently selected dates. The default is an empty collection.

#### Remarks[​](#remarks-7 "Direct link to Remarks")

Dates can be added to the collection either individually or in a range using the AddRange method. Depending on the value of the [SelectionMode](xref:Avalonia.Controls.SelectionMode) property, adding a date or range to the collection may cause it to be cleared. The following table lists how [CalendarSelectionMode](xref:Avalonia.Controls.CalendarSelectionMode) affects the SelectedDates property.

[CalendarSelectionMode](xref:Avalonia.Controls.CalendarSelectionMode) Description None No selections are allowed. SelectedDate cannot be set and no values can be added to SelectedDates.
...
A value that indicates the current selection mode. The default is [System.Windows.Controls.CalendarSelectionMode.SingleDate](xref:System.Windows.Controls.CalendarSelectionMode.SingleDate).

#### Remarks[​](#remarks-8 "Direct link to Remarks")

This property determines whether the Calendar allows no selection, selection of a single date, or selection of multiple dates. The selection mode is specified with the [CalendarSelectionMode](xref:Avalonia.Controls.CalendarSelectionMode) enumeration.
...
### AllowTapRangeSelectionProperty Field[​](#allowtaprangeselectionproperty-field "Direct link to AllowTapRangeSelectionProperty Field")
...
### DisplayDateEndProperty Field[​](#displaydateendproperty-field "Direct link to DisplayDateEndProperty Field")
...
### DisplayDateProperty Field[​](#displaydateproperty-field "Direct link to DisplayDateProperty Field")
...
### DisplayDateStartProperty Field[​](#displaydatestartproperty-field "Direct link to DisplayDateStartProperty Field")
...
### FirstDayOfWeekProperty Field[​](#firstdayofweekproperty-field "Direct link to FirstDayOfWeekProperty Field")
...
### HeaderBackgroundProperty Field[​](#headerbackgroundproperty-field "Direct link to HeaderBackgroundProperty Field")
...
### IsTodayHighlightedProperty Field[​](#istodayhighlightedproperty-field "Direct link to IsTodayHighlightedProperty Field")
...
### SelectedDateProperty Field[​](#selecteddateproperty-field "Direct link to SelectedDateProperty Field")
...
### SelectionModeProperty Field[​](#selectionmodeproperty-field "Direct link to SelectionModeProperty Field")
...
### DisplayDateChanged Event[​](#displaydatechanged-event "Direct link to DisplayDateChanged Event")

Occurs when the [System.Windows.Controls.Calendar.DisplayDate](xref:System.Windows.Controls.Calendar.DisplayDate) property is changed.
...
### DisplayModeChanged Event[​](#displaymodechanged-event "Direct link to DisplayModeChanged Event")

Occurs when the [System.Windows.Controls.Calendar.DisplayMode](xref:System.Windows.Controls.Calendar.DisplayMode) property is changed.
...
### SelectedDatesChanged Event[​](#selecteddateschanged-event "Direct link to SelectedDatesChanged Event")
