...
Source:[SplitView.cs](https://github.com/AvaloniaUI/Avalonia/blob/649891b3481c6e1581f42efc8f5f106f86ef6119/src/Avalonia.Controls/SplitView/SplitView.cs)
...
### SplitView Constructor[​](#splitview-constructor "Direct link to SplitView Constructor")
...
### CompactPaneLength Property[​](#compactpanelength-property "Direct link to CompactPaneLength Property")

Gets or sets the length of the pane when in [Avalonia.Controls.SplitViewDisplayMode.CompactOverlay](xref:Avalonia.Controls.SplitViewDisplayMode.CompactOverlay) or [Avalonia.Controls.SplitViewDisplayMode.CompactInline](xref:Avalonia.Controls.SplitViewDisplayMode.CompactInline) mode
...
### IsPaneOpen Property[​](#ispaneopen-property "Direct link to IsPaneOpen Property")
...
### OpenPaneLength Property[​](#openpanelength-property "Direct link to OpenPaneLength Property")
...
### Pane Property[​](#pane-property "Direct link to Pane Property")
...
### PaneBackground Property[​](#panebackground-property "Direct link to PaneBackground Property")
...
### PanePlacement Property[​](#paneplacement-property "Direct link to PanePlacement Property")
...
### PaneTemplate Property[​](#panetemplate-property "Direct link to PaneTemplate Property")
...
### TemplateSettings Property[​](#templatesettings-property "Direct link to TemplateSettings Property")
...
### UseLightDismissOverlayMode Property[​](#uselightdismissoverlaymode-property "Direct link to UseLightDismissOverlayMode Property")

Gets or sets whether WinUI equivalent LightDismissOverlayMode is enabled

When enabled, and the pane is open in Overlay or CompactOverlay mode, the contents of the [Avalonia.Controls.SplitView](xref:Avalonia.Controls.SplitView) are darkened to visually separate the open pane and the rest of the [Avalonia.Controls.SplitView](xref:Avalonia.Controls.SplitView).
...
### CompactPaneLengthProperty Field[​](#compactpanelengthproperty-field "Direct link to CompactPaneLengthProperty Field")
...
### IsPaneOpenProperty Field[​](#ispaneopenproperty-field "Direct link to IsPaneOpenProperty Field")
...
### OpenPaneLengthProperty Field[​](#openpanelengthproperty-field "Direct link to OpenPaneLengthProperty Field")
...
### PaneBackgroundProperty Field[​](#panebackgroundproperty-field "Direct link to PaneBackgroundProperty Field")
...
### PaneClosedEvent Field[​](#paneclosedevent-field "Direct link to PaneClosedEvent Field")
...
### PaneClosingEvent Field[​](#paneclosingevent-field "Direct link to PaneClosingEvent Field")
...
### PaneOpenedEvent Field[​](#paneopenedevent-field "Direct link to PaneOpenedEvent Field")
...
### PaneOpeningEvent Field[​](#paneopeningevent-field "Direct link to PaneOpeningEvent Field")
...
### PanePlacementProperty Field[​](#paneplacementproperty-field "Direct link to PanePlacementProperty Field")
...
### PaneProperty Field[​](#paneproperty-field "Direct link to PaneProperty Field")
...
### PaneTemplateProperty Field[​](#panetemplateproperty-field "Direct link to PaneTemplateProperty Field")
...
### TemplateSettingsProperty Field[​](#templatesettingsproperty-field "Direct link to TemplateSettingsProperty Field")
...
### UseLightDismissOverlayModeProperty Field[​](#uselightdismissoverlaymodeproperty-field "Direct link to UseLightDismissOverlayModeProperty Field")
...
### PaneClosed Event[​](#paneclosed-event "Direct link to PaneClosed Event")
...
### PaneClosing Event[​](#paneclosing-event "Direct link to PaneClosing Event")
...
The event args [Avalonia.Interactivity.CancelRoutedEventArgs.Cancel](xref:Avalonia.Interactivity.CancelRoutedEventArgs.Cancel) property may be set to true to cancel the event and keep the pane open.

### PaneOpened Event[​](#paneopened-event "Direct link to PaneOpened Event")
...
### PaneOpening Event[​](#paneopening-event "Direct link to PaneOpening Event")
...
The event args [Avalonia.Interactivity.CancelRoutedEventArgs.Cancel](xref:Avalonia.Interactivity.CancelRoutedEventArgs.Cancel) property may be set to true to cancel the event and keep the pane closed.
