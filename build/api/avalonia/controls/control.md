...
Source:[Control.cs](https://github.com/AvaloniaUI/Avalonia/blob/649891b3481c6e1581f42efc8f5f106f86ef6119/src/Avalonia.Controls/Control.cs)
...
Inheritance: object -> [AvaloniaObject](../avaloniaobject) -> [Animatable](../animation/animatable) -> [StyledElement](../styledelement) -> [Visual](../visual) -> [Layoutable](../layout/layoutable) -> [Interactive](../interactivity/interactive) -> [InputElement](../input/inputelement) -> Control

Derived types: [Decorator](decorator), [Image](image), [MediaPlayerPresenter](mediaplayerpresenter), [NativeControlHost](nativecontrolhost), [NativeWebView](nativewebview), [Panel](panel), [ContentPresenter](presenters/contentpresenter), [ItemsPresenter](presenters/itemspresenter), [TextPresenter](presenters/textpresenter), [Popup](primitives/popup), [TemplatedControl](primitives/templatedcontrol), [Track](primitives/track), [Shape](shapes/shape), [TextBlock](textblock), [TickBar](tickbar), [Viewbox](viewbox), [OpenGlControlBase](../opengl/controls/openglcontrolbase)

Implements: [IDataTemplateHost](templates/idatatemplatehost), IVisualBrushInitialize, [ISetterValue](../styling/isettervalue)
...
### Control Constructor[​](#control-constructor "Direct link to Control Constructor")
...
### ContextFlyout Property[​](#contextflyout-property "Direct link to ContextFlyout Property")
...
### ContextMenu Property[​](#contextmenu-property "Direct link to ContextMenu Property")
...
### FocusAdorner Property[​](#focusadorner-property "Direct link to FocusAdorner Property")
...
### IsLoaded Property[​](#isloaded-property "Direct link to IsLoaded Property")
...
### ContextFlyoutProperty Field[​](#contextflyoutproperty-field "Direct link to ContextFlyoutProperty Field")
...
### ContextMenuProperty Field[​](#contextmenuproperty-field "Direct link to ContextMenuProperty Field")
...
### FocusAdornerProperty Field[​](#focusadornerproperty-field "Direct link to FocusAdornerProperty Field")
...
### LoadedEvent Field[​](#loadedevent-field "Direct link to LoadedEvent Field")
...
### RequestBringIntoViewEvent Field[​](#requestbringintoviewevent-field "Direct link to RequestBringIntoViewEvent Field")
...
### SizeChangedEvent Field[​](#sizechangedevent-field "Direct link to SizeChangedEvent Field")
...
### TagProperty Field[​](#tagproperty-field "Direct link to TagProperty Field")
...
### UnloadedEvent Field[​](#unloadedevent-field "Direct link to UnloadedEvent Field")
...
### Loaded Event[​](#loaded-event "Direct link to Loaded Event")
...
### SizeChanged Event[​](#sizechanged-event "Direct link to SizeChanged Event")
...
### Unloaded Event[​](#unloaded-event "Direct link to Unloaded Event")
...
This is API symmetrical with [Avalonia.Controls.Control.Loaded](xref:Avalonia.Controls.Control.Loaded) and exists for compatibility with other XAML frameworks; however, it behaves the same as OnDetachedFromVisualTree.
