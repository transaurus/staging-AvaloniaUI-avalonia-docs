...
Source: [ColorView.Properties.cs](https://github.com/AvaloniaUI/Avalonia/blob/649891b3481c6e1581f42efc8f5f106f86ef6119/src/Avalonia.Controls.ColorPicker/ColorView/ColorView.Properties.cs), [ColorView.cs](https://github.com/AvaloniaUI/Avalonia/blob/649891b3481c6e1581f42efc8f5f106f86ef6119/src/Avalonia.Controls.ColorPicker/ColorView/ColorView.cs)
...
Inheritance: object -> [AvaloniaObject](../avaloniaobject) -> [Animatable](../animation/animatable) -> [StyledElement](../styledelement) -> [Visual](../visual) -> [Layoutable](../layout/layoutable) -> [Interactive](../interactivity/interactive) -> [InputElement](../input/inputelement) -> [Control](control) -> [TemplatedControl](primitives/templatedcontrol) -> ColorView

Derived types:[ColorPicker](colorpicker)
...
### ColorView Constructor[​](#colorview-constructor "Direct link to ColorView Constructor")
...
For control authors, use [Avalonia.Controls.Primitives.ColorSpectrum.HsvColor](xref:Avalonia.Controls.Primitives.ColorSpectrum.HsvColor) instead to avoid loss of precision and color drifting.

### ColorModel Property[​](#colormodel-property "Direct link to ColorModel Property")
...
### ColorSpectrumComponents Property[​](#colorspectrumcomponents-property "Direct link to ColorSpectrumComponents Property")
...
### ColorSpectrumShape Property[​](#colorspectrumshape-property "Direct link to ColorSpectrumShape Property")
...
### HexInputAlphaPosition Property[​](#hexinputalphaposition-property "Direct link to HexInputAlphaPosition Property")
...
### HsvColor Property[​](#hsvcolor-property "Direct link to HsvColor Property")
...
This should be used in all cases instead of the [Avalonia.Controls.Primitives.ColorSpectrum.Color](xref:Avalonia.Controls.Primitives.ColorSpectrum.Color) property. Internally, the [Avalonia.Controls.Primitives.ColorSpectrum](xref:Avalonia.Controls.Primitives.ColorSpectrum) uses the HSV color model and using this property will avoid loss of precision and color drifting.

### IsAccentColorsVisible Property[​](#isaccentcolorsvisible-property "Direct link to IsAccentColorsVisible Property")
...
### IsAlphaEnabled Property[​](#isalphaenabled-property "Direct link to IsAlphaEnabled Property")
...
Gets or sets a value indicating whether the alpha component editing controls (Slider(s) and [TextBox](xref:Avalonia.Controls.TextBox)) are visible. When hidden, the existing alpha component value is maintained.
...
Note that [Avalonia.Controls.ColorView.IsComponentTextInputVisible](xref:Avalonia.Controls.ColorView.IsComponentTextInputVisible) also controls the alpha component [TextBox](xref:Avalonia.Controls.TextBox) visibility.

### IsColorComponentsVisible Property[​](#iscolorcomponentsvisible-property "Direct link to IsColorComponentsVisible Property")
...
### IsColorModelVisible Property[​](#iscolormodelvisible-property "Direct link to IsColorModelVisible Property")
...
### IsColorPaletteVisible Property[​](#iscolorpalettevisible-property "Direct link to IsColorPaletteVisible Property")
...
### IsColorPreviewVisible Property[​](#iscolorpreviewvisible-property "Direct link to IsColorPreviewVisible Property")
...
Note that accent color visibility is controlled separately by [Avalonia.Controls.ColorView.IsAccentColorsVisible](xref:Avalonia.Controls.ColorView.IsAccentColorsVisible).

### IsColorSpectrumSliderVisible Property[​](#iscolorspectrumslidervisible-property "Direct link to IsColorSpectrumSliderVisible Property")
...
### IsColorSpectrumVisible Property[​](#iscolorspectrumvisible-property "Direct link to IsColorSpectrumVisible Property")
...
### IsComponentSliderVisible Property[​](#iscomponentslidervisible-property "Direct link to IsComponentSliderVisible Property")
...
All color components are controlled by this property but alpha can also be controlled with [Avalonia.Controls.ColorView.IsAlphaVisible](xref:Avalonia.Controls.ColorView.IsAlphaVisible).

### IsComponentTextInputVisible Property[​](#iscomponenttextinputvisible-property "Direct link to IsComponentTextInputVisible Property")
...
### IsHexInputVisible Property[​](#ishexinputvisible-property "Direct link to IsHexInputVisible Property")
...
### MaxHue Property[​](#maxhue-property "Direct link to MaxHue Property")

Gets or sets the maximum value of the Hue component in the range from 0..359. This property must be greater than [Avalonia.Controls.Primitives.ColorSpectrum.MinHue](xref:Avalonia.Controls.Primitives.ColorSpectrum.MinHue).
...
### MaxSaturation Property[​](#maxsaturation-property "Direct link to MaxSaturation Property")

Gets or sets the maximum value of the Saturation component in the range from 0..100. This property must be greater than [Avalonia.Controls.Primitives.ColorSpectrum.MinSaturation](xref:Avalonia.Controls.Primitives.ColorSpectrum.MinSaturation).
...
### MaxValue Property[​](#maxvalue-property "Direct link to MaxValue Property")

Gets or sets the maximum value of the Value component in the range from 0..100. This property must be greater than [Avalonia.Controls.Primitives.ColorSpectrum.MinValue](xref:Avalonia.Controls.Primitives.ColorSpectrum.MinValue).
...
### MinHue Property[​](#minhue-property "Direct link to MinHue Property")

Gets or sets the minimum value of the Hue component in the range from 0..359. This property must be less than [Avalonia.Controls.Primitives.ColorSpectrum.MaxHue](xref:Avalonia.Controls.Primitives.ColorSpectrum.MaxHue).
...
### MinSaturation Property[​](#minsaturation-property "Direct link to MinSaturation Property")

Gets or sets the minimum value of the Saturation component in the range from 0..100. This property must be less than [Avalonia.Controls.Primitives.ColorSpectrum.MaxSaturation](xref:Avalonia.Controls.Primitives.ColorSpectrum.MaxSaturation).
...
### MinValue Property[​](#minvalue-property "Direct link to MinValue Property")

Gets or sets the minimum value of the Value component in the range from 0..100. This property must be less than [Avalonia.Controls.Primitives.ColorSpectrum.MaxValue](xref:Avalonia.Controls.Primitives.ColorSpectrum.MaxValue).
...
### Palette Property[​](#palette-property "Direct link to Palette Property")
...
This will automatically set both [Avalonia.Controls.ColorView.PaletteColors](xref:Avalonia.Controls.ColorView.PaletteColors) and [Avalonia.Controls.ColorView.PaletteColumnCount](xref:Avalonia.Controls.ColorView.PaletteColumnCount) overwriting any existing values.

### PaletteColors Property[​](#palettecolors-property "Direct link to PaletteColors Property")
...
This is not commonly set manually. Instead, it should be set automatically by providing an [Avalonia.Controls.IColorPalette](xref:Avalonia.Controls.IColorPalette) to the [Avalonia.Controls.ColorView.Palette](xref:Avalonia.Controls.ColorView.Palette) property.

Also note that this property is what should be bound in the control template. [Avalonia.Controls.ColorView.Palette](xref:Avalonia.Controls.ColorView.Palette) is too high-level to use on its own.

### PaletteColumnCount Property[​](#palettecolumncount-property "Direct link to PaletteColumnCount Property")
...
When using the default control theme, this property is designed to be used with the [Avalonia.Controls.ColorViewTab](xref:Avalonia.Controls.ColorViewTab) enum. The [Avalonia.Controls.ColorViewTab](xref:Avalonia.Controls.ColorViewTab) enum defines the index values of each of the three standard tabs. Use like `SelectedIndex = (int)ColorViewTab.Palette`.
...
### ColorModelProperty Field[​](#colormodelproperty-field "Direct link to ColorModelProperty Field")
...
### ColorSpectrumComponentsProperty Field[​](#colorspectrumcomponentsproperty-field "Direct link to ColorSpectrumComponentsProperty Field")
...
### ColorSpectrumShapeProperty Field[​](#colorspectrumshapeproperty-field "Direct link to ColorSpectrumShapeProperty Field")
...
### HexInputAlphaPositionProperty Field[​](#hexinputalphapositionproperty-field "Direct link to HexInputAlphaPositionProperty Field")
...
### HsvColorProperty Field[​](#hsvcolorproperty-field "Direct link to HsvColorProperty Field")
...
### IsAccentColorsVisibleProperty Field[​](#isaccentcolorsvisibleproperty-field "Direct link to IsAccentColorsVisibleProperty Field")
...
### IsAlphaEnabledProperty Field[​](#isalphaenabledproperty-field "Direct link to IsAlphaEnabledProperty Field")
...
### IsAlphaVisibleProperty Field[​](#isalphavisibleproperty-field "Direct link to IsAlphaVisibleProperty Field")
...
### IsColorComponentsVisibleProperty Field[​](#iscolorcomponentsvisibleproperty-field "Direct link to IsColorComponentsVisibleProperty Field")
...
### IsColorModelVisibleProperty Field[​](#iscolormodelvisibleproperty-field "Direct link to IsColorModelVisibleProperty Field")
...
### IsColorPaletteVisibleProperty Field[​](#iscolorpalettevisibleproperty-field "Direct link to IsColorPaletteVisibleProperty Field")
...
### IsColorPreviewVisibleProperty Field[​](#iscolorpreviewvisibleproperty-field "Direct link to IsColorPreviewVisibleProperty Field")
...
### IsColorSpectrumSliderVisibleProperty Field[​](#iscolorspectrumslidervisibleproperty-field "Direct link to IsColorSpectrumSliderVisibleProperty Field")
...
### IsColorSpectrumVisibleProperty Field[​](#iscolorspectrumvisibleproperty-field "Direct link to IsColorSpectrumVisibleProperty Field")
...
### IsComponentSliderVisibleProperty Field[​](#iscomponentslidervisibleproperty-field "Direct link to IsComponentSliderVisibleProperty Field")
...
### IsComponentTextInputVisibleProperty Field[​](#iscomponenttextinputvisibleproperty-field "Direct link to IsComponentTextInputVisibleProperty Field")
...
### IsHexInputVisibleProperty Field[​](#ishexinputvisibleproperty-field "Direct link to IsHexInputVisibleProperty Field")
...
### MaxHueProperty Field[​](#maxhueproperty-field "Direct link to MaxHueProperty Field")
...
### MaxSaturationProperty Field[​](#maxsaturationproperty-field "Direct link to MaxSaturationProperty Field")
...
### MaxValueProperty Field[​](#maxvalueproperty-field "Direct link to MaxValueProperty Field")
...
### MinHueProperty Field[​](#minhueproperty-field "Direct link to MinHueProperty Field")
...
### MinSaturationProperty Field[​](#minsaturationproperty-field "Direct link to MinSaturationProperty Field")
...
### MinValueProperty Field[​](#minvalueproperty-field "Direct link to MinValueProperty Field")
...
### PaletteColorsProperty Field[​](#palettecolorsproperty-field "Direct link to PaletteColorsProperty Field")
...
### PaletteColumnCountProperty Field[​](#palettecolumncountproperty-field "Direct link to PaletteColumnCountProperty Field")
...
### PaletteProperty Field[​](#paletteproperty-field "Direct link to PaletteProperty Field")
...
### ColorChanged Event[​](#colorchanged-event "Direct link to ColorChanged Event")
