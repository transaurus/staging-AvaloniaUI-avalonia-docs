...
Source:[TickBar.cs](https://github.com/AvaloniaUI/Avalonia/blob/649891b3481c6e1581f42efc8f5f106f86ef6119/src/Avalonia.Controls/TickBar.cs)
...
Inheritance: object -> [AvaloniaObject](../avaloniaobject) -> [Animatable](../animation/animatable) -> [StyledElement](../styledelement) -> [Visual](../visual) -> [Layoutable](../layout/layoutable) -> [Interactive](../interactivity/interactive) -> [InputElement](../input/inputelement) -> [Control](control) -> TickBar
...
### TickBar Constructor[​](#tickbar-constructor "Direct link to TickBar Constructor")
...
The primary ticks (for Minimum and Maximum value) height will be 100% of [TickBar](xref:Avalonia.Controls.TickBar)'s render size (use Width or Height depends on Placement property).
...
### Fill Property[​](#fill-property "Direct link to Fill Property")
...
Placement property specified how the Tick will be placed. This property affects the way ticks are drawn. This property has type of [Avalonia.Controls.TickBarPlacement](xref:Avalonia.Controls.TickBarPlacement).
...
### ReservedSpace Property[​](#reservedspace-property "Direct link to ReservedSpace Property")

[TickBar](xref:Avalonia.Controls.TickBar) will use ReservedSpaceProperty for left and right spacing (for horizontal orientation) or top and bottom spacing (for vertical orientation). The space on both sides of [TickBar](xref:Avalonia.Controls.TickBar) is half of specified ReservedSpace. This property has type of [Avalonia.Rect](xref:Avalonia.Rect).
...
### TickFrequency Property[​](#tickfrequency-property "Direct link to TickFrequency Property")
...
### Ticks Property[​](#ticks-property "Direct link to Ticks Property")

The Ticks property contains collection of value of type Double which are the logical positions use to draw the ticks. The property value is a [Avalonia.Collections.AvaloniaList\<T>](xref:Avalonia.Collections.AvaloniaList%601).
...
### FillProperty Field[​](#fillproperty-field "Direct link to FillProperty Field")
...
### ReservedSpaceProperty Field[​](#reservedspaceproperty-field "Direct link to ReservedSpaceProperty Field")
...
### TickFrequencyProperty Field[​](#tickfrequencyproperty-field "Direct link to TickFrequencyProperty Field")
...
### TicksProperty Field[​](#ticksproperty-field "Direct link to TicksProperty Field")
