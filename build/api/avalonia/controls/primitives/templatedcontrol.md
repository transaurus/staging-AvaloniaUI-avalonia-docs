...
Source:[TemplatedControl.cs](https://github.com/AvaloniaUI/Avalonia/blob/649891b3481c6e1581f42efc8f5f106f86ef6119/src/Avalonia.Controls/Primitives/TemplatedControl.cs)
...
Inheritance: object -> [AvaloniaObject](../../avaloniaobject) -> [Animatable](../../animation/animatable) -> [StyledElement](../../styledelement) -> [Visual](../../visual) -> [Layoutable](../../layout/layoutable) -> [Interactive](../../interactivity/interactive) -> [InputElement](../../input/inputelement) -> [Control](../control) -> TemplatedControl

Derived types: [AppBarSeparator](../appbarseparator), [AutoCompleteBox](../autocompletebox), [Calendar](../calendar), [CalendarDatePicker](../calendardatepicker), [ColorView](../colorview), [CommandBar](../commandbar), [ContentControl](../contentcontrol), [DatePicker](../datepicker), [IconElement](../iconelement), [ItemsControl](../itemscontrol), [Markdown](../markdown), [MediaPlayerControl](../mediaplayercontrol), [NativeMenuBar](../nativemenubar), [WindowNotificationManager](../notifications/windownotificationmanager), [NumericUpDown](../numericupdown), [Page](../page), [CalendarItem](calendaritem), [ColorPreviewer](colorpreviewer), [ColorSpectrum](colorspectrum), [PickerPresenterBase](pickerpresenterbase), [RangeBase](rangebase), [Thumb](thumb), [TreeDataGridCell](treedatagridcell), [TreeDataGridRow](treedatagridrow), [Separator](../separator), [TextBox](../textbox), [TimePicker](../timepicker), [TreeDataGrid](../treedatagrid), [ManagedFileChooser](../../dialogs/managedfilechooser), [ManagedFileChooserOverwritePrompt](../../dialogs/managedfilechooseroverwriteprompt)
...
### TemplatedControl Constructor[​](#templatedcontrol-constructor "Direct link to TemplatedControl Constructor")
...
### GetIsTemplateFocusTarget Method[​](#getistemplatefocustarget-method "Direct link to GetIsTemplateFocusTarget Method")
...
### SetIsTemplateFocusTarget Method[​](#setistemplatefocustarget-method "Direct link to SetIsTemplateFocusTarget Method")
...
### IsTemplateFocusTargetProperty Field[​](#istemplatefocustargetproperty-field "Direct link to IsTemplateFocusTargetProperty Field")
...
### TemplateAppliedEvent Field[​](#templateappliedevent-field "Direct link to TemplateAppliedEvent Field")
...
### TemplateApplied Event[​](#templateapplied-event "Direct link to TemplateApplied Event")
