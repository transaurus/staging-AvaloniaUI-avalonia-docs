...
Source:[Popup.cs](https://github.com/AvaloniaUI/Avalonia/blob/649891b3481c6e1581f42efc8f5f106f86ef6119/src/Avalonia.Controls/Primitives/Popup.cs)
...
Inheritance: object -> [AvaloniaObject](../../avaloniaobject) -> [Animatable](../../animation/animatable) -> [StyledElement](../../styledelement) -> [Visual](../../visual) -> [Layoutable](../../layout/layoutable) -> [Interactive](../../interactivity/interactive) -> [InputElement](../../input/inputelement) -> [Control](../control) -> Popup
...
### Popup Constructor[​](#popup-constructor "Direct link to Popup Constructor")
...
### GetTakesFocusFromNativeControl Method[​](#gettakesfocusfromnativecontrol-method "Direct link to GetTakesFocusFromNativeControl Method")

Gets the value of the [Avalonia.Controls.Primitives.Popup.TakesFocusFromNativeControl](xref:Avalonia.Controls.Primitives.Popup.TakesFocusFromNativeControl) attached property on the specified control.
...
### IsInsidePopup Method[​](#isinsidepopup-method "Direct link to IsInsidePopup Method")
...
### SetTakesFocusFromNativeControl Method[​](#settakesfocusfromnativecontrol-method "Direct link to SetTakesFocusFromNativeControl Method")

Sets the value of the [Avalonia.Controls.Primitives.Popup.TakesFocusFromNativeControl](xref:Avalonia.Controls.Primitives.Popup.TakesFocusFromNativeControl) attached property on the specified control.
...
### DependencyResolver Property[​](#dependencyresolver-property "Direct link to DependencyResolver Property")
...
This property allows a client to customize the behaviour of the popup by injecting a specialized dependency resolver into the [Avalonia.Controls.Primitives.PopupRoot](xref:Avalonia.Controls.Primitives.PopupRoot)'s constructor.
...
### InheritsTransform Property[​](#inheritstransform-property "Direct link to InheritsTransform Property")

Gets or sets a value that determines whether the popup inherits the render transform from its [Avalonia.Controls.Primitives.Popup.PlacementTarget](xref:Avalonia.Controls.Primitives.Popup.PlacementTarget). Defaults to false.
...
### IsLightDismissEnabled Property[​](#islightdismissenabled-property "Direct link to IsLightDismissEnabled Property")
...
### IsPointerOverPopup Property[​](#ispointeroverpopup-property "Direct link to IsPointerOverPopup Property")
...
### IsUsingOverlayLayer Property[​](#isusingoverlaylayer-property "Direct link to IsUsingOverlayLayer Property")
...
When [Avalonia.Controls.Primitives.Popup.IsLightDismissEnabled](xref:Avalonia.Controls.Primitives.Popup.IsLightDismissEnabled) is set to true, clicks outside the popup cause the popup to close. When [Avalonia.Controls.Primitives.Popup.OverlayDismissEventPassThrough](xref:Avalonia.Controls.Primitives.Popup.OverlayDismissEventPassThrough) is set to false, these clicks will be handled by the popup and not be registered by the parent window. When set to true, the events will be passed through to the parent window.
...
### PlacementRect Property[​](#placementrect-property "Direct link to PlacementRect Property")

Gets or sets the anchor rectangle within the parent that the popup will be placed relative to when [Avalonia.Controls.Primitives.Popup.Placement](xref:Avalonia.Controls.Primitives.Popup.Placement) is [Avalonia.Controls.PlacementMode.AnchorAndGravity](xref:Avalonia.Controls.PlacementMode.AnchorAndGravity).
...
The placement rect defines a rectangle relative to [Avalonia.Controls.Primitives.Popup.PlacementTarget](xref:Avalonia.Controls.Primitives.Popup.PlacementTarget) around which the popup will be opened, with [Avalonia.Controls.Primitives.Popup.PlacementAnchor](xref:Avalonia.Controls.Primitives.Popup.PlacementAnchor) determining which edge of the placement target is used.
...
### PlacementTarget Property[​](#placementtarget-property "Direct link to PlacementTarget Property")
...
### ShouldUseOverlayLayer Property[​](#shoulduseoverlaylayer-property "Direct link to ShouldUseOverlayLayer Property")
...
When [Avalonia.Controls.Primitives.Popup.ShouldUseOverlayLayer](xref:Avalonia.Controls.Primitives.Popup.ShouldUseOverlayLayer) is "false" implementation depends on the platform. Use [Avalonia.Controls.Primitives.Popup.IsUsingOverlayLayer](xref:Avalonia.Controls.Primitives.Popup.IsUsingOverlayLayer) to get actual popup behavior. This is an equvalent of `OverlayPopups` property of the platform options, but settable independently per each popup.

### TakesFocusFromNativeControl Property[​](#takesfocusfromnativecontrol-property "Direct link to TakesFocusFromNativeControl Property")
...
### Topmost Property[​](#topmost-property "Direct link to Topmost Property")
...
### WindowManagerAddShadowHint Property[​](#windowmanageraddshadowhint-property "Direct link to WindowManagerAddShadowHint Property")
...
### InheritsTransformProperty Field[​](#inheritstransformproperty-field "Direct link to InheritsTransformProperty Field")
...
### IsLightDismissEnabledProperty Field[​](#islightdismissenabledproperty-field "Direct link to IsLightDismissEnabledProperty Field")
...
### IsUsingOverlayLayerProperty Field[​](#isusingoverlaylayerproperty-field "Direct link to IsUsingOverlayLayerProperty Field")
...
### PlacementRectProperty Field[​](#placementrectproperty-field "Direct link to PlacementRectProperty Field")
...
### PlacementTargetProperty Field[​](#placementtargetproperty-field "Direct link to PlacementTargetProperty Field")
...
### ShouldUseOverlayLayerProperty Field[​](#shoulduseoverlaylayerproperty-field "Direct link to ShouldUseOverlayLayerProperty Field")
...
### TakesFocusFromNativeControlProperty Field[​](#takesfocusfromnativecontrolproperty-field "Direct link to TakesFocusFromNativeControlProperty Field")
...
### TopmostProperty Field[​](#topmostproperty-field "Direct link to TopmostProperty Field")
...
### WindowManagerAddShadowHintProperty Field[​](#windowmanageraddshadowhintproperty-field "Direct link to WindowManagerAddShadowHintProperty Field")
