...
Source:[Run.cs](https://github.com/AvaloniaUI/Avalonia/blob/649891b3481c6e1581f42efc8f5f106f86ef6119/src/Avalonia.Controls/Documents/Run.cs)
...
Inheritance: object -> [AvaloniaObject](../../avaloniaobject) -> [Animatable](../../animation/animatable) -> [StyledElement](../../styledelement) -> [TextElement](textelement) -> [Inline](inline) -> Run
...
#### Run Constructor[​](#run-constructor "Direct link to Run Constructor")
...
#### Run Constructor[​](#run-constructor-1 "Direct link to Run Constructor")
...
Note that when a [TextRange](xref:Avalonia.Media.TextFormatting.TextRange) that intersects with this Run gets modified (e.g. by editing a selection in RichTextBox), we will get two changes to this property since we delete and then insert when setting the content of a [TextRange](xref:Avalonia.Media.TextFormatting.TextRange).
