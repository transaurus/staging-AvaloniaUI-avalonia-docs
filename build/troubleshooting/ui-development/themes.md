...
## My control theme isn't being found[​](#my-control-theme-isnt-being-found "Direct link to My control theme isn't being found")

If your custom control theme is not being picked up by Avalonia, verify that the theme returns a [style key](/docs/styling/styles.md) that matches both the `x:Key` and `TargetType` of your control theme.
...
Example: defining and referencing a control theme
...
## My control theme is breaking other controls[​](#my-control-theme-is-breaking-other-controls "Direct link to My control theme is breaking other controls")
...
Example: a style that unintentionally affects nested controls
...
Example: scoping a style with a class selector
...
## Application window is transparent or no content is rendered[​](#application-window-is-transparent-or-no-content-is-rendered "Direct link to Application window is transparent or no content is rendered")
...
* [Themes overview](/docs/styling/themes.md)
* [Styles](/docs/styling/styles.md)
* [Troubleshooting styles](/troubleshooting/ui-development/styles.md)
* [How to use control themes](/docs/styling/control-themes.md)
