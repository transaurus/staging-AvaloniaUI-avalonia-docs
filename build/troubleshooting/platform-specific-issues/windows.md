...
## Packaging and signing[​](#packaging-and-signing "Direct link to Packaging and signing")

#### Signed executable still triggers SmartScreen warnings[​](#signed-executable-still-triggers-smartscreen-warnings "Direct link to Signed executable still triggers SmartScreen warnings")
...
#### Azure authentication failures[​](#azure-authentication-failures "Direct link to Azure authentication failures")
...
#### Application shows a blank or black window[​](#application-shows-a-blank-or-black-window "Direct link to Application shows a blank or black window")
...
#### Flickering or visual artifacts during window resize[​](#flickering-or-visual-artifacts-during-window-resize "Direct link to Flickering or visual artifacts during window resize")
...
## High-DPI and scaling[​](#high-dpi-and-scaling "Direct link to High-DPI and scaling")

#### Controls appear too small or too large on high-DPI displays[​](#controls-appear-too-small-or-too-large-on-high-dpi-displays "Direct link to Controls appear too small or too large on high-DPI displays")
...
#### Bitmap or image assets appear blurry[​](#bitmap-or-image-assets-appear-blurry "Direct link to Bitmap or image assets appear blurry")
...
## Theme and appearance[​](#theme-and-appearance "Direct link to Theme and appearance")

#### Title bar stays light when switching to dark theme on Windows 10[​](#title-bar-stays-light-when-switching-to-dark-theme-on-windows-10 "Direct link to Title bar stays light when switching to dark theme on Windows 10")
...
* **Use a custom title bar.** Set `ExtendClientAreaToDecorationsHint="True"` and `SystemDecorations="None"` to draw your own title bar with full theme control. See [Custom title bars](/docs/platform-specific-guides/windows.md#custom-title-bars) for details.
...
## Window behavior[​](#window-behavior "Direct link to Window behavior")

#### Window position or size not restored correctly[​](#window-position-or-size-not-restored-correctly "Direct link to Window position or size not restored correctly")
...
#### Taskbar icon missing for borderless or custom-chrome windows[​](#taskbar-icon-missing-for-borderless-or-custom-chrome-windows "Direct link to Taskbar icon missing for borderless or custom-chrome windows")
...
* [Windows platform guide](/docs/platform-specific-guides/windows.md) for transparency, Mica, and Win32 integration details
* [macOS issues](/troubleshooting/platform-specific-issues/macos.md) and [WebAssembly issues](/troubleshooting/platform-specific-issues/webassembly.md) for other platform-specific troubleshooting
* [Logging errors and warnings](/docs/app-development/logging-errors-and-warnings.md) for capturing diagnostic output from your application
