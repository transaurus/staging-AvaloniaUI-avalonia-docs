...
## `System.DllNotFoundException: libSkiaSharp`[​](#systemdllnotfoundexception-libskiasharp "Direct link to systemdllnotfoundexception-libskiasharp")
...
## Build fails with `wasm-tools` version mismatch[​](#build-fails-with-wasm-tools-version-mismatch "Direct link to build-fails-with-wasm-tools-version-mismatch")
...
## App loads but displays a blank screen[​](#app-loads-but-displays-a-blank-screen "Direct link to App loads but displays a blank screen")
...
## Debugging WebAssembly applications[​](#debugging-webassembly-applications "Direct link to Debugging WebAssembly applications")
...
## CORS errors when calling external APIs[​](#cors-errors-when-calling-external-apis "Direct link to CORS errors when calling external APIs")
...
## Large download size[​](#large-download-size "Direct link to Large download size")
