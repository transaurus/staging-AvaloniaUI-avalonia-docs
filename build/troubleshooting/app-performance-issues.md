...
## Use CompiledBindings[​](#use-compiledbindings "Direct link to Use CompiledBindings")

One of the most effective ways to improve performance in Avalonia is to use [`CompiledBindings`](/docs/data-binding/compiled-bindings.md) in your application. Compiled bindings enable faster data binding by compiling the binding path at compile time, thus reducing the overhead of reflection at runtime.

## Choose the right control for data display[​](#choose-the-right-control-for-data-display "Direct link to Choose the right control for data display")
...
[`TreeDataGrid`](/controls/data-display/structured-data/treedatagrid.md) is maintained as part of Avalonia Accelerate as of October 2025. It is presently still the recommended option for large datasets.
...
## Optimize your visual tree structure[​](#optimize-your-visual-tree-structure "Direct link to Optimize your visual tree structure")
...
## Minimize use of run for setting text properties[​](#minimize-use-of-run-for-setting-text-properties "Direct link to Minimize use of run for setting text properties")
...
## Use StreamGeometries over PathGeometries[​](#use-streamgeometries-over-pathgeometries "Direct link to Use StreamGeometries over PathGeometries")
...
## Use reduced image sizes[​](#use-reduced-image-sizes "Direct link to Use reduced image sizes")
...
## Resolve your binding errors[​](#resolve-your-binding-errors "Direct link to Resolve your binding errors")
...
## Asynchronously load data[​](#asynchronously-load-data "Direct link to Asynchronously load data")
