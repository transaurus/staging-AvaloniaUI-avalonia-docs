...
## .NET is not a recognized program[​](#net-is-not-a-recognized-program "Direct link to .NET is not a recognized program")

If your terminal reports that `dotnet` is not recognized, the .NET SDK is either not installed or not on your system `PATH`.

### Step 1: Check whether the SDK is installed[​](#step-1-check-whether-the-sdk-is-installed "Direct link to Step 1: Check whether the SDK is installed")
...
### Step 2: Restart your terminal[​](#step-2-restart-your-terminal "Direct link to Step 2: Restart your terminal")
...
### Step 3: Verify the PATH (if the issue persists)[​](#step-3-verify-the-path-if-the-issue-persists "Direct link to Step 3: Verify the PATH (if the issue persists)")
...
### Step 4: Check for multiple SDK installations[​](#step-4-check-for-multiple-sdk-installations "Direct link to Step 4: Check for multiple SDK installations")
...
## `Avalonia.Templates` package cannot be found[​](#avaloniatemplates-package-cannot-be-found "Direct link to avaloniatemplates-package-cannot-be-found")
...
### Step 1: List your NuGet sources[​](#step-1-list-your-nuget-sources "Direct link to Step 1: List your NuGet sources")
...
### Step 2: Add the NuGet source if it is missing[​](#step-2-add-the-nuget-source-if-it-is-missing "Direct link to Step 2: Add the NuGet source if it is missing")
...
### Step 3: Re-enable a disabled source[​](#step-3-re-enable-a-disabled-source "Direct link to Step 3: Re-enable a disabled source")
...
### Step 4: Check network and firewall settings[​](#step-4-check-network-and-firewall-settings "Direct link to Step 4: Check network and firewall settings")
...
### Step 5: Clear the NuGet cache[​](#step-5-clear-the-nuget-cache "Direct link to Step 5: Clear the NuGet cache")
...
## Template install succeeds but templates do not appear[​](#template-install-succeeds-but-templates-do-not-appear "Direct link to Template install succeeds but templates do not appear")
...
## Permission errors during installation[​](#permission-errors-during-installation "Direct link to Permission errors during installation")
...
* [App performance issues](/troubleshooting/app-performance-issues.md)
