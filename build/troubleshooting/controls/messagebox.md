...
## Adding message box functionality to your app[​](#adding-message-box-functionality-to-your-app "Direct link to Adding message box functionality to your app")
...
### Step 1: Choose a library[​](#step-1-choose-a-library "Direct link to Step 1: Choose a library")
...
### Step 2: Install the NuGet package[​](#step-2-install-the-nuget-package "Direct link to Step 2: Install the NuGet package")
...
### Step 3: Show a message box[​](#step-3-show-a-message-box "Direct link to Step 3: Show a message box")
...
### Step 4: Handle platform differences[​](#step-4-handle-platform-differences "Direct link to Step 4: Handle platform differences")
...
## Third-party `MessageBox` implementations[​](#third-party-messagebox-implementations "Direct link to third-party-messagebox-implementations")
...
## Building your own message box[​](#building-your-own-message-box "Direct link to Building your own message box")
