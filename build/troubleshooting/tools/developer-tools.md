...
## Developer Tools does not launch or attach[​](#developer-tools-does-not-launch-or-attach "Direct link to Developer Tools does not launch or attach")
...
## Obtaining Developer Tools logs[​](#obtaining-developer-tools-logs "Direct link to Obtaining Developer Tools logs")
...
### Log files are empty or missing[​](#log-files-are-empty-or-missing "Direct link to Log files are empty or missing")
...
## Obtaining Diagnostics Support logs[​](#obtaining-diagnostics-support-logs "Direct link to Obtaining Diagnostics Support logs")
...
### Custom logger implementations[​](#custom-logger-implementations "Direct link to Custom logger implementations")
