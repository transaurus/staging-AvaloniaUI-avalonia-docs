...
## Bitmap support[​](#bitmap-support "Direct link to Bitmap support")
...
## STA threading (Windows)[​](#sta-threading-windows "Direct link to STA threading (Windows)")
...
Alternatively, you can use [custom initialization](/xpf/configuration/customizing-initialization.md), which handles STA threading automatically.
...
* [Known differences](/xpf/migration/known-differences.md)
* [Customizing initialization](/xpf/configuration/customizing-initialization.md)
* [Troubleshooting](/xpf/troubleshooting.md)
