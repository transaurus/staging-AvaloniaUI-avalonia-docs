...
## XPF WebView (NativeWebView and NativeWebDialog)[​](#xpf-webview-nativewebview-and-nativewebdialog "Direct link to XPF WebView (NativeWebView and NativeWebDialog)")
...
See [Embedding Web Content](/docs/app-development/embedding-web-content.md) for the Avalonia documentation on these controls.

### Linux requirements[​](#linux-requirements "Direct link to Linux requirements")
...
## DotNetBrowser[​](#dotnetbrowser "Direct link to DotNetBrowser")
...
## Choosing a web control[​](#choosing-a-web-control "Direct link to Choosing a web control")
