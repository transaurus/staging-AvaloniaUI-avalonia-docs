# Embedding Avalonia in XPF

## Embedding Avalonia controls[​](#embedding-avalonia-controls "Direct link to Embedding Avalonia controls")

### Step 1: Add an Avalonia `UserControl`[​](#step-1-add-an-avalonia-usercontrol "Direct link to step-1-add-an-avalonia-usercontrol")
...
### Step 2: Host the Avalonia `UserControl`[​](#step-2-host-the-avalonia-usercontrol "Direct link to step-2-host-the-avalonia-usercontrol")
...
## Styling Avalonia controls[​](#styling-avalonia-controls "Direct link to Styling Avalonia controls")

In XPF you can add Style to the Avalonia control only with the code-behind. Please consider the sample below.

### XAML code[​](#xaml-code "Direct link to XAML code")
...
### Code-behind C# code[​](#code-behind-c-code "Direct link to Code-behind C# code")
...
## Adding global styles dynamically[​](#adding-global-styles-dynamically "Direct link to Adding global styles dynamically")
...
### With a custom Avalonia application[​](#with-a-custom-avalonia-application "Direct link to With a custom Avalonia application")

In more advanced scenarios you may need to fully replace the styles applied by default with your custom styles and for that you will need to redefine the Avalonia Application. First step would be to disable the automatic XPF initialization.
...
## Accessing Avalonia features[​](#accessing-avalonia-features "Direct link to Accessing Avalonia features")
...
## Getting the Avalonia window[​](#getting-the-avalonia-window "Direct link to Getting the Avalonia window")
