...
* A valid XPF license and access to the XPF SDK NuGet feed. See [Getting started](/xpf/getting-started.md) for setup details.

## Step 1: Update the project file[​](#step-1-update-the-project-file "Direct link to Step 1: Update the project file")
...
## Step 2: Add an XPF application class[​](#step-2-add-an-xpf-application-class "Direct link to Step 2: Add an XPF application class")
...
## Step 3: Initialize the XPF application[​](#step-3-initialize-the-xpf-application "Direct link to Step 3: Initialize the XPF application")
...
## Step 4: Add an XPF UserControl[​](#step-4-add-an-xpf-usercontrol "Direct link to Step 4: Add an XPF UserControl")
...
## Step 5: Host the XPF UserControl[​](#step-5-host-the-xpf-usercontrol "Direct link to Step 5: Host the XPF UserControl")
...
* [Embedding Avalonia in XPF](/xpf/interop/embedding-avalonia-in-xpf.md)
* [Centralizing multiple XPF projects](/xpf/configuration/centralizing-multiple-xpf-projects.md)
