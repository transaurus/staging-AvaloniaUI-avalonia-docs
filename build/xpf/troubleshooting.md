...
## Trouble restoring NuGet packages[​](#trouble-restoring-nuget-packages "Direct link to Trouble restoring NuGet packages")
...
### Check your firewall settings[​](#check-your-firewall-settings "Direct link to Check your firewall settings")
...
### Check you have set up NuGet.config[​](#check-you-have-set-up-nugetconfig "Direct link to Check you have set up NuGet.config")

* Ensure that you have added a [NuGet.config](/xpf/getting-started.md#step-2-add-a-nugetconfig) file, **and that it is in the same directory** as the `.sln` file you are loading
* Ensure that you have added a valid license key to your `NuGet.config` file

### Clear your NuGet HTTP cache[​](#clear-your-nuget-http-cache "Direct link to Clear your NuGet HTTP cache")
...
## Avalonia version conflicts[​](#avalonia-version-conflicts "Direct link to Avalonia version conflicts")
...
## Assembly version conflicts in multi-project solutions[​](#assembly-version-conflicts-in-multi-project-solutions "Direct link to Assembly version conflicts in multi-project solutions")
...
## ContextMenu not showing programmatically[​](#contextmenu-not-showing-programmatically "Direct link to ContextMenu not showing programmatically")
...
## Application path returns null in published apps[​](#application-path-returns-null-in-published-apps "Direct link to Application path returns null in published apps")
...
## Listening for XPF logs[​](#listening-for-xpf-logs "Direct link to Listening for XPF logs")
...
## Listening for Avalonia logs[​](#listening-for-avalonia-logs "Direct link to Listening for Avalonia logs")
...
### .LogToTrace in a custom Avalonia initialization[​](#logtotrace-in-a-custom-avalonia-initialization "Direct link to .LogToTrace in a custom Avalonia initialization")

1. Follow [instructions](/xpf/configuration/customizing-initialization.md) on how to setup custom Avalonia initialization.
...
### Override `Logger.Sink`[​](#override-loggersink "Direct link to override-loggersink")
...
## System.Resources.Extensions[​](#systemresourcesextensions "Direct link to System.Resources.Extensions")
...
## NullReferenceException or MissingMethodException[​](#nullreferenceexception-or-missingmethodexception "Direct link to NullReferenceException or MissingMethodException")
...
## libSkiaSharp not found on Linux[​](#libskiasharp-not-found-on-linux "Direct link to libSkiaSharp not found on Linux")
...
See [Linux: Publishing](/xpf/platforms/linux.md#publishing-for-linux) for more details.

## AssemblyLoadContext (ALC) conflicts[​](#assemblyloadcontext-alc-conflicts "Direct link to AssemblyLoadContext (ALC) conflicts")
...
## .NET version compatibility[​](#net-version-compatibility "Direct link to .NET version compatibility")
...
## Xpf.Sdk import conflicts[​](#xpfsdk-import-conflicts "Direct link to Xpf.Sdk import conflicts")
...
## Creating NuGet packages that depend on XPF[​](#creating-nuget-packages-that-depend-on-xpf "Direct link to Creating NuGet packages that depend on XPF")
...
## Dispatcher thread errors[​](#dispatcher-thread-errors "Direct link to Dispatcher thread errors")
...
* Some third-party libraries (such as Caliburn.Micro) may access window properties from background threads during initialization. See [Library Compatibility: Caliburn.Micro](/xpf/third-party/compatibility.md#caliburnmicro) for library-specific guidance.
