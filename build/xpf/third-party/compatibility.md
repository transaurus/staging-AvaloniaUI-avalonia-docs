...
This page covers compatibility notes for specific third-party libraries with Avalonia XPF. For enabling Win32 API shims (required by most third-party libraries on non-Windows platforms), see [Win32 API Shims](/xpf/third-party/win32-api-shims.md).

## DevExpress[​](#devexpress "Direct link to DevExpress")
...
3. Be aware of the following platform-specific limitations:
   ...
   * **Linux dependencies**: DevExpress controls on Linux require `libgdiplus`. See [Linux: Other Dependencies](/xpf/platforms/linux.md#other-dependencies).
...
## CefSharp[​](#cefsharp "Direct link to CefSharp")
...
For cross-platform browser alternatives, see [Web Content Embedding](/xpf/interop/web-content.md).

## Dragablz[​](#dragablz "Direct link to Dragablz")
...
## Caliburn.Micro[​](#caliburnmicro "Direct link to Caliburn.Micro")
...
## WinForms controls[​](#winforms-controls "Direct link to WinForms controls")
...
## Aspose[​](#aspose "Direct link to Aspose")

Aspose libraries set their own `DllImportResolver` on certain assemblies. Because .NET allows only one resolver per assembly, this conflicts with XPF's WinApiShim. See [Win32 API Shims: Resolving DllImportResolver Conflicts](/xpf/third-party/win32-api-shims.md#resolving-dllimportresolver-conflicts) for the workaround.

## Compatibility database[​](#compatibility-database "Direct link to Compatibility database")
