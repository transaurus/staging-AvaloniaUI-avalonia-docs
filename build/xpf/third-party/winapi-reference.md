...
For setup and configuration, see [Win32 API Shims](/xpf/third-party/win32-api-shims.md).
...
## user32.dll[​](#user32dll "Direct link to user32.dll")

### Window creation and lifecycle[​](#window-creation-and-lifecycle "Direct link to Window creation and lifecycle")
...
### Window properties and state[​](#window-properties-and-state "Direct link to Window properties and state")
...
### Window position and layout[​](#window-position-and-layout "Direct link to Window position and layout")
...
### Window hierarchy[​](#window-hierarchy "Direct link to Window hierarchy")
...
### Window display[​](#window-display "Direct link to Window display")
...
### System menu[​](#system-menu "Direct link to System menu")

| Function        | Description                                                                                  |
| --------------- | -------------------------------------------------------------------------------------------- |
| `GetSystemMenu` | Returns a handle to the window's system menu (the menu shown when clicking the window icon). |

### Focus and input[​](#focus-and-input "Direct link to Focus and input")
...
### Caret[​](#caret "Direct link to Caret")
...
## gdi32.dll[​](#gdi32dll "Direct link to gdi32.dll")

### Device contexts[​](#device-contexts "Direct link to Device contexts")
...
### Drawing objects[​](#drawing-objects "Direct link to Drawing objects")
...
### Coordinate mapping[​](#coordinate-mapping "Direct link to Coordinate mapping")
...
## dwmapi.dll[​](#dwmapidll "Direct link to dwmapi.dll")
...
## shcore.dll / Monitor APIs[​](#shcoredll--monitor-apis "Direct link to shcore.dll / Monitor APIs")
...
## imm32.dll (Input Method Editor)[​](#imm32dll-input-method-editor "Direct link to imm32.dll (Input Method Editor)")
...
## kernel32.dll[​](#kernel32dll "Direct link to kernel32.dll")
...
### File and memory mapping[​](#file-and-memory-mapping "Direct link to File and memory mapping")
...
## shell32.dll[​](#shell32dll "Direct link to shell32.dll")
...
## uxtheme.dll[​](#uxthemedll "Direct link to uxtheme.dll")
...
## msctf.dll[​](#msctfdll "Direct link to msctf.dll")
