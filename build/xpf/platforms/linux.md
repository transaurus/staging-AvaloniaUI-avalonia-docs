...
## Installing .NET[​](#installing-net "Direct link to Installing .NET")
...
### Other distributions[​](#other-distributions-1 "Direct link to Other distributions")
...
### Fixing a broken .NET installation[​](#fixing-a-broken-net-installation "Direct link to Fixing a broken .NET installation")
...
## Other dependencies[​](#other-dependencies "Direct link to Other dependencies")
...
### Fedora[​](#fedora-1 "Direct link to Fedora")
...
### RHEL / CentOS / Rocky Linux / AlmaLinux[​](#rhel--centos--rocky-linux--almalinux "Direct link to RHEL / CentOS / Rocky Linux / AlmaLinux")
...
### Other distributions[​](#other-distributions-2 "Direct link to Other distributions")
...
## Publishing for Linux[​](#publishing-for-linux "Direct link to Publishing for Linux")
...
### Native library resolution with ReadyToRun[​](#native-library-resolution-with-readytorun "Direct link to Native library resolution with ReadyToRun")
...
## Debugging on Linux[​](#debugging-on-linux "Direct link to Debugging on Linux")

### From Windows (Visual Studio)[​](#from-windows-visual-studio "Direct link to From Windows (Visual Studio)")
...
### From VS Code[​](#from-vs-code "Direct link to From VS Code")

Use VS Code with the C# DevKit extension. Configure a `launch.json` for remote debugging over SSH or WSL2.

### From JetBrains Rider[​](#from-jetbrains-rider "Direct link to From JetBrains Rider")
...
## Tray icons[​](#tray-icons "Direct link to Tray icons")
...
## File dialogs on older distributions[​](#file-dialogs-on-older-distributions "Direct link to File dialogs on older distributions")
...
To work around this, disable the DBus file picker in your [custom initialization](/xpf/configuration/customizing-initialization.md):
...
## Win32 API shim conflicts with native APIs[​](#win32-api-shim-conflicts-with-native-apis "Direct link to Win32 API shim conflicts with native APIs")
...
## Launching from `systemd`[​](#launching-from-systemd "Direct link to launching-from-systemd")
...
## WebView on Linux[​](#webview-on-linux "Direct link to WebView on Linux")
...
### Debian / Ubuntu[​](#debian--ubuntu-1 "Direct link to Debian / Ubuntu")
...
### Fedora[​](#fedora-2 "Direct link to Fedora")
...
### RHEL / CentOS[​](#rhel--centos "Direct link to RHEL / CentOS")
...
For a comparison of all browser embedding options, see [Web Content Embedding](/xpf/interop/web-content.md).

## Display server considerations[​](#display-server-considerations "Direct link to Display server considerations")

### X11[​](#x11 "Direct link to X11")
...
### Wayland[​](#wayland "Direct link to Wayland")
