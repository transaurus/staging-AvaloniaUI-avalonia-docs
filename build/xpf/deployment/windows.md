...
## Single-file publishing[​](#single-file-publishing "Direct link to Single-file publishing")
...
## ReadyToRun compilation[​](#readytorun-compilation "Direct link to ReadyToRun compilation")
...
See [Performance Optimization](/xpf/configuration/performance.md#reducing-startup-time-with-readytorun) for more details.

## WinForms hosting[​](#winforms-hosting "Direct link to WinForms hosting")
...
## STA threading[​](#sta-threading "Direct link to STA threading")
...
When you use [custom initialization](/xpf/configuration/customizing-initialization.md), the XPF SDK handles STA threading automatically.

## Windows installers[​](#windows-installers "Direct link to Windows installers")
...
* [macOS Deployment](/xpf/deployment/macos.md)
* [Linux Deployment](/xpf/deployment/linux.md)
* [Customizing Initialization](/xpf/configuration/customizing-initialization.md)
* [Performance Optimization](/xpf/configuration/performance.md)
