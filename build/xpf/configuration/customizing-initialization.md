...
Avalonia provides the [`AppBuilder`](/docs/fundamentals/application-lifetimes.md) API to customize various aspects of the framework.

Because XPF is based upon Avalonia, it can be useful to have access to this API in an XPF application.

## Step 1: Disable automatic XPF initialization[​](#step-1-disable-automatic-xpf-initialization "Direct link to Step 1: Disable automatic XPF initialization")
...
## Step 2: Add a main entry point[​](#step-2-add-a-main-entry-point "Direct link to Step 2: Add a main entry point")
...
## Step 3: Set the `StartupObject`[​](#step-3-set-the-startupobject "Direct link to step-3-set-the-startupobject")
...
## AssemblyLoadContext (ALC) Support[​](#assemblyloadcontext-alc-support "Direct link to AssemblyLoadContext (ALC) Support")
...
## Custom assembly loading[​](#custom-assembly-loading "Direct link to Custom assembly loading")
...
## Dispatcher constraints[​](#dispatcher-constraints "Direct link to Dispatcher constraints")
...
See [Missing Features: Multiple UI Threads](/xpf/version-info/missing-features.md) for more details.

## Optional: Define a custom Avalonia application[​](#optional-define-a-custom-avalonia-application "Direct link to Optional: Define a custom Avalonia application")
