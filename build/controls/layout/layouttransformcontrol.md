...
The [`LayoutTransformControl`](/api/avalonia/controls/layouttransformcontrol.md) applies a transform (rotation, scale, skew) to its child that participates in layout. Unlike `RenderTransform`, which only changes how a control is drawn without affecting surrounding layout, [`LayoutTransformControl`](/api/avalonia/controls/layouttransformcontrol.md) causes parent panels to measure and arrange around the transformed bounds.
...
## `LayoutTransform` vs. `RenderTransform`[​](#layouttransform-vs-rendertransform "Direct link to layouttransform-vs-rendertransform")
...
### Rotating a control[​](#rotating-a-control "Direct link to Rotating a control")
...
### Scaling a control[​](#scaling-a-control "Direct link to Scaling a control")
...
### Combining transforms[​](#combining-transforms "Direct link to Combining transforms")
...
### Binding the angle[​](#binding-the-angle "Direct link to Binding the angle")
...
* [Decorator](/controls/layout/decorator.md)
* [Border](/controls/layout/border)
* [Viewbox](/controls/layout/viewbox)
* [Transforms](/concepts/transforms)
* [LayoutTransformControl API reference](/api/avalonia/controls/layouttransformcontrol.md)
