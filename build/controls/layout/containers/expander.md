...
| [`ExpandDirection`](/api/avalonia/controls/expanddirection.md) | `ExpandDirection` | Direction the content expands: `Down` (default), `Up`, `Left`, or `Right`.                         |
...
## Content transition[​](#content-transition "Direct link to Content transition")
...
## Nesting expanders[​](#nesting-expanders "Direct link to Nesting expanders")
...
* [Expander API reference](/api/avalonia/controls/expander.md)
...
* [GroupBox](/controls/layout/containers/groupbox.md)
