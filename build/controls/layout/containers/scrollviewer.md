...
The [`ScrollViewer`](/api/avalonia/controls/scrollviewer.md) control can have content that is bigger than its content zone. It provides scroll bars so your users can move hidden content into view.
...
| ------------------------------- | --------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| `HorizontalScrollBarVisibility` | [`ScrollBarVisibility`](/api/avalonia/controls/primitives/scrollbarvisibility.md) | Controls the horizontal scrollbar: `Auto`, `Visible`, `Hidden`, `Disabled`.                                                                       |
...
## Scrollbar visibility options[​](#scrollbar-visibility-options "Direct link to Scrollbar visibility options")
...
## Scroll chaining[​](#scroll-chaining "Direct link to Scroll chaining")
...
### Horizontal scrolling[​](#horizontal-scrolling "Direct link to Horizontal scrolling")
...
* [ScrollViewer API reference](/api/avalonia/controls/scrollviewer.md)
