...
The [`StackPanel`](/api/avalonia/controls/stackpanel.md) arranges its child controls by stacking them horizontally or vertically. You will often use a stack panel to arrange a small subsection of your UI on a page.
...
| ---------------------------------------------------- | ---------------------------------------------------------------------------------- |
| [`Orientation`](/api/avalonia/layout/orientation.md) | Sets the direction of the stack. Choose from `Horizontal` or `Vertical` (default). |
...
## Defining a StackPanel in code[​](#defining-a-stackpanel-in-code "Direct link to Defining a StackPanel in code")
...
## Centering items[​](#centering-items "Direct link to Centering items")
...
## Horizontal stack with spacing[​](#horizontal-stack-with-spacing "Direct link to Horizontal stack with spacing")
...
* [StackPanel API reference](/api/avalonia/controls/stackpanel.md)
