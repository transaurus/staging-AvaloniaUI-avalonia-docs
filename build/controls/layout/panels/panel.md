...
## Controlling overlap with `ZIndex`[​](#controlling-overlap-with-zindex "Direct link to controlling-overlap-with-zindex")
...
## Setting a background for hit testing[​](#setting-a-background-for-hit-testing "Direct link to Setting a background for hit testing")
...
## Using `Panel` as a base for custom panels[​](#using-panel-as-a-base-for-custom-panels "Direct link to using-panel-as-a-base-for-custom-panels")
...
For a complete walkthrough, see [Custom panel](/docs/custom-controls/custom-panel.md).

## Other panel controls[​](#other-panel-controls "Direct link to Other panel controls")

If you need more control over how child elements are positioned, consider one of these specialized panels:

* [Stack panel](/controls/layout/panels/stackpanel.md): arranges children in a single horizontal or vertical line.
* [Dock panel](/controls/layout/panels/dockpanel.md): docks children to the edges of the panel.
* [Grid](/controls/layout/panels/grid.md): arranges children in rows and columns.
* [Wrap panel](/controls/layout/panels/wrappanel.md): arranges children in a line that wraps when it reaches the panel edge.
* [Canvas](/controls/layout/panels/canvas.md): positions children at explicit coordinates.
* [Relative panel](/controls/layout/panels/relativepanel.md): positions children relative to each other or to the panel itself.
* [Uniform grid](/controls/layout/panels/uniformgrid.md): arranges children in a grid with equally sized cells.

## See also[​](#see-also "Direct link to See also")

* [Panel API reference](/api/avalonia/controls/panel.md)
* [`Panel.cs` source code on GitHub](https://github.com/AvaloniaUI/Avalonia/blob/master/src/Avalonia.Controls/Panel.cs)
* [Custom panel](/docs/custom-controls/custom-panel.md)
