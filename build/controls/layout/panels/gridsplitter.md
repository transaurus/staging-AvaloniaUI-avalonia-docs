...
The [`GridSplitter`](/api/avalonia/controls/gridsplitter.md) control allows a user to resize the columns or rows in a `Grid` at runtime. The splitter is drawn as a column or row (size can be specified), and has a grip that the user can manipulate at runtime.
...
## Drag behavior[​](#drag-behavior "Direct link to Drag behavior")
...
## Min/max constraints[​](#minmax-constraints "Direct link to Min/max constraints")
...
* [GridSplitter API reference](/api/avalonia/controls/gridsplitter.md)
