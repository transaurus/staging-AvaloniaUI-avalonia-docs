...
## Binding content[​](#binding-content "Direct link to Binding content")
...
## Building accessible forms[​](#building-accessible-forms "Direct link to Building accessible forms")
...
## Label vs TextBlock[​](#label-vs-textblock "Direct link to Label vs TextBlock")
...
* [Label API reference](/api/avalonia/controls/label.md)
