...
## Thematic break[​](#thematic-break "Direct link to Thematic break")

| Key                                  | Type  | Default   | Notes                |
| ------------------------------------ | ----- | --------- | -------------------- |
| `MarkdownThematicBreakRectangleFill` | Brush | `#d1d9e0` | Thematic break color |

## Headers (per level)[​](#headers-per-level "Direct link to Headers (per level)")
...
## Quote blocks[​](#quote-blocks "Direct link to Quote blocks")
...
## Inline styles[​](#inline-styles "Direct link to Inline styles")

| Key                            | Type  | Default  | Notes                                 |
| ------------------------------ | ----- | -------- | ------------------------------------- |
| `MarkdownMarkedSpanBackground` | Brush | `Yellow` | Highlight background for marked spans |

## Alert blocks (per type)[​](#alert-blocks-per-type "Direct link to Alert blocks (per type)")
...
### Alert header content templates[​](#alert-header-content-templates "Direct link to Alert header content templates")
...
## Copy button[​](#copy-button "Direct link to Copy button")
