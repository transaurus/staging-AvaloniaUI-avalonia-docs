...
### XAML usage (with view model binding)[​](#xaml-usage-with-view-model-binding "Direct link to XAML usage (with view model binding)")
...
### View model example (load from file)[​](#view-model-example-load-from-file "Direct link to View model example (load from file)")
...
### C# Usage[​](#c-usage "Direct link to C# Usage")
...
## API overview[​](#api-overview "Direct link to API overview")
...
## Custom image loader[​](#custom-image-loader "Direct link to Custom image loader")

See the [Image Loader](/docs/markdown/imageloader) page for a detailed example how to customize image loading.

## Code highlighter[​](#code-highlighter "Direct link to Code highlighter")
...
* [Image loader](/controls/data-display/text-display/imageloader.md)
* [Code highlighter](/controls/data-display/text-display/codehighlighter.md)
