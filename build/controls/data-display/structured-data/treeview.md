...
| `ItemsControl.ItemPanel`    | The container panel to place items in. By default, this is a StackPanel. See [this page](/docs/custom-controls/custom-itemspanel.md) to customise the ItemsPanel. |
...
![](/assets/images/treeview-animal-hierarchy-338675d6a37ca5eee3084f636fda20af.gif)
...
![](/assets/images/treeview-enhanced-animal-hierarchy-594fe092a4f0fc1c737e88f2e0eab4fa.gif)

## Expansion events[​](#expansion-events "Direct link to Expansion events")
...
* [TreeView API reference](/api/avalonia/controls/treeview.md)
