...
* *Flat* displays data in a two-dimensional table, similar to a standard data grid.
* *Hierarchical* displays data in an expandable tree with optional columns.
...
See the [Installation Guide](/tools/installing-accelerate.md) for full instructions on installing Accelerate components.
...
### Add the licence key[​](#add-the-licence-key "Direct link to Add the licence key")
...
### Install the theme[​](#install-the-theme "Direct link to Install the theme")
...
## Flat data[​](#flat-data "Direct link to Flat data")
...
### Add the control[​](#add-the-control "Direct link to Add the control")
...
### Run the application[​](#run-the-application "Direct link to Run the application")

![](/assets/images/quickstart-flat-1-fb0b713c8531330e947d2d7c58000173.png)

## Hierarchical data[​](#hierarchical-data "Direct link to Hierarchical data")

### Data model[​](#data-model-1 "Direct link to Data model")
...
### Add the control[​](#add-the-control-1 "Direct link to Add the control")
...
### Run the application[​](#run-the-application-1 "Direct link to Run the application")

![](/assets/images/quickstart-hierarchical-1-94dd68850d3250a90ff7e87e0a67864c.png)
