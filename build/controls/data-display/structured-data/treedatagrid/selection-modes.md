...
## Row selection[​](#row-selection "Direct link to Row selection")
...
### Getting selected items[​](#getting-selected-items "Direct link to Getting selected items")
...
### Programmatically selecting rows[​](#programmatically-selecting-rows "Direct link to Programmatically selecting rows")
...
### Selection changed event[​](#selection-changed-event "Direct link to Selection changed event")
...
## Cell selection[​](#cell-selection "Direct link to Cell selection")
...
### Getting selected items[​](#getting-selected-items-1 "Direct link to Getting selected items")
...
### Programmatically selecting cells[​](#programmatically-selecting-cells "Direct link to Programmatically selecting cells")
...
### Selection changed event[​](#selection-changed-event-1 "Direct link to Selection changed event")
