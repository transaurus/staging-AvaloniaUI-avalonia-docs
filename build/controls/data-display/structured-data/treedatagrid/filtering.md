...
## Enabling filtering[​](#enabling-filtering "Direct link to Enabling filtering")
...
### Basic string filtering[​](#basic-string-filtering "Direct link to Basic string filtering")
...
### Multiple criteria filtering[​](#multiple-criteria-filtering "Direct link to Multiple criteria filtering")
...
### Enum and category filtering[​](#enum-and-category-filtering "Direct link to Enum and category filtering")
...
### Null-safe filtering[​](#null-safe-filtering "Direct link to Null-safe filtering")
...
## Updating the filter[​](#updating-the-filter "Direct link to Updating the filter")
...
## Clearing the filter[​](#clearing-the-filter "Direct link to Clearing the filter")
...
## Hierarchical data filtering[​](#hierarchical-data-filtering "Direct link to Hierarchical data filtering")
...
### Keeping parent items visible[​](#keeping-parent-items-visible "Direct link to Keeping parent items visible")
...
* **Throttle user input.** When filtering is driven by a [`TextBox`](/api/avalonia/controls/textbox.md), use `Observable.Throttle` or a delay timer so the predicate does not run on every keystroke.
...
### Throttled filtering example[​](#throttled-filtering-example "Direct link to Throttled filtering example")
...
* [TreeDataGrid overview](/controls/data-display/structured-data/treedatagrid.md)
* [Column types](/controls/data-display/structured-data/treedatagrid/column-types.md)
* [Sorting](/controls/data-display/structured-data/treedatagrid/sorting.md)
* [Selection modes](/controls/data-display/structured-data/treedatagrid/selection-modes.md)
* [Expand and collapse operations](/controls/data-display/structured-data/treedatagrid/expand-and-collapse.md)
