...
## Basic expand and collapse operations[​](#basic-expand-and-collapse-operations "Direct link to Basic expand and collapse operations")
...
For more information about `IndexPath` see [Selection modes](/controls/data-display/structured-data/treedatagrid/selection-modes.md)

### Expand all and collapse all[​](#expand-all-and-collapse-all "Direct link to Expand all and collapse all")
...
### Expand or collapse based on a condition[​](#expand-or-collapse-based-on-a-condition "Direct link to Expand or collapse based on a condition")
...
## Lazy loading data on expand[​](#lazy-loading-data-on-expand "Direct link to Lazy loading data on expand")
