...
A `MenuFlyout` allows you to host a simple menu as the flyout for a control. You might use this as an alternative to the [ContextMenu](/controls/menus/contextmenu.md).

The properties of a menu flyout are the same as for a [Flyout](/controls/layout/containers/flyout.md).
...
## With Commands and Icons[​](#with-commands-and-icons "Direct link to With Commands and Icons")
...
## Dynamic MenuFlyout[​](#dynamic-menuflyout "Direct link to Dynamic MenuFlyout")
...
* [MenuFlyout API reference](/api/avalonia/controls/menuflyout.md)
...
* [Separator](/controls/menus/separator.md)
