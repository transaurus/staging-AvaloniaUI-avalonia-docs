...
## Commands and icons[​](#commands-and-icons "Direct link to Commands and icons")
...
## Passing context to commands[​](#passing-context-to-commands "Direct link to Passing context to commands")
...
## Dynamically building menu items[​](#dynamically-building-menu-items "Direct link to Dynamically building menu items")
...
## Handling opening and closing[​](#handling-opening-and-closing "Direct link to Handling opening and closing")
...
## Context flyout[​](#context-flyout "Direct link to Context flyout")
...
* [Flyout](/controls/layout/containers/flyout.md)
* [ContextMenu API reference](/api/avalonia/controls/contextmenu.md)
