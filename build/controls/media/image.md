...
The image can be rendered in a few different blend modes, which changes the way the image interacts with what's behind it. see the [Bitmap Blend Modes](/docs/graphics-animation/bitmap-blend-modes.md) page for a list of all supported blend modes and an example gallery.
...
The scaling settings for an image are the same as for the [Viewbox](/controls/layout/containers/viewbox.md).
...
![](/assets/images/image-unscaled-5cdfbf730d7789faeb1ac4962492bf3b.png)
...
![](/assets/images/image-uniform-to-fill-6c9642de6cdb68cd151d1347dabe04be.png)

### BlendMode[​](#blendmode "Direct link to BlendMode")

This example is using two images, where the second image is using the `Multiply` Blend mode. For more information, read the [Bitmap Blend Modes](/docs/graphics-animation/bitmap-blend-modes.md) page.
...
![](/assets/images/Multiply-967632c7e6504c50d2a36ad753911449.png)

## See also[​](#see-also "Direct link to See also")

* [Image API reference](/api/avalonia/controls/image.md)
