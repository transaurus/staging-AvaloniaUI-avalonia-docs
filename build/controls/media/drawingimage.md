...
[`DrawingImage`](/api/avalonia/media/drawingimage.md) renders vector graphics as an `IImage`, making it usable anywhere a bitmap image would be. Instead of loading pixels from a file, it draws shapes, paths, and other vector content defined through Avalonia's [`Drawing`](/api/avalonia/media/drawing.md) classes.
...
## Drawing types[​](#drawing-types "Direct link to Drawing types")
...
| [`DrawingGroup`](/api/avalonia/media/drawinggroup.md) | Combines multiple drawings into one, with optional transform, clip, and opacity |
...
### Simple vector icon[​](#simple-vector-icon "Direct link to Simple vector icon")
...
### Combining multiple drawings[​](#combining-multiple-drawings "Direct link to Combining multiple drawings")
...
### Using as a resource[​](#using-as-a-resource "Direct link to Using as a resource")
...
### `DrawingImage` vs. bitmap images[​](#drawingimage-vs-bitmap-images "Direct link to drawingimage-vs-bitmap-images")
...
* [PathIcon](/controls/media/pathicon.md)
...
* [DrawingImage API reference](/api/avalonia/media/drawingimage.md)
* [GeometryDrawing API reference](/api/avalonia/media/geometrydrawing.md)
* [DrawingGroup API reference](/api/avalonia/media/drawinggroup.md)
