...
### Media source properties[​](#media-source-properties "Direct link to Media source properties")
...
## Backend architecture[​](#backend-architecture "Direct link to Backend architecture")
...
### Basic playback[​](#basic-playback "Direct link to Basic playback")

caution

`MediaPlayer` is not ready to accept a media source until the Avalonia UI has fully loaded. Always set the `Source` property after the `Loaded` event has fired. See [Initialization Timing](/controls/media/media-playback.md#initialization-timing) for details.
...
### Using a custom visual[​](#using-a-custom-visual "Direct link to Using a custom visual")
...
### Resource cleanup[​](#resource-cleanup "Direct link to Resource cleanup")
...
1. **Initialization Timing**:
   ...
   * See [Initialization Timing](/controls/media/media-playback.md#initialization-timing) for full guidance.
