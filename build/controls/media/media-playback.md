# Implementing media playback with MediaPlayer

This guide provides a practical introduction to implementing media playback in Avalonia applications using the Avalonia Accelerate [`MediaPlayer`](/controls/media/mediaplayercontrol.md).
...
See the [Installation Guide](/tools/developer-tools/installation.md) for step-by-step instructions on how to install Accelerate components.
...
### Add the license key[​](#add-the-license-key "Direct link to Add the license key")
...
### Using MediaPlayerControl (recommended)[​](#using-mediaplayercontrol-recommended "Direct link to Using MediaPlayerControl (recommended)")
...
### Using MediaPlayer directly[​](#using-mediaplayer-directly "Direct link to Using MediaPlayer directly")
...
## Initialization timing[​](#initialization-timing "Direct link to Initialization timing")
...
### Option 1: Use the OnLoaded override[​](#option-1-use-the-onloaded-override "Direct link to Option 1: Use the OnLoaded override")
...
### Option 2: Use Dispatcher.UIThread.Post[​](#option-2-use-dispatcheruithreadpost "Direct link to Option 2: Use Dispatcher.UIThread.Post")
...
## Loading media sources[​](#loading-media-sources "Direct link to Loading media sources")

### From files or URLs using UriSource[​](#from-files-or-urls-using-urisource "Direct link to From files or URLs using UriSource")
...
**Note**: If it's possible, always add the `file://` schema to your local file URI's. This makes sure that the player recognizes the file's path as local.

### From streams with StreamSource[​](#from-streams-with-streamsource "Direct link to From streams with StreamSource")
...
**Note**: Make sure to not control the disposal of the stream you passed to the `StreamSource` as the player will take care of its lifetime.

### Using file picker with StorageFileSource[​](#using-file-picker-with-storagefilesource "Direct link to Using file picker with StorageFileSource")
...
### Playback control[​](#playback-control "Direct link to Playback control")
...
### Media information[​](#media-information "Direct link to Media information")
...
* Please see the [Troubleshooting](/troubleshooting/controls/mediaplayer.md).
...
### Embedded Linux (direct rendering manager)[​](#embedded-linux-direct-rendering-manager "Direct link to Embedded Linux (direct rendering manager)")
...
## Codecs support[​](#codecs-support "Direct link to Codecs support")
...
### macOS and iOS[​](#macos-and-ios "Direct link to macOS and iOS")
