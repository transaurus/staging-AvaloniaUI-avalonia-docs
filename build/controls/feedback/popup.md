...
The [`Popup`](/api/avalonia/controls/primitives/popup.md) is a low-level control that displays content in a floating window above other content. It serves as the foundation for higher-level controls like `Flyout`, [`ToolTip`](/api/avalonia/controls/tooltip.md), `ComboBox` dropdowns, and context menus. Use `Popup` directly when you need custom positioning or dismissal behavior that those controls do not provide.
...
## Placement modes[​](#placement-modes "Direct link to Placement modes")
...
## Binding `IsOpen`[​](#binding-isopen "Direct link to binding-isopen")
...
## Custom placement[​](#custom-placement "Direct link to Custom placement")
...
## Popup vs Flyout vs ToolTip[​](#popup-vs-flyout-vs-tooltip "Direct link to Popup vs Flyout vs ToolTip")
...
* [Flyout](/controls/layout/containers/flyout.md): A higher-level popup attached to a control.
* [ToolTip](/controls/feedback/tooltip.md): Hover-activated popups for supplementary text.
* [ContextMenu](/controls/menus/contextmenu.md): Right-click menus.
