...
The [`NavigationPage`](/api/avalonia/controls/navigationpage.md) manages a stack-based navigation system, allowing you to push and pop pages with animated transitions. It displays a navigation bar with a back button and the current page's header.
...
## Navigation bar layout[​](#navigation-bar-layout "Direct link to Navigation bar layout")
...
| -------------------------------- | --------------------------------------------------------------- | ---------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| `Content`                        | [`Page`](/api/avalonia/controls/page.md)                        | `null`           | The initial root page displayed in the navigation stack.                                                                          |
| `PageTransition`                 | [`IPageTransition`](/api/avalonia/animation/ipagetransition.md) | Platform default | The transition animation used when navigating between pages.                                                                      |
...
### BarLayoutBehavior values[​](#barlayoutbehavior-values "Direct link to BarLayoutBehavior values")
...
### Modal navigation[​](#modal-navigation "Direct link to Modal navigation")
...
### Stack properties[​](#stack-properties "Direct link to Stack properties")
...
### Basic NavigationPage in XAML[​](#basic-navigationpage-in-xaml "Direct link to Basic NavigationPage in XAML")
...
![NavigationPage with root page](/assets/images/navigationpage-root-5394b9ddee83aa1d30c0d40868916bf4.png)

### Basic NavigationPage in code[​](#basic-navigationpage-in-code "Direct link to Basic NavigationPage in code")
...
### Pushing and popping pages[​](#pushing-and-popping-pages "Direct link to Pushing and popping pages")
...
![NavigationPage after pushing a page](/assets/images/navigationpage-pushed-ae3599043b1a3dc8094afdd8c4e9d075.png)

### Tracking stack depth[​](#tracking-stack-depth "Direct link to Tracking stack depth")
...
### Hiding the navigation bar[​](#hiding-the-navigation-bar "Direct link to Hiding the navigation bar")
...
![NavigationPage with hidden navigation bar](/assets/images/navigationpage-no-navbar-334e637768b95231a051609df94f85e9.png)

### Hiding the back button[​](#hiding-the-back-button "Direct link to Hiding the back button")
...
### Custom back button content[​](#custom-back-button-content "Direct link to Custom back button content")
...
![NavigationPage with custom back button content](/assets/images/navigationpage-custom-back-button-6ee4c3a89bc06a4a7fba1a2a3019b71f.png)

### Per-page TopCommandBar[​](#per-page-topcommandbar "Direct link to Per-page TopCommandBar")
...
![NavigationPage with top command bar](/assets/images/navigationpage-top-commandbar-a4279627c0e78b81b4ab22e70055a6a3.png)
...
![NavigationPage appearance and transitions](/assets/images/navigationpage-appearance-1950acc30e4e32c9159d17f34cdf52ae.png)

### Modal pages[​](#modal-pages "Direct link to Modal pages")
...
![NavigationPage with modal page](/assets/images/navigationpage-modal-6648923ebb67c1ac8b612eaf9bbd5391.png)

### Modal transitions[​](#modal-transitions "Direct link to Modal transitions")
...
### Customizing bar height[​](#customizing-bar-height "Direct link to Customizing bar height")
...
### Navigation bar shadow[​](#navigation-bar-shadow "Direct link to Navigation bar shadow")
...
### Overlay navigation bar[​](#overlay-navigation-bar "Direct link to Overlay navigation bar")
...
![NavigationPage with overlay bar layout](/assets/images/navigationpage-overlay-bar-26ba10f3223ce09bd2073086d0f78354.png)

### Replacing a login screen[​](#replacing-a-login-screen "Direct link to Replacing a login screen")
...
### DrawerPage integration[​](#drawerpage-integration "Direct link to DrawerPage integration")
...
![NavigationPage with DrawerPage integration](/assets/images/navigationpage-drawer-integration-dac397f11d3e472b95b2fa83f22c81d6.png)

### Disabling back-swipe gesture[​](#disabling-back-swipe-gesture "Direct link to Disabling back-swipe gesture")
...
* [Page Transitions](/docs/graphics-animation/page-transitions.md)
* [NavigationPage API reference](/api/avalonia/controls/navigationpage.md)
