...
The [`ThemeVariantScope`](/api/avalonia/controls/themevariantscope.md) control overrides the active theme variant (light or dark) for a section of your visual tree. All controls placed inside a `ThemeVariantScope` use the specified variant, regardless of the application or window setting. This is useful when you need part of your UI to display in a different theme from the rest of the application.
...
## Side-by-side theme preview[​](#side-by-side-theme-preview "Direct link to Side-by-side theme preview")
...
## Resetting to the inherited variant[​](#resetting-to-the-inherited-variant "Direct link to Resetting to the inherited variant")
...
## Nesting scopes[​](#nesting-scopes "Direct link to Nesting scopes")
...
## Theme-aware resources[​](#theme-aware-resources "Direct link to Theme-aware resources")
...
## Setting the variant from code[​](#setting-the-variant-from-code "Direct link to Setting the variant from code")
...
* [Theme variants](/docs/styling/theme-variants.md): Full guide to light/dark theme support and theme dictionaries.
* [How to switch themes](/docs/how-to/theme-switching-how-to.md): Implementing a theme toggle in your application.
* [Resources](/docs/app-development/resources.md): Overview of the resource system.
