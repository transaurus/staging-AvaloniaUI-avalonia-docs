...
## Visual tree structure[​](#visual-tree-structure "Direct link to Visual tree structure")
...
## WindowDrawnDecorationsTemplate[​](#windowdrawndecorationstemplate "Direct link to WindowDrawnDecorationsTemplate")
...
## WindowDrawnDecorationsContent[​](#windowdrawndecorationscontent "Direct link to WindowDrawnDecorationsContent")
...
## Decoration parts[​](#decoration-parts "Direct link to Decoration parts")
...
## Template parts[​](#template-parts "Direct link to Template parts")
...
## Element roles[​](#element-roles "Direct link to Element roles")

`ElementRole` is an [attached property](/docs/properties.md#attached-properties) that marks each visual element with a specific role for cross-platform, non-client hit testing. It can be applied to any element in the visual tree, not only decoration children elements.
...
## See aslo[​](#see-aslo "Direct link to See aslo")

* [Window control](/controls/primitives/window.md)
* [Avalonia v12 breaking changes](/docs/avalonia12-breaking-changes.md)
