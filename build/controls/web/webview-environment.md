...
## Base class properties[​](#base-class-properties "Direct link to Base class properties")

### WebViewEnvironmentRequestedEventArgs[​](#webviewenvironmentrequestedeventargs "Direct link to WebViewEnvironmentRequestedEventArgs")
...
## Platform-specific options[​](#platform-specific-options "Direct link to Platform-specific options")

### Windows WebView2[​](#windows-webview2 "Direct link to Windows WebView2")
...
### macOS/iOS (WKWebView)[​](#macosios-wkwebview "Direct link to macOS/iOS (WKWebView)")
...
### Linux (GTK WebKit)[​](#linux-gtk-webkit "Direct link to Linux (GTK WebKit)")
