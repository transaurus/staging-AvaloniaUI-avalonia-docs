...
### AuthenticateAsync[​](#authenticateasync "Direct link to AuthenticateAsync")
...
## WebAuthenticationOptions[​](#webauthenticationoptions "Direct link to WebAuthenticationOptions")
...
If true, WebAuthenticationBroker will avoid platform specific implementation option, and will use [NativeWebDialog](/controls/web/nativewebdialog.md) based implementation.
...
Callback that can be used to override [NativeWebDialog](/controls/web/nativewebdialog.md) creation when WebAuthenticationBroker uses dialog implementation instead of system auth APIs.

## WebAuthenticationResult[​](#webauthenticationresult "Direct link to WebAuthenticationResult")
...
\* Apple platforms use ASWebAuthenticationSession implementation.<br /><!-- -->\*\* Android uses CustomTabsIntent implementation, but support is experimental and might be changed.<br /><!-- -->\*\*\* Browser solution requires CORS to be configured to allow access to the redirected page. .NET 10 is also necessary to run this library in browser.
