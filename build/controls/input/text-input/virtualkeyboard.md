...
### Multiple Input Methods[​](#multiple-input-methods "Direct link to Multiple Input Methods")
...
### Code-Behind Configuration[​](#code-behind-configuration "Direct link to Code-Behind Configuration")
...
## Working with TextInputOptions[​](#working-with-textinputoptions "Direct link to Working with TextInputOptions")
...
## When to use VirtualKeyboard vs. VirtualKeyboardScope[​](#when-to-use-virtualkeyboard-vs-virtualkeyboardscope "Direct link to When to use VirtualKeyboard vs. VirtualKeyboardScope")

### Choose VirtualKeyboard when:[​](#choose-virtualkeyboard-when "Direct link to Choose VirtualKeyboard when:")
...
### Choose VirtualKeyboardScope when:[​](#choose-virtualkeyboardscope-when "Direct link to Choose VirtualKeyboardScope when:")
...
### Customizable resources[​](#customizable-resources "Direct link to Customizable resources")

![](/assets/images/styles-4ef3e5bf93ad621ba0bb4bf74fcf4675.png)
...
### How to override[​](#how-to-override "Direct link to How to override")
...
### Example: Custom theme[​](#example-custom-theme "Direct link to Example: Custom theme")
...
* [VirtualKeyboardScope](/controls/layout/containers/virtualkeyboardscope.md) - A container control that automatically manages keyboard visibility
* [Adding a virtual keyboard](/docs/platform-specific-guides/embedded-linux/virtual-keyboard.md)
