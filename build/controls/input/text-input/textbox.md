...
The [`TextBox`](/api/avalonia/controls/textbox.md) presents an area for typed (keyboard) input. You can use it for single-line fields such as a username, or enable multi-line editing for longer-form content like notes or comments.
...
![](/assets/images/textbox-entry-6e655cee770e2366cc84cd2923536397.gif)

## Watermark (placeholder text)[​](#watermark-placeholder-text "Direct link to Watermark (placeholder text)")
...
## Limiting input length[​](#limiting-input-length "Direct link to Limiting input length")
...
## View model binding[​](#view-model-binding "Direct link to View model binding")
...
## Input with inner content[​](#input-with-inner-content "Direct link to Input with inner content")
...
* [TextBox API reference](/api/avalonia/controls/textbox.md)
* [`TextBox.cs` source code on GitHub](https://github.com/AvaloniaUI/Avalonia/blob/master/src/Avalonia.Controls/TextBox.cs)
* [MaskedTextBox](/controls/input/text-input/maskedtextbox.md)
* [AutoCompleteBox](/controls/input/text-input/autocompletebox.md)
