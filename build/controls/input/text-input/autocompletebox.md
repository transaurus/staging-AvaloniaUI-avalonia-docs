...
| `AsyncPopulator`    | An asynchronous function that can provide the list of matches for a given (string) criteria. |
| `MaxLength`         | The maximum number of characters the user can type. 0 means no limit.                        |
| `InnerLeftContent`  | Content displayed inside the text area on the left (e.g., a search icon).                    |
| `InnerRightContent` | Content displayed inside the text area on the right (e.g., a clear button).                  |
...
![](/assets/images/autocompletebox-15f0c274b731beb71f0d3c719b9e17e6.gif)

### Using AutoCompleteBox with objects[​](#using-autocompletebox-with-objects "Direct link to Using AutoCompleteBox with objects")
...
#### Filtering Objects Using ValueMemberBinding[​](#filtering-objects-using-valuememberbinding "Direct link to Filtering Objects Using ValueMemberBinding")
...
#### Implementing custom filtering using ItemFilter[​](#implementing-custom-filtering-using-itemfilter "Direct link to Implementing custom filtering using ItemFilter")
...
#### Customizing text using a value converter[​](#customizing-text-using-a-value-converter "Direct link to Customizing text using a value converter")
...
* [AutoCompleteBox API reference](/api/avalonia/controls/autocompletebox.md)
