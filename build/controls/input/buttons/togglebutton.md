...
The [`ToggleButton`](/api/avalonia/controls/primitives/togglebutton.md) control presents a Boolean value by using styles and a pseudo class that is either present (true) or absent (false). This allows you to create a wide range of graphical presentations for the control in each of the pseudo class states.
...
## Three-state behavior[​](#three-state-behavior "Direct link to Three-state behavior")
...
### Styling with pseudo classes[​](#styling-with-pseudo-classes "Direct link to Styling with pseudo classes")
...
![](/assets/images/togglebutton-mute-0ef3cc0e022d5f286e3a488601e28316.gif)
...
### Three-state binding[​](#three-state-binding "Direct link to Three-state binding")
...
* [ToggleSplitButton](/controls/input/buttons/togglesplitbutton.md)
* [RadioButton](/controls/input/buttons/radiobutton.md)
* [ToggleButton API reference](/api/avalonia/controls/primitives/togglebutton.md)
