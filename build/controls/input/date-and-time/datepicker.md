...
![](/assets/images/datepicker-651624c3960bee4ed88aeff1a9e05b97.gif)
...
## Constraining the date range[​](#constraining-the-date-range "Direct link to Constraining the date range")
...
## Customizing the display format[​](#customizing-the-display-format "Direct link to Customizing the display format")
...
## Initializing the date[​](#initializing-the-date "Direct link to Initializing the date")
...
* [CalendarDatePicker](/controls/input/date-and-time/calendardatepicker.md)
* [TimePicker](/controls/input/date-and-time/timepicker.md)
* [DatePicker API reference](/api/avalonia/controls/datepicker.md)
