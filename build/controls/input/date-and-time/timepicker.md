...
## Clock format[​](#clock-format "Direct link to Clock format")
...
## Initializing the time[​](#initializing-the-time "Direct link to Initializing the time")
...
## Constraining the time[​](#constraining-the-time "Direct link to Constraining the time")
...
* [TimePicker API reference](/api/avalonia/controls/timepicker.md)
