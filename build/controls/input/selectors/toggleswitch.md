...
The [`ToggleSwitch`](/api/avalonia/controls/toggleswitch.md) control presents a sliding toggle that you can flip between on and off states. It behaves like a [`CheckBox`](/api/avalonia/controls/checkbox.md) but uses a track-and-thumb visual that feels natural on mobile and touch-first interfaces.
...
## Custom on/off labels[​](#custom-onoff-labels "Direct link to Custom on/off labels")
...
## Hiding the labels[​](#hiding-the-labels "Direct link to Hiding the labels")
...
## Settings form pattern[​](#settings-form-pattern "Direct link to Settings form pattern")
...
## Choosing between `ToggleSwitch` and `CheckBox`[​](#choosing-between-toggleswitch-and-checkbox "Direct link to choosing-between-toggleswitch-and-checkbox")
