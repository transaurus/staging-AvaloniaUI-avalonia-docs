...
To review the concept behind **data templates**, see [Introduction to data templates](/docs/data-templates/introduction-to-data-templates.md).
...
| `ItemPanel`                | `ITemplate<Panel>` | The container panel to place items in. By default, this is a `StackPanel`. See [this page](/docs/custom-controls/custom-itemspanel.md) to customise the `ItemPanel`. |
...
![ComboBox with data template showing font families](/assets/images/combobox-data-template-6dedb479ee272f17b8174e59e897485c.gif)
...
## Editable ComboBox[​](#editable-combobox "Direct link to Editable ComboBox")
...
### `TextSearch.TextBinding`[​](#textsearchtextbinding "Direct link to textsearchtextbinding")
...
* [ComboBox API reference](/api/avalonia/controls/combobox.md)
