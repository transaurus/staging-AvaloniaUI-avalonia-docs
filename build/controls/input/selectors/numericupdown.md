...
### Custom increment and range[​](#custom-increment-and-range "Direct link to Custom increment and range")
...
### Hiding the spinner buttons[​](#hiding-the-spinner-buttons "Direct link to Hiding the spinner buttons")
...
### Adding a prefix or suffix[​](#adding-a-prefix-or-suffix "Direct link to Adding a prefix or suffix")
...
* [Slider](/controls/input/selectors/slider.md)
* [TextBox](/controls/input/text/textbox)
* [Binding to Controls](/docs/data-binding/binding-to-controls.md)
* [NumericUpDown API Reference](/api/avalonia/controls/numericupdown.md)
