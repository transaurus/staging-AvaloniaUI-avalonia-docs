...
#### Visual Studio Extension[​](#visual-studio-extension "Direct link to Visual Studio Extension")
...
#### Avalonia Dev Tools[​](#avalonia-dev-tools "Direct link to Avalonia Dev Tools")
...
#### Avalonia Parcel[​](#avalonia-parcel "Direct link to Avalonia Parcel")
...
#### Individual Developers[​](#individual-developers "Direct link to Individual Developers")

Individual developers working on their own equipment, including commercial projects.

#### Small Organizations[​](#small-organizations "Direct link to Small Organizations")
...
#### Educational Institutions[​](#educational-institutions "Direct link to Educational Institutions")
...
#### Grace Period for Visual Studio Users[​](#grace-period-for-visual-studio-users "Direct link to Grace Period for Visual Studio Users")
...
## Telemetry and Data Collection[​](#telemetry-and-data-collection "Direct link to Telemetry and Data Collection")
...
#### Build Telemetry[​](#build-telemetry "Direct link to Build Telemetry")
...
#### How Telemetry Works[​](#how-telemetry-works "Direct link to How Telemetry Works")
...
#### Verifying Telemetry Data[​](#verifying-telemetry-data "Direct link to Verifying Telemetry Data")
...
## Crash Reporting (Parcel and Dev Tools Only)[​](#crash-reporting-parcel-and-dev-tools-only "Direct link to Crash Reporting (Parcel and Dev Tools Only)")
...
#### What's Collected[​](#whats-collected "Direct link to What's Collected")
...
#### Privacy Safeguards[​](#privacy-safeguards "Direct link to Privacy Safeguards")
...
## Data Transparency Commitment[​](#data-transparency-commitment "Direct link to Data Transparency Commitment")
...
## Uninstalling the Community Edition[​](#uninstalling-the-community-edition "Direct link to Uninstalling the Community Edition")

If you wish to remove the Accelerate tools and restore telemetry behavior, please follow these steps carefully.

#### Step 1: Uninstall the Tools[​](#step-1-uninstall-the-tools "Direct link to Step 1: Uninstall the Tools")
...
#### Step 2: Remove License Data (CRITICAL)[​](#step-2-remove-license-data-critical "Direct link to Step 2: Remove License Data (CRITICAL)")
...
#### Why This Manual Step Is Necessary[​](#why-this-manual-step-is-necessary "Direct link to Why This Manual Step Is Necessary")
...
## Startup Program for Growing Companies[​](#startup-program-for-growing-companies "Direct link to Startup Program for Growing Companies")
