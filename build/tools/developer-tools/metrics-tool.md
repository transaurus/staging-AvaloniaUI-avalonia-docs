...
![Histogram](/assets/images/metrics-histogram-12f3d5128f59e84e936a83e44ec98590.png)

## Disabling/enabling default sources[​](#disablingenabling-default-sources "Direct link to Disabling/enabling default sources")

By default, `Developer Tools` is configured to only accept `Avalonia` and `System.Runtime` meters providers.

It's possible to disable them or enable another by clicking the **+** button. All instruments are grouped by their meter provider, typically a namespace defining name.
...
![Meters Filter](/assets/images/meters-filter-548daab9fbaf12f9164059b7be9d0001.png)

note

Note, `Avalonia` meters are available from 11.3.0 version of the framework. And `System.Runtime` only from .NET 9. If your application doesn't meet neither of these two requirements, by default, you will see empty list of meters.

## Writing custom metric sources[​](#writing-custom-metric-sources "Direct link to Writing custom metric sources")
...
* [Profiler tool](/tools/developer-tools/profiler-tool.md)
