...
## Viewing Avalonia logs in the tool[​](#viewing-avalonia-logs-in-the-tool "Direct link to Viewing Avalonia logs in the tool")
...
![Logs Tool with Avalonia warnings](/assets/images/logs-avalonia-list-247c475e75d47a35444f4e9e941142fe.png)

## Enabling Microsoft.Extensions.Logging integration[​](#enabling-microsoftextensionslogging-integration "Direct link to Enabling Microsoft.Extensions.Logging integration")

By default, only `Avalonia` logs are redirected to the `Developer Tools` process. `Diagnostics Support` library includes built-in integration with Microsoft logging abstractions which can be easily enabled.
...
You can find more details about `DeveloperToolsOptions` on [Reference to DeveloperToolsOptions](/tools/developer-tools/options.md) page.

## Attaching custom log source[​](#attaching-custom-log-source "Direct link to Attaching custom log source")

![Logs Tool with custom Serilog events](/assets/images/logs-custom-serilog-3dd6d2a39d4aea64cf51d04188fae444.png)
