...
## What is Build MCP?[​](#what-is-build-mcp "Direct link to What is Build MCP?")
...
### Documentation and rules[​](#documentation-and-rules "Direct link to Documentation and rules")
...
## Available prompts[​](#available-prompts "Direct link to Available prompts")
...
### Server appears but tools are not available[​](#server-appears-but-tools-are-not-available "Direct link to Server appears but tools are not available")
...
### Results seem outdated[​](#results-seem-outdated "Direct link to Results seem outdated")
...
This prompt works best when combined with the [DevTools MCP](/tools/developer-tools/mcp.md), which provides the `attach-to-file` tool for live XAML previewing. The assistant writes AXAML, previews it, takes screenshots, and iterates until the result matches your target design. DevTools MCP requires a paid [Accelerate license](https://my.avalonia.dev/).
