...
## Configure the launch profile[​](#configure-the-launch-profile "Direct link to Configure the launch profile")
...
## Configure the build task[​](#configure-the-build-task "Direct link to Configure the build task")
...
## Start debugging[​](#start-debugging "Direct link to Start debugging")
...
* [Visual Studio extension](/tools/visual-studio-extension.md)
