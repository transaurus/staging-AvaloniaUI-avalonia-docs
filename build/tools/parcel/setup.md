...
## Step 1: Installing Avalonia Parcel[​](#step-1-installing-avalonia-parcel "Direct link to Step 1: Installing Avalonia Parcel")

`Avalonia Parcel` is a native [.NET tool](https://learn.microsoft.com/en-us/dotnet/core/tools/global-tools), with an update mechanism provided by the SDK. This guide demonstrates global installation of the tool. Local installation is also possible but be aware: the tool will only work in the project that it's installed into.
...
## Step 2: Run the tool[​](#step-2-run-the-tool "Direct link to Step 2: Run the tool")
...
## Step 3: Activate the tool[​](#step-3-activate-the-tool "Direct link to Step 3: Activate the tool")
...
* [Model context protocol (MCP)](/tools/parcel/mcp.md)
* [Windows packaging](/tools/parcel/packaging-for-windows.md)
* [macOS packaging](/tools/parcel/packaging-for-macos.md)
* [Linux packaging](/tools/parcel/packaging-for-linux.md)
