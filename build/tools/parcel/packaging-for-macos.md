...
### Bundle Configuration[​](#bundle-configuration "Direct link to Bundle Configuration")
...
### Bundle Properties[​](#bundle-properties "Direct link to Bundle Properties")
...
#### Custom Info.plist Configuration[​](#custom-infoplist-configuration "Direct link to Custom Info.plist Configuration")
...
### ZIP Creation[​](#zip-creation "Direct link to ZIP Creation")
...
See the [macOS troubleshooting page](/troubleshooting/platform-specific-issues/macos.md#packaging).
...
### Signing Methods[​](#signing-methods "Direct link to Signing Methods")

Parcel supports multiple certificate formats depending on development environment and workflow.

#### KeyChain Identity (macOS Only)[​](#keychain-identity-macos-only "Direct link to KeyChain Identity (macOS Only)")
...
#### P12 Certificate (Cross-Platform)[​](#p12-certificate-cross-platform "Direct link to P12 Certificate (Cross-Platform)")
...
### Create Developer Certificate[​](#create-developer-certificate "Direct link to Create Developer Certificate")
...
See the [macOS troubleshooting page](/troubleshooting/platform-specific-issues/macos.md#code-signing).
...
### Apple Account Authentication[​](#apple-account-authentication "Direct link to Apple Account Authentication")

Parcel requires authentication with Apple's notary service. Two methods are available for providing credentials.

#### App-Specific Password (Recommended)[​](#app-specific-password-recommended "Direct link to App-Specific Password (Recommended)")
...
#### Keychain Profile (macOS Only)[​](#keychain-profile-macos-only "Direct link to Keychain Profile (macOS Only)")
...
### Running Non-Notarized Apps (Testing & Personal Use)[​](#running-non-notarized-apps-testing--personal-use "Direct link to Running Non-Notarized Apps (Testing & Personal Use)")
...
### Troubleshooting notarization issues[​](#troubleshooting-notarization-issues "Direct link to Troubleshooting notarization issues")

See the [macOS troubleshooting page](/troubleshooting/platform-specific-issues/macos.md#notarization).

## See also[​](#see-also "Direct link to See also")

* [Parcel setup](/tools/parcel/setup.md)
* [Parcel command line reference](/tools/parcel/command-line-reference.md)
