...
| `--license-key`  | License key necessary to run Parcel. If unset, falls back to the "PARCEL\_LICENSE\_KEY" environment variable, or existing app session |
| `--verbosity`    | Set the verbosity level (quiet, minimal, normal, detailed, diagnostic)                                                                |

## Commands[​](#commands "Direct link to Commands")

### pack[​](#pack "Direct link to pack")
...
See [Model Context Protocol](/tools/parcel/mcp.md) for more details on usage.
...
* [Packaging for macOS](/tools/parcel/packaging-for-macos.md)
* [Packaging for Windows](/tools/parcel/packaging-for-windows.md)
* [Packaging for Linux](/tools/parcel/packaging-for-linux.md)
