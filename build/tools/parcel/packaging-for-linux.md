...
## Supported Package Formats[​](#supported-package-formats "Direct link to Supported Package Formats")
...
### Avalonia-Specific Dependencies[​](#avalonia-specific-dependencies "Direct link to Avalonia-Specific Dependencies")
...
### DEB/RPM Specific Properties[​](#debrpm-specific-properties "Direct link to DEB/RPM Specific Properties")
...
## Installation & Removal[​](#installation--removal "Direct link to Installation & Removal")

### DEB Packages (Debian/Ubuntu)[​](#deb-packages-debianubuntu "Direct link to DEB Packages (Debian/Ubuntu)")
...
### RPM Packages (Fedora/RHEL)[​](#rpm-packages-fedorarhel "Direct link to RPM Packages (Fedora/RHEL)")
...
### ZIP Archives[​](#zip-archives "Direct link to ZIP Archives")
