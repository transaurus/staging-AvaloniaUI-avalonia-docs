...
### Package Configuration[​](#package-configuration "Direct link to Package Configuration")
...
### NSIS Installer Properties[​](#nsis-installer-properties "Direct link to NSIS Installer Properties")
...
#### Local Certificate[​](#local-certificate "Direct link to Local Certificate")
...
#### Windows Certificate Store[​](#windows-certificate-store "Direct link to Windows Certificate Store")
...
#### Microsoft Trusted Signing (Cross-Platform)[​](#microsoft-trusted-signing-cross-platform "Direct link to Microsoft Trusted Signing (Cross-Platform)")
...
**Authentication:** Azure CLI authentication or environment variables:
...
#### Azure Key Vault[​](#azure-key-vault "Direct link to Azure Key Vault")
...
#### AWS KMS[​](#aws-kms "Direct link to AWS KMS")
...
**Authentication:** AWS credentials from one of the following sources:
...
#### DigiCert[​](#digicert "Direct link to DigiCert")
...
#### Google Cloud KMS[​](#google-cloud-kms "Direct link to Google Cloud KMS")
...
#### SSL.com eSigner[​](#sslcom-esigner "Direct link to SSL.com eSigner")
