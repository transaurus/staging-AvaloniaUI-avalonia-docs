# Installing Avalonia Accelerate
...
* A valid Avalonia license key. You can obtain one from the [Avalonia portal](https://portal.avaloniaui.net), including a free [Community Edition](/tools/community-edition.md) key if you qualify.

## NuGet package source[​](#nuget-package-source "Direct link to NuGet package source")
...
## Add the NuGet package[​](#add-the-nuget-package "Direct link to Add the NuGet package")
