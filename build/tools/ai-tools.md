...
## Supported AI assistants[​](#supported-ai-assistants "Direct link to Supported AI assistants")
...
## Build MCP[​](#build-mcp "Direct link to Build MCP")
...
[Set up Build MCP](/tools/ai-tools/build-mcp.md)

## DevTools MCP[​](#devtools-mcp "Direct link to DevTools MCP")
...
[Set up DevTools MCP](/tools/developer-tools/mcp.md)

## Parcel MCP[​](#parcel-mcp "Direct link to Parcel MCP")
...
[Set up Parcel MCP](/tools/parcel/mcp.md)

## See also[​](#see-also "Direct link to See also")

* [Build MCP](/tools/ai-tools/build-mcp.md)
