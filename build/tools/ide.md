...
The [Avalonia for Visual Studio](/tools/visual-studio-extension.md) extension is part of Avalonia Accelerate and provides a full-featured XAML editing experience. It includes a live previewer, intelligent code completion with automatic namespace imports, error highlighting with fix suggestions, a drag-and-drop designer, and full XAML colorisation.
...
* [Avalonia for Visual Studio](/tools/visual-studio-extension.md)
