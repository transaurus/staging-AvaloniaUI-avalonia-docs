...
## Simulating user input[​](#simulating-user-input "Direct link to Simulating user input")
...
### Mouse input[​](#mouse-input "Direct link to Mouse input")
...
### Testing a button click[​](#testing-a-button-click "Direct link to Testing a button click")
...
### Testing text input[​](#testing-text-input "Direct link to Testing text input")
...
### Testing data binding[​](#testing-data-binding "Direct link to Testing data binding")
...
### Testing keyboard shortcuts[​](#testing-keyboard-shortcuts "Direct link to Testing keyboard shortcuts")
...
### Testing a view with loaded XAML[​](#testing-a-view-with-loaded-xaml "Direct link to Testing a view with loaded XAML")
...
## Flushing async operations[​](#flushing-async-operations "Direct link to Flushing async operations")
...
## Visual regression testing[​](#visual-regression-testing "Direct link to Visual regression testing")
...
### Enabling the Skia renderer[​](#enabling-the-skia-renderer "Direct link to Enabling the Skia renderer")
...
### Capturing a frame[​](#capturing-a-frame "Direct link to Capturing a frame")
...
### Comparing against a baseline[​](#comparing-against-a-baseline "Direct link to Comparing against a baseline")
...
## Testing view models without UI[​](#testing-view-models-without-ui "Direct link to Testing view models without UI")
...
This is an advanced usage scenario. For most cases, use the [XUnit](/docs/testing/headless-xunit.md) or [NUnit](/docs/testing/headless-nunit.md) integration, which handles setup automatically.
...
### Setup application[​](#setup-application "Direct link to Setup application")
...
### Run a headless session[​](#run-a-headless-session "Direct link to Run a headless session")
...
* [Headless Testing with XUnit](/docs/testing/headless-xunit.md): XUnit integration with `[AvaloniaFact]`.
* [Headless Testing with NUnit](/docs/testing/headless-nunit.md): NUnit integration with `[AvaloniaTest]`.
* [UI Testing with Appium](/docs/testing/ui-testing-with-appium.md): End-to-end testing with a real application window.
