...
Appium is an open-source automation framework that drives your application through its accessibility tree, simulating real user interactions such as clicking buttons, typing text, and verifying control states. Unlike [headless tests](/docs/testing/setting-up-the-headless-platform.md), which run without a visible window and simulate input programmatically, Appium tests launch your compiled application in a real window and interact with it the same way a user would.
...
## When to use Appium vs headless[​](#when-to-use-appium-vs-headless "Direct link to When to use Appium vs headless")
...
## Creating a test fixture[​](#creating-a-test-fixture "Direct link to Creating a test fixture")
...
### Setting AutomationId on controls[​](#setting-automationid-on-controls "Direct link to Setting AutomationId on controls")
...
### A basic test[​](#a-basic-test "Direct link to A basic test")
...
### Testing checkbox state[​](#testing-checkbox-state "Direct link to Testing checkbox state")
...
## Cross-platform helpers[​](#cross-platform-helpers "Direct link to Cross-platform helpers")
...
## CI/CD considerations[​](#cicd-considerations "Direct link to CI/CD considerations")
...
* **Linux**: Appium does not have a stable Linux desktop driver. For Linux CI, use [headless tests](/docs/testing/setting-up-the-headless-platform.md) instead.

## See also[​](#see-also "Direct link to See also")

* [Headless Testing with XUnit](/docs/testing/headless-xunit.md): Fast, in-process unit testing.
* [Headless Testing with NUnit](/docs/testing/headless-nunit.md): NUnit integration for headless tests.
* [Headless Platform Setup](/docs/testing/setting-up-the-headless-platform.md): Simulating input and capturing frames.
