...
## Decision flowchart[​](#decision-flowchart "Direct link to Decision flowchart")
...
| ----------------------------------------------------------- | --------------------------------------- | -------------------------------------------------- | ---------------------------------------------------------------- |
| [Grid](/docs/controls/layout/panels/grid)                   | Rows and columns                        | Yes                                                | Most general-purpose layouts, forms, dashboards                  |
| [DockPanel](/docs/controls/layout/panels/dockpanel)         | Edges (top, bottom, left, right) + fill | Yes                                                | App shells with header, sidebar, and content area                |
| [StackPanel](/docs/controls/layout/panels/stackpanel)       | Single line (vertical or horizontal)    | Partially (stretches perpendicular, scrolls along) | Toolbars, menus, simple lists of controls                        |
| [WrapPanel](/docs/controls/layout/panels/wrappanel)         | Sequential with line wrapping           | Yes                                                | Tag clouds, icon grids, responsive item collections              |
| [UniformGrid](/docs/controls/layout/panels/uniformgrid)     | Equal-sized cells                       | Yes                                                | Calculator keypads, image galleries, dashboards with equal tiles |
| [RelativePanel](/docs/controls/layout/panels/relativepanel) | Relative to siblings or panel edges     | Yes                                                | Adaptive layouts that rearrange based on available space         |
| [Canvas](/docs/controls/layout/panels/canvas)               | Absolute coordinates                    | No                                                 | Drawing surfaces, diagrams, custom overlays                      |
| [Panel](/docs/controls/layout/panels/panel)                 | Layered on top of each other            | Yes                                                | Overlays, stacking visuals at the same position                  |

## Panel details[​](#panel-details "Direct link to Panel details")
...
### DockPanel[​](#dockpanel "Direct link to DockPanel")
...
### StackPanel[​](#stackpanel "Direct link to StackPanel")
...
### WrapPanel[​](#wrappanel "Direct link to WrapPanel")
...
### UniformGrid[​](#uniformgrid "Direct link to UniformGrid")
...
### RelativePanel[​](#relativepanel "Direct link to RelativePanel")
...
### Panel[​](#panel "Direct link to Panel")
...
## Nesting panels[​](#nesting-panels "Direct link to Nesting panels")
...
* [Layout](/docs/layout/layout) for how the measure and arrange system works.
* [Positioning Controls](/docs/layout/positioning-controls.md) for alignment, margin, and padding.
* [Responsive Layout How-To](/docs/how-to/responsive-layout-how-to.md) for adaptive layout techniques.
* Individual panel references: [Grid](/controls/layout/panels/grid.md), [DockPanel](/controls/layout/panels/dockpanel.md), [StackPanel](/controls/layout/panels/stackpanel.md), [WrapPanel](/controls/layout/panels/wrappanel.md), [Canvas](/controls/layout/panels/canvas.md), [RelativePanel](/controls/layout/panels/relativepanel.md), [UniformGrid](/controls/layout/panels/uniformgrid.md), [Panel](/controls/layout/panels/panel.md).
