...
## Approaches at a glance[​](#approaches-at-a-glance "Direct link to Approaches at a glance")
...
### Declaring a container[​](#declaring-a-container "Direct link to Declaring a container")
...
### Writing a container query[​](#writing-a-container-query "Direct link to Writing a container query")
...
### Adjusting layout structure with breakpoints[​](#adjusting-layout-structure-with-breakpoints "Direct link to Adjusting layout structure with breakpoints")
...
### Customising non-layout properties[​](#customising-non-layout-properties "Direct link to Customising non-layout properties")
...
### Combining queries[​](#combining-queries "Direct link to Combining queries")
...
For the full query syntax, available query types, and restrictions, see [Container queries](/docs/styling/container-queries.md).
...
## OnFormFactor[​](#onformfactor "Direct link to OnFormFactor")
...
### Form factor values[​](#form-factor-values "Direct link to Form factor values")
...
### OnPlatform[​](#onplatform "Direct link to OnPlatform")
...
## Reflowing panels[​](#reflowing-panels "Direct link to Reflowing panels")
...
## Breakpoint view models[​](#breakpoint-view-models "Direct link to Breakpoint view models")
...
* [Container queries](/docs/styling/container-queries.md): Full query syntax, container sizing modes, and restrictions.
* [How to: Build responsive layouts](/docs/how-to/responsive-layout-how-to.md): Step-by-step recipes for common responsive patterns.
...
* [`OnFormFactorExtension` API reference](/api/avalonia/markup/xaml/markupextensions/onformfactorextension.md)
* [`OnPlatformExtension` API reference](/api/avalonia/markup/xaml/markupextensions/onplatformextension.md)
