...
## From Delphi (VCL / FireMonkey)[​](#from-delphi-vcl--firemonkey "Direct link to From Delphi (VCL / FireMonkey)")
...
| `TButton`                    | `Button`                                       |                                 |
| `TEdit`                      | [`TextBox`](/api/avalonia/controls/textbox.md) |                                 |
...
## From Qt (QML / Qt Widgets)[​](#from-qt-qml--qt-widgets "Direct link to From Qt (QML / Qt Widgets)")
...
### Concept mapping[​](#concept-mapping-1 "Direct link to Concept mapping")
...
## From Electron[​](#from-electron "Direct link to From Electron")
...
### Why teams move away from Electron[​](#why-teams-move-away-from-electron "Direct link to Why teams move away from Electron")
...
### What Avalonia offers instead[​](#what-avalonia-offers-instead "Direct link to What Avalonia offers instead")
...
## From ASP.NET MVC / Blazor (Web to Desktop)[​](#from-aspnet-mvc--blazor-web-to-desktop "Direct link to From ASP.NET MVC / Blazor (Web to Desktop)")
...
### What transfers directly[​](#what-transfers-directly "Direct link to What transfers directly")
...
### What changes[​](#what-changes "Direct link to What changes")
...
* **Navigation is application-managed:** There is no URL routing. Navigation is handled by swapping views based on application state, or by using [NavigationPage](/controls/navigation/navigationpage.md) for stack-based page navigation.
...
2. **[Learn XAML basics](/docs/xaml.md):** Understand how Avalonia declares UI.
3. **[Learn data binding](/docs/data-binding):** The foundation of how Avalonia connects UI to data.
4. **[Explore the controls](/controls.md):** See what is available out of the box.
