...
Avalonia's approach is more concise and composable. For a full guide on how styling works, see [Styles](/docs/styling/styles.md).

#### AdaptiveTrigger to container queries[​](#adaptivetrigger-to-container-queries "Direct link to AdaptiveTrigger to container queries")
...
For the full query syntax, see [Container queries](/docs/styling/container-queries.md). For guidance on choosing between container queries, `OnFormFactor`, reflowing panels, and code-driven breakpoints, see [Responsive layouts](/docs/layout/responsive-layouts.md).

### XAML namespace[​](#xaml-namespace "Direct link to XAML namespace")
...
| WinUI / UWP             | Avalonia                                                                     | Notes                                                                                                                                 |
| ----------------------- | ---------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| `NavigationView`        | No direct equivalent                                                         | Use [`SplitView`](/api/avalonia/controls/splitview.md) with a [`ListBox`](/api/avalonia/controls/listbox.md) or a third-party control |
...
| `Page` / `Frame`        | [`NavigationPage`](/api/avalonia/controls/navigationpage.md) / `ContentPage` | See [NavigationPage](/controls/navigation/navigationpage.md)                                                                          |
...
For full details on `NavigationPage`, see [NavigationPage](/controls/navigation/navigationpage.md).

### Resources and theming[​](#resources-and-theming "Direct link to Resources and theming")
...
* [Container queries](/docs/styling/container-queries.md): Size-based styling, replacing WinUI's AdaptiveTrigger.
