...
## Template storage[​](#template-storage "Direct link to Template storage")
...
In Avalonia, data templates are not stored in resources. Instead, they are placed in a [`DataTemplates`](/api/avalonia/controls/templates/datatemplates.md) collection that exists on every `Control` and on `Application`:
...
## DataType matching[​](#datatype-matching "Direct link to DataType matching")
...
## DataTemplateSelector replacement[​](#datatemplateselector-replacement "Direct link to DataTemplateSelector replacement")
...
## TreeDataTemplate[​](#treedatatemplate "Direct link to TreeDataTemplate")
...
## ItemTemplate and ContentTemplate[​](#itemtemplate-and-contenttemplate "Direct link to ItemTemplate and ContentTemplate")
...
## x<!-- -->:DataType<!-- --> for compiled bindings[​](#x-for-compiled-bindings "Direct link to x-for-compiled-bindings")
...
* [Introduction to Data Templates](/docs/data-templates/introduction-to-data-templates.md)
* [Data Template Collection](/docs/data-templates/data-template-collection.md)
* [Compiled Bindings](/docs/data-binding/compiled-bindings.md)
