...
## Property types comparison[​](#property-types-comparison "Direct link to Property types comparison")
...
### StyledProperty[​](#styledproperty "Direct link to StyledProperty")
...
### DirectProperty[​](#directproperty "Direct link to DirectProperty")
...
### AttachedProperty[​](#attachedproperty "Direct link to AttachedProperty")
...
## Property changed callbacks[​](#property-changed-callbacks "Direct link to Property changed callbacks")

### WPF approach[​](#wpf-approach "Direct link to WPF approach")
...
### Avalonia approaches[​](#avalonia-approaches "Direct link to Avalonia approaches")
...
## Value coercion[​](#value-coercion "Direct link to Value coercion")
...
## Value precedence[​](#value-precedence "Direct link to Value precedence")
...
For a detailed breakdown of how Avalonia resolves property values, see the [Value Precedence](/docs/properties/value-precedence.md) page.

## Common gotchas[​](#common-gotchas "Direct link to Common gotchas")

### No PropertyMetadata constructor with a default value[​](#no-propertymetadata-constructor-with-a-default-value "Direct link to No PropertyMetadata constructor with a default value")
...
### SetAndRaise replaces SetValue for DirectProperty[​](#setandraise-replaces-setvalue-for-directproperty "Direct link to SetAndRaise replaces SetValue for DirectProperty")
...
### StyledProperty values live in the property system[​](#styledproperty-values-live-in-the-property-system "Direct link to StyledProperty values live in the property system")
...
### Use AddOwner instead of OverrideMetadata for shared properties[​](#use-addowner-instead-of-overridemetadata-for-shared-properties "Direct link to Use AddOwner instead of OverrideMetadata for shared properties")
...
* [Value Precedence](/docs/properties/value-precedence.md)
* [Defining Properties on Custom Controls](/docs/custom-controls/defining-properties.md)
