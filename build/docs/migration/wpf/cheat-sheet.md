...
## Property system[​](#property-system "Direct link to Property system")
...
### DataTrigger equivalent[​](#datatrigger-equivalent "Direct link to DataTrigger equivalent")
...
| [`ListBox`](/api/avalonia/controls/listbox.md) | `ListBox`                                             | Same                                         |
...
| `Image`                                        | `Image`                                               | Same                                         |
| [`Border`](/api/avalonia/controls/border.md)   | `Border`                                              | Same; supports `BoxShadow`                   |
...
| `GroupBox`                                     | [`GroupBox`](/controls/layout/containers/groupbox.md) | Same                                         |
...
| WPF                                                                  | Avalonia                         | Notes                                            |
| -------------------------------------------------------------------- | -------------------------------- | ------------------------------------------------ |
| [`RoutedEvent`](/api/avalonia/interactivity/routedevent.md) (Bubble) | `RoutedEvent` (Bubble)           | Same                                             |
...
| WPF                                                                   | Avalonia                       | Notes                 |
| --------------------------------------------------------------------- | ------------------------------ | --------------------- |
| [`DataTemplate`](/api/avalonia/markup/xaml/templates/datatemplate.md) | `DataTemplate`                 | Same                  |
...
| [`VisualBrush`](/api/avalonia/media/visualbrush.md) | `VisualBrush`            | Same                              |
...
## Platform services[​](#platform-services "Direct link to Platform services")

| WPF                                                                   | Avalonia                                                  | Notes                                                                       |
| --------------------------------------------------------------------- | --------------------------------------------------------- | --------------------------------------------------------------------------- |
| `SystemParameters.PrimaryScreenWidth`                                 | `TopLevel.GetTopLevel(this).Screens.Primary.Bounds.Width` | Access via [`Screens`](/api/avalonia/controls/screens.md) on any `TopLevel` |
...
See [Working with screens](/docs/app-development/window-management.md#working-with-screens) for full usage details.
...
1. **No triggers**: Avalonia uses pseudo-classes and CSS-like selectors instead of WPF triggers. See [Pseudo-Classes](/docs/styling/pseudoclasses.md).
...
* [Migrating from WPF](/docs/migration/wpf.md): Detailed migration guides.
* [Avalonia Architecture](/docs/fundamentals/architecture.md): How Avalonia works internally.
* [Style Selectors](/docs/styling/style-selectors.md): CSS-like selector syntax.
* [Data Binding Syntax](/docs/data-binding/data-binding-syntax.md): Avalonia binding syntax.
