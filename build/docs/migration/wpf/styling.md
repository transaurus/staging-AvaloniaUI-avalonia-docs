...
## Style declaration[​](#style-declaration "Direct link to Style declaration")

In WPF, styles are defined as resources and referenced by type or key. In Avalonia, styles live in a dedicated [`Styles`](/api/avalonia/styling/styles.md) collection and use CSS-like selectors to target controls.
...
## Selectors vs TargetType[​](#selectors-vs-targettype "Direct link to Selectors vs TargetType")
...
For the full selector reference, see [Style Selectors](/docs/styling/style-selectors.md).

## Style classes vs x<!-- -->:Key[​](#style-classes-vs-x "Direct link to style-classes-vs-x")
...
## Triggers to pseudo-classes[​](#triggers-to-pseudo-classes "Direct link to Triggers to pseudo-classes")
...
### Property triggers to pseudo-classes[​](#property-triggers-to-pseudo-classes "Direct link to Property triggers to pseudo-classes")
...
For the full list, see [Pseudo-Classes](/docs/styling/pseudoclasses.md).

### DataTrigger migration[​](#datatrigger-migration "Direct link to DataTrigger migration")
...
Container queries eliminate the need for converters and `RelativeSource` bindings. They can also target multiple properties at once and combine width and height conditions. See [Container queries](/docs/styling/container-queries.md) for the full syntax and [Responsive layouts](/docs/layout/responsive-layouts.md) for guidance on building adaptive UIs.

### EventTrigger to animations on pseudo-classes[​](#eventtrigger-to-animations-on-pseudo-classes "Direct link to EventTrigger to animations on pseudo-classes")
...
## ControlTheme vs implicit styles[​](#controltheme-vs-implicit-styles "Direct link to ControlTheme vs implicit styles")

In WPF, an implicit style (a `Style` with `TargetType` but no `x:Key`) defines the default look for a control, including its `ControlTemplate`. In Avalonia, this role is filled by [`ControlTheme`](/api/avalonia/styling/controltheme.md).
...
For more details, see [Control Themes](/docs/styling/control-themes.md).

## TemplateBinding[​](#templatebinding "Direct link to TemplateBinding")
...
* [Container queries](/docs/styling/container-queries.md): Size-based styling, replacing WPF DataTrigger patterns on ActualWidth/ActualHeight.
* [Responsive layouts](/docs/layout/responsive-layouts.md): Building adaptive layouts with container queries and reflowing panels.
