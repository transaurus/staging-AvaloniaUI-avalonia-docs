...
## Panel types[​](#panel-types "Direct link to Panel types")

| WPF                                                  | Avalonia                 | Notes                                                  |
| ---------------------------------------------------- | ------------------------ | ------------------------------------------------------ |
| [`StackPanel`](/api/avalonia/controls/stackpanel.md) | `StackPanel`             | Same. Avalonia adds a `Spacing` property.              |
| [`Grid`](/api/avalonia/controls/grid.md)             | `Grid`                   | Same. Supports shorthand `ColumnDefinitions="Auto,*"`. |
...
## Grid shorthand syntax[​](#grid-shorthand-syntax "Direct link to Grid shorthand syntax")
...
## Panel vs Grid for layering[​](#panel-vs-grid-for-layering "Direct link to Panel vs Grid for layering")
...
## ScrollViewer differences[​](#scrollviewer-differences "Direct link to ScrollViewer differences")
...
* [Positioning Controls](/docs/layout/positioning-controls.md): Margins, alignment, and positioning.
