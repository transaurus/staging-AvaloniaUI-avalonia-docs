...
## Option 1: Avalonia MAUI backend[​](#option-1-avalonia-maui-backend "Direct link to Option 1: Avalonia MAUI backend")
...
At its core, the Avalonia MAUI Backend builds a single set of handlers that map MAUI controls to Avalonia controls. When you create a [`Button`](/api/avalonia/controls/button.md) in MAUI, it renders as an Avalonia `Button` on every platform, rather than a platform-specific native control.
...
### What this means for your code[​](#what-this-means-for-your-code "Direct link to What this means for your code")
...
## Option 2: migrate to Avalonia[​](#option-2-migrate-to-avalonia "Direct link to Option 2: migrate to Avalonia")
...
### Different rendering models[​](#different-rendering-models "Direct link to Different rendering models")
...
#### XAML dialect[​](#xaml-dialect "Direct link to XAML dialect")
...
| .NET MAUI                                                    | Avalonia                                       | Notes                                                        |
| ------------------------------------------------------------ | ---------------------------------------------- | ------------------------------------------------------------ |
| `Entry`                                                      | [`TextBox`](/api/avalonia/controls/textbox.md) |                                                              |
...
| [`NavigationPage`](/api/avalonia/controls/navigationpage.md) | `NavigationPage`                               | See [NavigationPage](/controls/navigation/navigationpage.md) |
...
MAUI has `VisualStateManager` for interactive states. Avalonia uses pseudo-classes (`:pointerover`, `:pressed`, `:disabled`, `:checked`) as part of the selector, which is more concise. See [Styles](/docs/styling/styles.md) for the full reference.
...
For full details, see [NavigationPage](/controls/navigation/navigationpage.md).
...
#### 1. Create a new Avalonia project[​](#1-create-a-new-avalonia-project "Direct link to 1. Create a new Avalonia project")
...
#### 2. Move your models and services[​](#2-move-your-models-and-services "Direct link to 2. Move your models and services")
...
#### 3. Migrate your view models[​](#3-migrate-your-view-models "Direct link to 3. Migrate your view models")
...
#### 4. Convert your XAML files[​](#4-convert-your-xaml-files "Direct link to 4. Convert your XAML files")
...
#### 5. Convert your styles and resources[​](#5-convert-your-styles-and-resources "Direct link to 5. Convert your styles and resources")
...
#### 6. Replace navigation[​](#6-replace-navigation "Direct link to 6. Replace navigation")
...
#### 7. Handle platform-specific code[​](#7-handle-platform-specific-code "Direct link to 7. Handle platform-specific code")
...
### What you gain[​](#what-you-gain "Direct link to What you gain")
...
* [Styles](/docs/styling/styles.md): How Avalonia's CSS-like styling works.
* [Data Binding Syntax](/docs/data-binding/data-binding-syntax.md): Avalonia binding syntax reference.
* [Controls Reference](/controls.md): Full Avalonia controls documentation.
* [NavigationPage](/controls/navigation/navigationpage.md): Stack-based page navigation in Avalonia.
