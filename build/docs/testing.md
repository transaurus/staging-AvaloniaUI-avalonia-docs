...
### Headless tests[​](#headless-tests "Direct link to Headless tests")

The [headless platform](/docs/testing/setting-up-the-headless-platform.md) runs Avalonia's full control tree, layout engine, styling, and data binding in memory without opening a window. You simulate keyboard and mouse input through helper methods. This is the right choice for testing control behavior, data binding, focus management, and command execution.

Avalonia provides integration packages for [xUnit](/docs/testing/headless-xunit.md) and [NUnit](/docs/testing/headless-nunit.md) that handle setup automatically.
...
* [Headless Testing Platform](/docs/testing/setting-up-the-headless-platform.md): Input simulation, frame capture, and async handling.
* [Headless Testing with XUnit](/docs/testing/headless-xunit.md): XUnit integration setup.
* [Headless Testing with NUnit](/docs/testing/headless-nunit.md): NUnit integration setup.
* [UI Testing with Appium](/docs/testing/ui-testing-with-appium.md): End-to-end testing with a real window.
