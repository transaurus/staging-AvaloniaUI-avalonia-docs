...
## Creating a templated control[​](#creating-a-templated-control "Direct link to Creating a templated control")
...
## Defining the control theme[​](#defining-the-control-theme "Direct link to Defining the control theme")
...
* Inside the `ControlTemplate`, use [`TemplateBinding`](/api/avalonia/data/templatebinding.md) to bind to properties on the templated control.
...
## TemplateBinding details[​](#templatebinding-details "Direct link to TemplateBinding details")
...
## Pseudo-classes[​](#pseudo-classes "Direct link to Pseudo-classes")
