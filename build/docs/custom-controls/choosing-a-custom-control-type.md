...
Avalonia provides various approaches for creating custom controls to meet your application's specific needs. Understanding the different types of custom controls will help you choose the most appropriate approach for your requirements. In Avalonia, the three common types of custom controls are [`UserControl`](/api/avalonia/controls/usercontrol.md)s, lookless controls, and custom-drawn controls.

## UserControl[​](#usercontrol "Direct link to UserControl")
...
[Clone the ](https://github.com/AvaloniaUI/AvaloniaUI.QuickGuides/tree/main/CustomControl)

<!-- -->

[Custom Control](https://github.com/AvaloniaUI/AvaloniaUI.QuickGuides/tree/main/CustomControl)

<!-- -->

[ sample](https://github.com/AvaloniaUI/AvaloniaUI.QuickGuides/tree/main/CustomControl)

## Templated (lookless) controls[​](#templated-lookless-controls "Direct link to Templated (lookless) controls")
...
Templated controls are typically used for general-purpose user-interface elements that are not specific to business logic and may require different themes or visual styles. Most of the [built-in controls](/controls.md) supplied by Avalonia are templated controls.
...
2. **Control Template**: Create a [`ControlTheme`](/docs/styling/control-themes.md) in XAML that specifies the visual appearance and structure of the control. The control template defines the parts of the control and how they should be styled.
...
## Custom-drawn controls[​](#custom-drawn-controls "Direct link to Custom-drawn controls")
...
* [Custom Control Class](/docs/custom-controls/custom-control-class.md)
