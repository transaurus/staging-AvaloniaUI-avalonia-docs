...
## Layout process[​](#layout-process "Direct link to Layout process")
...
## Practical example: radial panel[​](#practical-example-radial-panel "Direct link to Practical example: radial panel")
...
## Using attached properties[​](#using-attached-properties "Direct link to Using attached properties")
...
For a full guide on defining attached properties, see [Attached Properties](/docs/custom-controls/attached-properties.md).
