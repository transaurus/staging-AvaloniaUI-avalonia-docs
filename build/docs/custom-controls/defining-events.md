...
## Routed event[​](#routed-event "Direct link to Routed event")
...
## Handling events in XAML[​](#handling-events-in-xaml "Direct link to Handling events in XAML")
...
* [Routed Events](/docs/input-interaction/routed-events.md): Full routed events reference.
* [Events System](/docs/events/index): Overview of the events system.
* [Input Events](/docs/events/input-events.md): Built-in input events.
