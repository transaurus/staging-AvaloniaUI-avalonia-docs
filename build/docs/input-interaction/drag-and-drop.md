...
Avalonia supports drag-and-drop operations for transferring data between controls or between your application and the operating system. The drag-and-drop system uses the [`DragDrop`](/api/avalonia/input/dragdrop.md) static class and the [`DataTransfer`](/api/avalonia/input/datatransfer.md) type to manage data during operations.

## Enabling drop on a target[​](#enabling-drop-on-a-target "Direct link to Enabling drop on a target")
...
## Drag-and-drop events[​](#drag-and-drop-events "Direct link to Drag-and-drop events")
...
## Handling drop events[​](#handling-drop-events "Direct link to Handling drop events")
...
## DragDropEffects[​](#dragdropeffects "Direct link to DragDropEffects")
...
## Starting a drag operation[​](#starting-a-drag-operation "Direct link to Starting a drag operation")
...
## DataTransfer and data formats[​](#datatransfer-and-data-formats "Direct link to DataTransfer and data formats")
...
### Setting data[​](#setting-data "Direct link to Setting data")
...
## Visual feedback during drag[​](#visual-feedback-during-drag "Direct link to Visual feedback during drag")
...
## Handling events in XAML vs code[​](#handling-events-in-xaml-vs-code "Direct link to Handling events in XAML vs code")
...
* [Pointer Events](/docs/input-interaction/pointer.md): Detecting pointer movement for initiating drags.
* [Clipboard](/docs/services/clipboard.md): Sharing data via the clipboard.
* [Storage Provider](/docs/services/storage/storage-provider.md): Working with files and folders.
