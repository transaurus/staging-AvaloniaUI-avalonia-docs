...
| ------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------- |
| [`PinchGestureRecognizer`](/docs/input-interaction/gestures/pinch-gesture-recognizer.md)   | Two pointers moving towards or away from each other. Used for pinch-to-zoom.                    |
| [`PullGestureRecognizer`](/docs/input-interaction/gestures/pull-gesture-recognizer.md)     | A pointer dragged from the edge of a control in a specific direction. Used for pull-to-refresh. |
| [`ScrollGestureRecognizer`](/docs/input-interaction/gestures/scroll-gesture-recognizer.md) | A pointer dragged to scroll content horizontally, vertically, or both.                          |

## Attaching a gesture recognizer[​](#attaching-a-gesture-recognizer "Direct link to Attaching a gesture recognizer")
...
## Subscribing to gesture events[​](#subscribing-to-gesture-events "Direct link to Subscribing to gesture events")
...
## Holding gesture[​](#holding-gesture "Direct link to Holding gesture")
...
* [Pointer Events](/docs/input-interaction/pointer.md): Lower-level pointer events that gestures are built on.
