...
Focus refers to the [`InputElement`](/api/avalonia/input/inputelement.md) that is expected to receive keyboard input. Focused controls are typically distinguished with a visual indicator. The most familiar example is a `TextBox` with a blinking cursor inside, but non-textual controls like `Button` and [`Slider`](/api/avalonia/controls/slider.md) also participate in focus.
...
## `IsFocused` and `Focusable`[​](#isfocused-and-focusable "Direct link to isfocused-and-focusable")
...
| `Directional`      | 2D directional ([`XYFocus`](/api/avalonia/input/xyfocus.md)) |
| `Unspecified`      | Default                                                      |

## Focus events[​](#focus-events "Direct link to Focus events")
...
## Focus pseudoclasses[​](#focus-pseudoclasses "Direct link to Focus pseudoclasses")
...
The `FocusManager` provides global access to focus functionality, such as retrieving the currently focused element or clearing focus. For additional information, see the [FocusManager docs](/docs/services/focus-manager.md).
...
## Tab focus navigation[​](#tab-focus-navigation "Direct link to Tab focus navigation")
...
## Directional focus navigation[​](#directional-focus-navigation "Direct link to Directional focus navigation")
...
### Explicit navigation[​](#explicit-navigation "Direct link to Explicit navigation")
...
![Directional Navigation Example](/assets/images/directional-navigation-420ad0add3d83b32bb2415cc4d10f40d.gif)

## See also[​](#see-also "Direct link to See also")

* [Keyboard and hotkeys](/docs/input-interaction/keyboard-and-hotkeys.md): Key bindings and keyboard shortcuts.
* [FocusManager](/docs/services/focus-manager.md): Global focus management service.
* [Pointer events](/docs/input-interaction/pointer.md): Pointer device events.
* [Routed events](/docs/input-interaction/routed-events.md): How events travel through the element tree.
