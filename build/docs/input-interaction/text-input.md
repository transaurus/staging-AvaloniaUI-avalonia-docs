...
## How text input works[​](#how-text-input-works "Direct link to How text input works")
...
For most applications, you do not need to handle text input directly. Controls like [`TextBox`](/api/avalonia/controls/textbox.md) and `AutoCompleteBox` handle all text input automatically. This page covers scenarios where you need custom text input behavior.
...
### When to use TextInput vs KeyDown[​](#when-to-use-textinput-vs-keydown "Direct link to When to use TextInput vs KeyDown")
...
## Input method editors (IME)[​](#input-method-editors-ime "Direct link to Input method editors (IME)")
...
### IME composition in TextBox[​](#ime-composition-in-textbox "Direct link to IME composition in TextBox")
...
### Enabling IME on custom controls[​](#enabling-ime-on-custom-controls "Direct link to Enabling IME on custom controls")
...
### Requesting the on-screen keyboard from a custom control[​](#requesting-the-on-screen-keyboard-from-a-custom-control "Direct link to Requesting the on-screen keyboard from a custom control")
...
## On-screen keyboards[​](#on-screen-keyboards "Direct link to On-screen keyboards")
...
### Controlling keyboard visibility[​](#controlling-keyboard-visibility "Direct link to Controlling keyboard visibility")
...
### Keyboard types on mobile[​](#keyboard-types-on-mobile "Direct link to Keyboard types on mobile")
...
## Platform considerations[​](#platform-considerations "Direct link to Platform considerations")
...
* [Input Pane](/docs/services/input-pane.md): On-screen keyboard service.
* [TextBox Control](/controls/input/text-input/textbox.md): Built-in text input control.
