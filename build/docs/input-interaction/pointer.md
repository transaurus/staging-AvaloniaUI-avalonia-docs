...
Controls most often detect and respond to user input. The Avalonia input system uses both [direct and routed events](/docs/input-interaction/routed-events.md) to support text input, focus management, and mouse positioning.

Applications often have complex input requirements. Avalonia provides a [command system](/docs/input-interaction/adding-interactivity.md) that separates user input actions from the code that responds to those actions.
...
![](/assets/images/pointer-pressed-8e186992e7255d691861dfb44876db04.gif)

## Pointer types[​](#pointer-types "Direct link to Pointer types")
...
### Pen and stylus properties[​](#pen-and-stylus-properties "Direct link to Pen and stylus properties")
...
## Pointer position[​](#pointer-position "Direct link to Pointer position")
...
## Tap events[​](#tap-events "Direct link to Tap events")
...
## Cursor management[​](#cursor-management "Direct link to Cursor management")

### Setting the cursor on a control[​](#setting-the-cursor-on-a-control "Direct link to Setting the cursor on a control")
...
### Common cursor types[​](#common-cursor-types "Direct link to Common cursor types")
...
### Setting the cursor in code[​](#setting-the-cursor-in-code "Direct link to Setting the cursor in code")
...
### Changing the cursor during drag operations[​](#changing-the-cursor-during-drag-operations "Direct link to Changing the cursor during drag operations")
...
For the complete API documentation about pointer and tap events, see the [PointerEventArgs API reference](/api/avalonia/input/pointereventargs.md).

## See also[​](#see-also "Direct link to See also")

* [Gestures](/docs/input-interaction/gestures.md): Higher-level gesture events built on pointer events.
* [Drag and Drop](/docs/input-interaction/drag-and-drop.md): Drag-and-drop operations using pointer events.
* [Routed Events](/docs/input-interaction/routed-events.md): How events propagate through the element tree.
