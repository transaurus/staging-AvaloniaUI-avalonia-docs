...
## How commanding works[​](#how-commanding-works "Direct link to How commanding works")
...
## ICommand interface[​](#icommand-interface "Direct link to ICommand interface")
...
## Using RelayCommand (CommunityToolkit.Mvvm)[​](#using-relaycommand-communitytoolkitmvvm "Direct link to Using RelayCommand (CommunityToolkit.Mvvm)")
...
### Notifying CanExecute[​](#notifying-canexecute "Direct link to Notifying CanExecute")
...
## Controls that support commanding[​](#controls-that-support-commanding "Direct link to Controls that support commanding")
...
| [`KeyBinding`](/api/avalonia/input/keybinding.md) | `Command`                 | On key gesture          |
| `ToggleButton`                                    | `Command`                 | On toggle               |
| `SplitButton`                                     | `Command`                 | On primary button click |

## Keyboard shortcuts and commands[​](#keyboard-shortcuts-and-commands "Direct link to Keyboard shortcuts and commands")
...
## HotKey attached property[​](#hotkey-attached-property "Direct link to HotKey attached property")
...
* [How to Bind CanExecute](/docs/data-binding/how-to-bind-can-execute.md): Binding patterns for CanExecute.
* [Keyboard and Hotkeys](/docs/input-interaction/keyboard-and-hotkeys.md): Key bindings and keyboard input.
* [The MVVM Pattern](/docs/fundamentals/the-mvvm-pattern.md): Architecture for separating UI and logic.
