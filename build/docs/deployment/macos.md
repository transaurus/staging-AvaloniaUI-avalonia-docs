...
[Parcel](/tools/parcel/packaging-for-macos.md) automates macOS packaging for Avalonia apps. It handles bundle structure, `Info.plist` generation, code signing, notarization, and DMG creation from a single command. Parcel can also create macOS bundles from Windows and Linux. If you'd prefer to avoid the manual steps below, see the [Parcel setup guide](/tools/parcel/setup.md) to get started.

## Manual packaging[​](#manual-packaging "Direct link to Manual packaging")
...
### Making the application bundle[​](#making-the-application-bundle "Direct link to Making the application bundle")
...
If you need to register custom URL schemes or file type associations, see the [macOS platform integration guide](/docs/platform-specific-guides/macos.md).
...
#### Creating icon files[​](#creating-icon-files "Direct link to Creating icon files")

This type of icon file can not only be created on Apple devices, but it is also possible on Linux devices.<br /><!-- -->You can find more information about how you can achieve that in this blog post:<br />[Creating macOS Icons (icns) on Linux](https://dentrassi.de/2014/02/25/creating-mac-os-x-icons-icns-on-linux/)

#### About the `.app` executable file[​](#about-the-app-executable-file "Direct link to about-the-app-executable-file")
...
### Signing your app[​](#signing-your-app "Direct link to Signing your app")
...
### Running codesign and enabling hardened runtime[​](#running-codesign-and-enabling-hardened-runtime "Direct link to Running codesign and enabling hardened runtime")

Enabling hardened runtime is done in the same step as code signing. You have to codesign everything in the `.app` bundle under the `Contents/MacOS` folder, which is easiest to do with a script since there are a lot of files. To sign your files, you need an Apple developer account. To notarize your app, you'll need to do the following steps with a Developer ID certificate, which requires a paid Apple developer subscription.
...
### Notarizing your software[​](#notarizing-your-software "Direct link to Notarizing your software")
...
### App store packaging[​](#app-store-packaging "Direct link to App store packaging")
...
### Getting certificates[​](#getting-certificates "Direct link to Getting certificates")
...
### Sandbox and bundle[​](#sandbox-and-bundle "Direct link to Sandbox and bundle")
...
### Sandbox entitlements and signing[​](#sandbox-entitlements-and-signing "Direct link to Sandbox entitlements and signing")
...
### Packaging script[​](#packaging-script "Direct link to Packaging script")
...
### Testing a package[​](#testing-a-package "Direct link to Testing a package")
...
### Uploading a package to app store[​](#uploading-a-package-to-app-store "Direct link to Uploading a package to app store")
...
### Packaging in GitHub Actions workflow[​](#packaging-in-github-actions-workflow "Direct link to Packaging in GitHub Actions workflow")
