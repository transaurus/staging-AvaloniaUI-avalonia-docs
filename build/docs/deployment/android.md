...
## Running on an emulator[​](#running-on-an-emulator "Direct link to Running on an emulator")
...
### Create a keystore file[​](#create-a-keystore-file "Direct link to Create a keystore file")
...
#### Secure password handling[​](#secure-password-handling "Direct link to Secure password handling")
...
* [Android platform setup](/docs/platform-specific-guides/android.md)
