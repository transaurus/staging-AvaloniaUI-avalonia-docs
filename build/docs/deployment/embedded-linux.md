...
### Publish options explained[​](#publish-options-explained "Direct link to Publish options explained")
...
## Transferring to the device[​](#transferring-to-the-device "Direct link to Transferring to the device")
...
**USB drive:** Copy the publish directory to a USB drive, mount it on the target, and copy the files.
...
## Auto-starting on boot[​](#auto-starting-on-boot "Direct link to Auto-starting on boot")

For kiosk or appliance scenarios, configure the application to start automatically when the device boots.

### Using a systemd service[​](#using-a-systemd-service "Direct link to Using a systemd service")
...
## Reducing image size[​](#reducing-image-size "Direct link to Reducing image size")
...
* **Native AOT** compilation produces a smaller, fully native binary with no .NET runtime overhead. See [Native AOT deployment](/docs/deployment/native-aot.md) for details.
...
## Required libraries on the target[​](#required-libraries-on-the-target "Direct link to Required libraries on the target")
...
* [Embedded Linux platform integration](/docs/platform-specific-guides/embedded-linux.md) for framebuffer and DRM concepts
* [Running on Raspberry Pi](/docs/platform-specific-guides/embedded-linux/raspberry-pi.md) for a hardware-specific walkthrough
* [Desktop Linux deployment](/docs/deployment/linux.md) for `.deb` packaging
* [Native AOT deployment](/docs/deployment/native-aot.md)
