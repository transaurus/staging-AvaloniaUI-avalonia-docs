...
## Running on a simulator[​](#running-on-a-simulator "Direct link to Running on a simulator")
...
## Running on a device[​](#running-on-a-device "Direct link to Running on a device")
...
See the [iOS platform setup guide](/docs/platform-specific-guides/ios.md) for detailed steps on device provisioning with Xcode, including creating a free Apple developer signing certificate.
...
### Distribution options[​](#distribution-options "Direct link to Distribution options")
...
### Build and sign your app[​](#build-and-sign-your-app "Direct link to Build and sign your app")

#### Publishing from macOS[​](#publishing-from-macos "Direct link to Publishing from macOS")
...
#### Publishing from Windows[​](#publishing-from-windows "Direct link to Publishing from Windows")
...
### Build properties reference[​](#build-properties-reference "Direct link to Build properties reference")
...
#### Define properties in your project file[​](#define-properties-in-your-project-file "Direct link to Define properties in your project file")
...
### Distribute the app[​](#distribute-the-app "Direct link to Distribute the app")
...
## Mac Catalyst deployment[​](#mac-catalyst-deployment "Direct link to Mac Catalyst deployment")

If your iOS project targets Mac Catalyst (`net10.0-maccatalyst`), you can build and publish for macOS using the same project. See [Mac Catalyst](/docs/platform-specific-guides/ios.md#mac-catalyst) in the iOS platform guide for setup instructions.
...
* [iOS platform setup](/docs/platform-specific-guides/ios.md)
