...
## How precedence works[​](#how-precedence-works "Direct link to How precedence works")
...
## Clearing values[​](#clearing-values "Direct link to Clearing values")
...
## Setting values at specific priorities[​](#setting-values-at-specific-priorities "Direct link to Setting values at specific priorities")
...
## `SetCurrentValue`[​](#setcurrentvalue "Direct link to setcurrentvalue")
...
## Impact on data binding[​](#impact-on-data-binding "Direct link to Impact on data binding")
...
* [Property System Overview](/docs/properties/index): Overview of Avalonia property types.
* [Styles](/docs/styling/styles.md): How to define and apply styles.
* [Animations](/docs/graphics-animation/animations.md): How animations interact with properties.
