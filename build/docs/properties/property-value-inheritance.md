...
Inherited values have the lowest priority in the [value precedence](/docs/properties/value-precedence.md) system (just above `Unset`). A local value, style, or animation on a child will always override an inherited value.

## Built-in inherited properties[​](#built-in-inherited-properties "Direct link to Built-in inherited properties")

Several common properties in Avalonia are registered as inherited:

| Property                | Defined On                                                       | Effect                                                            |
| ----------------------- | ---------------------------------------------------------------- | ----------------------------------------------------------------- |
| `FontFamily`            | [`TextElement`](/api/avalonia/controls/documents/textelement.md) | Text controls inherit the font family from their parent.          |
...
## Creating an inherited property[​](#creating-an-inherited-property "Direct link to Creating an inherited property")
...
### Making the property available to descendants[​](#making-the-property-available-to-descendants "Direct link to Making the property available to descendants")
...
## Inheritance and `DataContext`[​](#inheritance-and-datacontext "Direct link to inheritance-and-datacontext")
...
* [Property System Overview](/docs/properties/index): Overview of property types and registration.
* [Value Precedence](/docs/properties/value-precedence.md): How inherited values fit into the priority order.
* [Data Context](/docs/data-binding/data-context.md): How the DataContext inherited property works with data binding.
