...
## Styled property metadata[​](#styled-property-metadata "Direct link to Styled property metadata")
...
### Overriding default values[​](#overriding-default-values "Direct link to Overriding default values")
...
### Triggering re-coercion[​](#triggering-re-coercion "Direct link to Triggering re-coercion")
...
## Value validation[​](#value-validation "Direct link to Value validation")
...
### Override `OnPropertyChanged`[​](#override-onpropertychanged "Direct link to override-onpropertychanged")
...
### `GetObservable`[​](#getobservable "Direct link to getobservable")
...
## Direct property metadata[​](#direct-property-metadata "Direct link to Direct property metadata")
...
* [Value Precedence](/docs/properties/value-precedence.md): How the property system resolves values from multiple sources.
* [Property Value Inheritance](/docs/properties/property-value-inheritance.md): How values propagate down the tree.
