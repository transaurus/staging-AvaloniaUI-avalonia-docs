...
## Event routing strategies[​](#event-routing-strategies "Direct link to Event routing strategies")
...
### Bubble example[​](#bubble-example "Direct link to Bubble example")
...
### Tunnel example[​](#tunnel-example "Direct link to Tunnel example")
...
## Handling routed events[​](#handling-routed-events "Direct link to Handling routed events")
...
### In code[​](#in-code "Direct link to In code")
...
### Handling bubbled events on a parent[​](#handling-bubbled-events-on-a-parent "Direct link to Handling bubbled events on a parent")
...
## Marking events as handled[​](#marking-events-as-handled "Direct link to Marking events as handled")
...
## `RoutedEventArgs` properties[​](#routedeventargs-properties "Direct link to routedeventargs-properties")
...
## Registering custom routed events[​](#registering-custom-routed-events "Direct link to Registering custom routed events")
...
### Custom event args[​](#custom-event-args "Direct link to Custom event args")
...
* [Routed Events](/docs/input-interaction/routed-events.md): Detailed reference on the routed event system.
* [Lifecycle Events](/docs/events/lifecycle-events.md): Events that fire during control creation, loading, and teardown.
* [Input Events](/docs/events/input-events.md): Pointer, keyboard, and gesture events.
* [Adding Interactivity](/docs/input-interaction/adding-interactivity.md): Practical guide to handling user interaction.
