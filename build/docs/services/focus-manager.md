...
The [`FocusManager`](/api/avalonia/input/focusmanager.md) service is responsible for managing keyboard focus in your application. It keeps track of the currently focused element and the current focus scope.

You can access `FocusManager` through an instance of [`TopLevel`](/api/avalonia/controls/toplevel.md) or `Window`. For more details on accessing `TopLevel`, visit the [TopLevel](/docs/fundamentals/top-level.md) page.
...
### `GetFocusedElement()`[​](#getfocusedelement "Direct link to getfocusedelement")
...
### `ClearFocus()`[​](#clearfocus "Direct link to clearfocus")
...
### Focusing a control[​](#focusing-a-control "Direct link to Focusing a control")
...
### Listening for global focus changes[​](#listening-for-global-focus-changes "Direct link to Listening for global focus changes")
...
### Tab navigation order[​](#tab-navigation-order "Direct link to Tab navigation order")
...
### Preventing a control from receiving focus[​](#preventing-a-control-from-receiving-focus "Direct link to Preventing a control from receiving focus")
...
### Focus on load[​](#focus-on-load "Direct link to Focus on load")
...
* [Focus](/docs/input-interaction/focus.md): Focus system overview and focus events.
* [TopLevel](/docs/fundamentals/top-level.md): Accessing platform services from `TopLevel`.
