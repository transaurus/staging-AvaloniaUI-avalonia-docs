...
### Deactivated[​](#deactivated "Direct link to Deactivated")
...
### TryLeaveBackground[​](#tryleavebackground "Direct link to TryLeaveBackground")
...
### TryEnterBackground[​](#tryenterbackground "Direct link to TryEnterBackground")
...
## Subscribing early for startup events[​](#subscribing-early-for-startup-events "Direct link to Subscribing early for startup events")
...
### Entering and exiting background state[​](#entering-and-exiting-background-state "Direct link to Entering and exiting background state")
...
### Handling URI activation[​](#handling-uri-activation "Direct link to Handling URI activation")
...
### Handling file activation[​](#handling-file-activation "Direct link to Handling file activation")
