...
The `InputPane` can be access through an instance of `TopLevel` or `Window`, for more details on accessing `TopLevel` please visit [TopLevel](/docs/fundamentals/top-level.md) page.
...
### OccludedRect[​](#occludedrect "Direct link to OccludedRect")
...
### StateChanged[​](#statechanged "Direct link to StateChanged")
...
* [Insets Manager](/docs/services/insets-manager.md): System bar visibility and safe area management.
