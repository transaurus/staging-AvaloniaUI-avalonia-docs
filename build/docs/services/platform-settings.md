...
You access `PlatformSettings` through the `GetPlatformSettings` extension method on any `Visual`. For more details on accessing platform services, visit the [TopLevel](/docs/fundamentals/top-level.md) page.
...
### `GetTapSize(PointerType type)`[​](#gettapsizepointertype-type "Direct link to gettapsizepointertype-type")
...
### `GetDoubleTapSize(PointerType type)`[​](#getdoubletapsizepointertype-type "Direct link to getdoubletapsizepointertype-type")
...
### `GetDoubleTapTime(PointerType type)`[​](#getdoubletaptimepointertype-type "Direct link to getdoubletaptimepointertype-type")
...
### `GetColorValues()`[​](#getcolorvalues "Direct link to getcolorvalues")
...
### `HoldWaitDuration`[​](#holdwaitduration "Direct link to holdwaitduration")
...
### `HotkeyConfiguration`[​](#hotkeyconfiguration "Direct link to hotkeyconfiguration")
...
Handling platform-specific hotkeys
...
### `ColorValuesChanged`[​](#colorvalueschanged "Direct link to colorvalueschanged")
...
Responding to system color changes
...
* [Pointer events](/docs/input-interaction/pointer.md): Working with pointer input and gestures.
* [Gestures](/docs/input-interaction/gestures.md): Handling tap and other gesture events.
