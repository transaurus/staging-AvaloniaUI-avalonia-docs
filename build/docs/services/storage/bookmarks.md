...
## Avalonia.Platform.Storage[​](#avaloniaplatformstorage "Direct link to Avalonia.Platform.Storage")

### `IStorageBookmarkItem` interface[​](#istoragebookmarkitem-interface "Direct link to istoragebookmarkitem-interface")
...
### `IStorageBookmarkFolder` interface[​](#istoragebookmarkfolder-interface "Direct link to istoragebookmarkfolder-interface")
...
## How to use bookmark methods[​](#how-to-use-bookmark-methods "Direct link to How to use bookmark methods")

This section provides a practical guide on using `bookmark`.

### Saving and loading bookmarks[​](#saving-and-loading-bookmarks "Direct link to Saving and loading bookmarks")
...
### Reading and writing file content from a bookmark[​](#reading-and-writing-file-content-from-a-bookmark "Direct link to Reading and writing file content from a bookmark")
...
### Managing bookmarked files and folders[​](#managing-bookmarked-files-and-folders "Direct link to Managing bookmarked files and folders")
...
## Platform-specific bookmark representation[​](#platform-specific-bookmark-representation "Direct link to Platform-specific bookmark representation")
...
* [Storage Items](/docs/services/storage/storage-item.md): Working with files and folders.
