...
You can access the `Launcher` through an instance of `TopLevel` or `Window`. For more details on accessing `TopLevel`, visit the [TopLevel](/docs/fundamentals/top-level.md) page.
...
### `LaunchUriAsync`[​](#launchuriasync "Direct link to launchuriasync")
...
### `LaunchFileAsync`[​](#launchfileasync "Direct link to launchfileasync")
...
### `LaunchFileInfoAsync`[​](#launchfileinfoasync "Direct link to launchfileinfoasync")
...
### `LaunchDirectoryInfoAsync`[​](#launchdirectoryinfoasync "Direct link to launchdirectoryinfoasync")
...
* [Storage Provider](/docs/services/storage/storage-provider.md): File and folder management API.
* [Clipboard](/docs/services/clipboard.md): Reading and writing clipboard data.
