...
## What is a data template?[​](#what-is-a-data-template "Direct link to What is a data template?")

At its core, a Data Template is a reusable definition that specifies how to present data of a particular type. It defines the visual structure and appearance of the data when displayed in the user interface. In Avalonia, a Data Template is often associated with a list control, such as a [`ListBox`](/api/avalonia/controls/listbox.md) or `ItemsControl`, and is responsible for rendering individual items of data within that control.

## Applying a data template to a ListBox[​](#applying-a-data-template-to-a-listbox "Direct link to Applying a data template to a ListBox")
...
## Type-specific data templates[​](#type-specific-data-templates "Direct link to Type-specific data templates")
...
## Where data templates can be defined[​](#where-data-templates-can-be-defined "Direct link to Where data templates can be defined")
...
## Data templates in resources[​](#data-templates-in-resources "Direct link to Data templates in resources")
