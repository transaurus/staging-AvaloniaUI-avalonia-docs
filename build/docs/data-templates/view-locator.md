...
ViewLocator is optional. You can achieve the same result using [DataTemplates](/docs/data-templates/data-template-collection.md) defined in XAML. ViewLocator is included in the default Avalonia project templates as a convenience for MVVM applications.

## How it works[​](#how-it-works "Direct link to How it works")

ViewLocator implements the [`IDataTemplate`](/api/avalonia/controls/templates/idatatemplate.md) interface, which means it participates in Avalonia's standard data template resolution. When a [`ContentControl`](/api/avalonia/controls/contentcontrol.md) or similar presenter needs to display an object that is not a control, it searches for a matching `IDataTemplate`. A registered ViewLocator matches view model objects and builds the corresponding view.
...
## Registering the view locator[​](#registering-the-view-locator "Direct link to Registering the view locator")
...
## Using the view locator[​](#using-the-view-locator "Direct link to Using the view locator")
...
### XAML data templates[​](#xaml-data-templates "Direct link to XAML data templates")
...
This approach uses Avalonia's built-in template resolution with no custom code. See [Data Template Collection](/docs/data-templates/data-template-collection.md) for details on how template matching and search order work.
...
See [Dependency Injection](/docs/app-development/dependency-injection.md) for setting up your service provider.

### Source generators[​](#source-generators "Direct link to Source generators")
...
* [Introduction to Data Templates](/docs/data-templates/introduction-to-data-templates.md): How Avalonia selects and applies data templates.
...
* [Dependency Injection](/docs/app-development/dependency-injection.md): Setting up service registration for your application.
