...
### Common binding parameters[​](#common-binding-parameters "Direct link to Common binding parameters")
...
For a comprehensive guide to binding syntax, see [Data Binding Syntax](/docs/data-binding/data-binding-syntax.md).

## CompiledBinding[​](#compiledbinding "Direct link to CompiledBinding")
...
## ReflectionBinding[​](#reflectionbinding "Direct link to ReflectionBinding")
...
## StaticResource[​](#staticresource "Direct link to StaticResource")
...
### Resource lookup order[​](#resource-lookup-order "Direct link to Resource lookup order")
...
## DynamicResource[​](#dynamicresource "Direct link to DynamicResource")
...
## RelativeSource[​](#relativesource "Direct link to RelativeSource")
...
## Markup extension syntax rules[​](#markup-extension-syntax-rules "Direct link to Markup extension syntax rules")
...
* [Data Binding Syntax](/docs/data-binding/data-binding-syntax.md): Comprehensive binding syntax reference.
* [Compiled Bindings](/docs/data-binding/compiled-bindings.md): Compile-time validated bindings.
* [Markup Extensions (Data Binding)](/docs/data-binding/markup-extensions.md): Binding-specific markup extension details.
