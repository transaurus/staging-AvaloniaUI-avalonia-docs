...
## `x:TypeArguments`[​](#xtypearguments "Direct link to xtypearguments")
...
### Multiple type arguments[​](#multiple-type-arguments "Direct link to Multiple type arguments")
...
## Using generic collections in resources[​](#using-generic-collections-in-resources "Direct link to Using generic collections in resources")
...
## Generic custom controls[​](#generic-custom-controls "Direct link to Generic custom controls")
...
## Common generic types in XAML[​](#common-generic-types-in-xaml "Direct link to Common generic types in XAML")
...
## Workarounds for unsupported scenarios[​](#workarounds-for-unsupported-scenarios "Direct link to Workarounds for unsupported scenarios")
...
* [XAML Namespaces](/docs/xaml/namespaces.md): How to reference CLR namespaces in XAML.
* [x: Directives](/docs/xaml/directives.md): Full reference for `x:TypeArguments` and other directives.
* [Type Converters](/docs/xaml/type-converters.md): Converting string values to .NET types.
