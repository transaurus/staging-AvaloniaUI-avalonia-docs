...
## Default namespaces[​](#default-namespaces "Direct link to Default namespaces")
...
| `xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"` | The XAML language namespace. Provides access to [x: directives](/docs/xaml/directives.md) like `x:Name`, `x:Key`, and `x:Class`.                                                                      |

## CLR namespaces mapped to the default Avalonia namespace[​](#clr-namespaces-mapped-to-the-default-avalonia-namespace "Direct link to CLR namespaces mapped to the default Avalonia namespace")
...
## Referencing your own types[​](#referencing-your-own-types "Direct link to Referencing your own types")

To use your own classes in XAML, you need to declare a namespace prefix that maps to a CLR namespace.

### Using the `using:` prefix[​](#using-the-using-prefix "Direct link to using-the-using-prefix")
...
### Using the `clr-namespace:` prefix[​](#using-the-clr-namespace-prefix "Direct link to using-the-clr-namespace-prefix")
...
## Defining custom XML namespace mappings[​](#defining-custom-xml-namespace-mappings "Direct link to Defining custom XML namespace mappings")
...
## Common namespace prefixes by convention[​](#common-namespace-prefixes-by-convention "Direct link to Common namespace prefixes by convention")
...
### Design-time namespaces[​](#design-time-namespaces "Direct link to Design-time namespaces")
...
* [x: Directives](/docs/xaml/directives.md): XAML language directives.
* [Custom Control Library](/docs/custom-controls/custom-control-library.md): How to package controls with namespace mappings.
