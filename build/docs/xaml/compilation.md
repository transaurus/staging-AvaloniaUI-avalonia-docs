...
## How XAML compilation works[​](#how-xaml-compilation-works "Direct link to How XAML compilation works")
...
## Compiled bindings[​](#compiled-bindings "Direct link to Compiled bindings")
...
### Enabling compiled bindings per control[​](#enabling-compiled-bindings-per-control "Direct link to Enabling compiled bindings per control")
...
### Enabling compiled bindings project-wide[​](#enabling-compiled-bindings-project-wide "Direct link to Enabling compiled bindings project-wide")
...
With this setting, all bindings require an `x:DataType` declaration. To opt out for specific bindings that need runtime resolution, use [`ReflectionBinding`](/api/avalonia/data/reflectionbinding.md):
...
### x<!-- -->:DataType<!-- --> on nested elements[​](#x-on-nested-elements "Direct link to x-on-nested-elements")
...
## Build-time error examples[​](#build-time-error-examples "Direct link to Build-time error examples")
...
## Native AOT considerations[​](#native-aot-considerations "Direct link to Native AOT considerations")
...
For more details on AOT deployment, see [Native AOT](/docs/deployment/native-aot.md).

## Obsolete and experimental diagnostics[​](#obsolete-and-experimental-diagnostics "Direct link to Obsolete and experimental diagnostics")
...
## Troubleshooting XAML compilation[​](#troubleshooting-xaml-compilation "Direct link to Troubleshooting XAML compilation")

### Build errors in XAML files[​](#build-errors-in-xaml-files "Direct link to Build errors in XAML files")
...
### Suppressing errors for dynamic scenarios[​](#suppressing-errors-for-dynamic-scenarios "Direct link to Suppressing errors for dynamic scenarios")
...
### Design-time data types[​](#design-time-data-types "Direct link to Design-time data types")
...
* [Compiled Bindings](/docs/data-binding/compiled-bindings.md): Detailed compiled binding reference.
* [Avalonia XAML](/docs/fundamentals/avalonia-xaml.md): XAML fundamentals.
* [x: Directives](/docs/xaml/directives.md): Full reference for x
  <!-- -->
  :CompileBindings
  <!-- -->
  , x
...
* [Native AOT](/docs/deployment/native-aot.md): AOT deployment guide.
