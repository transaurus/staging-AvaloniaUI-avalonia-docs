...
## `x:Class`[​](#xclass "Direct link to xclass")
...
## `x:Name`[​](#xname "Direct link to xname")
...
## `x:Key`[​](#xkey "Direct link to xkey")
...
## `x:DataType`[​](#xdatatype "Direct link to xdatatype")

Specifies the expected data type for data binding within a scope. This is required for [compiled bindings](/docs/data-binding/compiled-bindings.md) and enables IntelliSense for binding paths.
...
## `x:CompileBindings`[​](#xcompilebindings "Direct link to xcompilebindings")
...
## `x:Static`[​](#xstatic "Direct link to xstatic")
...
## `x:Type`[​](#xtype "Direct link to xtype")
...
## `x:Null`[​](#xnull "Direct link to xnull")
...
## `x:True` and `x:False`[​](#xtrue-and-xfalse "Direct link to xtrue-and-xfalse")
...
## `x:Shared`[​](#xshared "Direct link to xshared")
...
## Primitive type elements[​](#primitive-type-elements "Direct link to Primitive type elements")
...
* [Namespaces](/docs/xaml/namespaces.md): How XAML namespaces work.
* [Markup Extensions](/docs/xaml/markup-extensions.md): `{Binding}`, `{StaticResource}`, and other extensions.
* [Compiled Bindings](/docs/data-binding/compiled-bindings.md): How compiled bindings work.
