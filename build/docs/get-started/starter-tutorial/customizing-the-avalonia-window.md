...
As [mentioned earlier](/docs/get-started/starter-tutorial.md), the Avalonia window is where your app will run on the target platform. In a .axaml file, the `<Window>...</Window>` tag defines what goes in the window.
...
1Margin2Border3Padding4Content

**Margin<!-- -->:**

<!-- -->

The outermost transparent space that creates distance between this control and neighboring elements.

## Default window attributes[​](#default-window-attributes "Direct link to Default window attributes")
...
## Setting the window's attributes[​](#setting-the-windows-attributes "Direct link to Setting the window's attributes")
...
### Setting the previewer size[​](#setting-the-previewer-size "Direct link to Setting the previewer size")
...
For more information, see the page on [previewing your UI design](/docs/app-development/xaml-preview-and-design-settings.md).

![A screenshot of an app running in a window in portrait orientation.](/assets/images/temperature-converter-portrait-orientation-933867e63d9c915fd3f6ca54a598d20b.png)

### Setting the runtime window size[​](#setting-the-runtime-window-size "Direct link to Setting the runtime window size")
