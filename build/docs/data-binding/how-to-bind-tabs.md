...
## Binding support example[​](#binding-support-example "Direct link to Binding support example")
...
## Tab lifecycle notes[​](#tab-lifecycle-notes "Direct link to Tab lifecycle notes")
...
* [TabControl](/controls/navigation/tabcontrol.md): Full reference for the `TabControl` control.
* [How to: Work with TabControl](/docs/how-to/tabcontrol-how-to.md): Static tabs, closeable tabs, and tab styling.
* [Data templates](/docs/data-templates/introduction-to-data-templates.md): Controlling how items are displayed.
* [Data binding syntax](/docs/data-binding/data-binding-syntax.md): Binding paths and modes.
