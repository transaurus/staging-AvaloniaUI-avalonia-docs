...
## What is INotifyPropertyChanged?[​](#what-is-inotifypropertychanged "Direct link to What is INotifyPropertyChanged?")
...
## Why is INotifyPropertyChanged important in MVVM?[​](#why-is-inotifypropertychanged-important-in-mvvm "Direct link to Why is INotifyPropertyChanged important in MVVM?")
...
## Implementing INotifyPropertyChanged[​](#implementing-inotifypropertychanged "Direct link to Implementing INotifyPropertyChanged")
...
## Using MVVM Toolkit to simplify INotifyPropertyChanged[​](#using-mvvm-toolkit-to-simplify-inotifypropertychanged "Direct link to Using MVVM Toolkit to simplify INotifyPropertyChanged")
...
* [The MVVM Pattern](/docs/fundamentals/the-mvvm-pattern.md): Introduction to the MVVM architectural pattern.
