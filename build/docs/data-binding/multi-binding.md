...
[`MultiBinding`](/api/avalonia/data/multibinding.md) combines values from multiple source properties into a single target property. It is useful when a display value depends on more than one data source, such as formatting a full name from separate first and last name properties, or computing a composite value.

## Basic usage with StringFormat[​](#basic-usage-with-stringformat "Direct link to Basic usage with StringFormat")
...
### Formatting numbers[​](#formatting-numbers "Direct link to Formatting numbers")
...
## Using an IMultiValueConverter[​](#using-an-imultivalueconverter "Direct link to Using an IMultiValueConverter")
...
### Defining the converter[​](#defining-the-converter "Direct link to Defining the converter")
...
### Using the converter in XAML[​](#using-the-converter-in-xaml "Direct link to Using the converter in XAML")
...
## Binding to controls[​](#binding-to-controls "Direct link to Binding to controls")
...
## MultiBinding properties[​](#multibinding-properties "Direct link to MultiBinding properties")
...
## FuncMultiValueConverter[​](#funcmultivalueconverter "Direct link to FuncMultiValueConverter")
...
### Visibility from multiple conditions[​](#visibility-from-multiple-conditions "Direct link to Visibility from multiple conditions")
...
### Computing a value from multiple inputs[​](#computing-a-value-from-multiple-inputs "Direct link to Computing a value from multiple inputs")
...
* [Data Binding Syntax](/docs/data-binding/data-binding-syntax.md): Binding parameters including StringFormat.
* [How to Create a Custom Converter](/docs/data-binding/how-to-create-a-custom-data-binding-converter.md): Single-value converters.
