...
The UI control that displays data. Examples include TextBox, TextBlock, and other Avalonia controls with bindable properties.
...
For more information about how to use the MVVM Pattern with Avalonia, see [The MVVM Pattern](/docs/fundamentals/the-mvvm-pattern.md).

info

For background information on the origins and development of the MVVM pattern at *Microsoft*, see the [Microsoft Patterns and Practices article](https://msdn.microsoft.com/en-us/library/hh848246.aspx).

## Binding modes[​](#binding-modes "Direct link to Binding modes")
...
## FallbackValue and TargetNullValue[​](#fallbackvalue-and-targetnullvalue "Direct link to FallbackValue and TargetNullValue")
...
* [The MVVM Pattern](/docs/fundamentals/the-mvvm-pattern.md): Architectural pattern used with data binding.
