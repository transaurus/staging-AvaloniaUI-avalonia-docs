...
## Validation with data annotations[​](#validation-with-data-annotations "Direct link to Validation with data annotations")
...
## INotifyDataErrorInfo[​](#inotifydataerrorinfo "Direct link to INotifyDataErrorInfo")
...
## Custom validation attributes[​](#custom-validation-attributes "Direct link to Custom validation attributes")
...
## Validation error display[​](#validation-error-display "Direct link to Validation error display")
...
Validation errors are also automatically exposed to screen readers and other assistive technologies through the [`DataValidationErrors`](/api/avalonia/controls/datavalidationerrors.md) automation peer. See [Accessibility](/docs/app-development/accessibility.md#data-validation-errors) for details.

### Customizing error display[​](#customizing-error-display "Direct link to Customizing error display")
...
### Showing errors below the control[​](#showing-errors-below-the-control "Direct link to Showing errors below the control")
...
## Validating on submit[​](#validating-on-submit "Direct link to Validating on submit")
...
## Exception-based validation[​](#exception-based-validation "Direct link to Exception-based validation")
...
* [The MVVM Pattern](/docs/fundamentals/the-mvvm-pattern.md): View model patterns and CommunityToolkit.Mvvm.
