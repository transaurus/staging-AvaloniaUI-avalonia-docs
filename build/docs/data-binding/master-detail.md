...
## Basic master-detail[​](#basic-master-detail "Direct link to Basic master-detail")

Bind a [`ListBox`](/api/avalonia/controls/listbox.md) to a collection and display the selected item's properties in an adjacent panel. The detail panel sets its `DataContext` to the `SelectedPerson` property, so every binding inside it resolves against the selected object:
...
## Editable detail view[​](#editable-detail-view "Direct link to Editable detail view")
...
## Master-detail with a separate detail view model[​](#master-detail-with-a-separate-detail-view-model "Direct link to Master-detail with a separate detail view model")
...
## Master-detail with navigation[​](#master-detail-with-navigation "Direct link to Master-detail with navigation")
...
## Nested master-detail[​](#nested-master-detail "Direct link to Nested master-detail")
...
## Placeholder for empty selection[​](#placeholder-for-empty-selection "Direct link to Placeholder for empty selection")
...
* [Bind to a collection](/docs/data-binding/how-to-bind-to-a-collection.md): Binding `ItemsSource` and `DataTemplate` usage.
* [Data templates](/docs/data-templates/introduction-to-data-templates.md): Controlling how items are displayed.
* [Data context](/docs/data-binding/data-context.md): How `DataContext` flows through the control tree.
* [Collection views](/docs/data-binding/collection-views.md): Sorting, filtering, and grouping bound collections.
* [Compiled bindings](/docs/data-binding/compiled-bindings.md): Improve binding performance and catch errors at compile time.
