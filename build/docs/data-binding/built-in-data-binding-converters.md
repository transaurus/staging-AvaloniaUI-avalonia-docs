...
## Negation operator examples[​](#negation-operator-examples "Direct link to Negation operator examples")
...
## Other conversion examples[​](#other-conversion-examples "Direct link to Other conversion examples")
...
* [How to Create a Custom Data Binding Converter](/docs/data-binding/how-to-create-a-custom-data-binding-converter.md): Writing custom value converters.
* [Data Binding Syntax](/docs/data-binding/data-binding-syntax.md): Binding parameters and converter usage.
* [MultiBinding](/docs/data-binding/multi-binding.md): Combining multiple bound values.
