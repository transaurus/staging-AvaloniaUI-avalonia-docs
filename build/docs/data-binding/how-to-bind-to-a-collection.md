...
When your application needs to display a dynamic list of items, you bind a collection property to a list control such as [`ListBox`](/api/avalonia/controls/listbox.md), [`ItemsControl`](/api/avalonia/controls/itemscontrol.md), or `ComboBox`. By using `ObservableCollection<T>`, the UI stays in sync whenever you add, remove, or reorder items. This guide walks you through the common scenarios for collection binding in Avalonia.

## Why use `ObservableCollection<T>`[​](#why-use-observablecollectiont "Direct link to why-use-observablecollectiont")
...
## Bind to a simple `ObservableCollection`[​](#bind-to-a-simple-observablecollection "Direct link to bind-to-a-simple-observablecollection")
...
## Bind to a collection of complex objects[​](#bind-to-a-collection-of-complex-objects "Direct link to Bind to a collection of complex objects")
...
## Add and remove items at runtime[​](#add-and-remove-items-at-runtime "Direct link to Add and remove items at runtime")
...
## Use `ItemsControl` for non-selectable lists[​](#use-itemscontrol-for-non-selectable-lists "Direct link to use-itemscontrol-for-non-selectable-lists")
...
* [Collection views](/docs/data-binding/collection-views.md): Sort, filter, and group bound collections.
* [Master-detail binding](/docs/data-binding/master-detail.md): Display details for the selected item in a list.
* [Data templates](/docs/data-templates/introduction-to-data-templates.md): Control how items are displayed.
* [INotifyPropertyChanged](/docs/data-binding/inotifypropertychanged.md): Change notification for view models.
* [Binding to commands](/docs/data-binding/binding-to-commands.md): Wire up buttons and other actions.
