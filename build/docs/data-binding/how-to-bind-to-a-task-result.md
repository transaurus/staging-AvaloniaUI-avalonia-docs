...
## Basic task binding[​](#basic-task-binding "Direct link to Basic task binding")
...
## Loading data from an API[​](#loading-data-from-an-api "Direct link to Loading data from an API")
...
## Showing a loading indicator[​](#showing-a-loading-indicator "Direct link to Showing a loading indicator")
...
## Refreshing task data[​](#refreshing-task-data "Direct link to Refreshing task data")
...
## Edge cases and limitations[​](#edge-cases-and-limitations "Direct link to Edge cases and limitations")
...
* [How to bind to an observable](/docs/data-binding/how-to-bind-to-an-observable.md)
