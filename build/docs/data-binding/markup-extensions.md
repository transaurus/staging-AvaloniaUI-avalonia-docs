...
Create custom XAML markup extensions that provide values to properties at runtime.

## About markup extensions[​](#about-markup-extensions "Direct link to About markup extensions")

A classic markup extension is any class that:

* Implements `object? ProvideValue(IServiceProvider?)`
* Optionally inherits from [`MarkupExtension`](/api/avalonia/markup/xaml/markupextension.md) (not required in Avalonia)
...
| ------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| [StaticResource](/docs/app-development/resource-dictionary.md#static-resource)        | An existing keyed resource and does not update on changes          |
| [DynamicResource](/docs/app-development/resource-dictionary.md#using-resources)       | Deferred loading of a keyed resource that will update on changes   |
| Binding                                                                               | Based on the default binding preference: Compiled or Reflection    |
| [CompiledBinding](/docs/data-binding/compiled-bindings.md#compiledbinding-markup)     | Based on a compiled binding                                        |
| [ReflectionBinding](/docs/data-binding/compiled-bindings.md#reflectionbinding-markup) | Based on a reflection binding                                      |
| [TemplateBinding](/docs/custom-controls/templated-controls.md)                        | Based on a simplified binding used only within a `ControlTemplate` |
| [OnPlatform](/docs/platform-specific-guides/xaml.md#onplatform-markup-extension)      | Conditionally when on the specified platform                       |
| [OnFormFactor](/docs/platform-specific-guides/xaml.md#onformfactor-markup-extension)  | Conditionally when on the specified factor                         |

## Compiler intrinsics[​](#compiler-intrinsics "Direct link to Compiler intrinsics")
...
## Creating markup extensions[​](#creating-markup-extensions "Direct link to Creating markup extensions")
...
### Using `IServiceProvider`[​](#using-iserviceprovider "Direct link to using-iserviceprovider")
...
### Receiving literal parameters[​](#receiving-literal-parameters "Direct link to Receiving literal parameters")
...
### Receiving parameters from bindings[​](#receiving-parameters-from-bindings "Direct link to Receiving parameters from bindings")
...
### Returning parameters[​](#returning-parameters "Direct link to Returning parameters")
...
### MarkupExtension property attributes[​](#markupextension-property-attributes "Direct link to MarkupExtension property attributes")
...
## Options markup extensions[​](#options-markup-extensions "Direct link to Options markup extensions")
...
### `OnPlatform` markup extension[​](#onplatform-markup-extension "Direct link to onplatform-markup-extension")
...
### Creating custom options markup extensions[​](#creating-custom-options-markup-extensions "Direct link to Creating custom options markup extensions")
...
* [Data Binding Syntax](/docs/data-binding/data-binding-syntax.md): Binding MarkupExtension reference.
* [Compiled Bindings](/docs/data-binding/compiled-bindings.md): CompiledBinding and ReflectionBinding markup.
* [Platform-specific XAML](/docs/platform-specific-guides/xaml.md): OnPlatform and OnFormFactor markup extensions.
