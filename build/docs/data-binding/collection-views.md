# Sorting, filtering, and grouping collections
...
## Filtering a collection[​](#filtering-a-collection "Direct link to Filtering a collection")
...
### Manual filtering with ObservableCollection[​](#manual-filtering-with-observablecollection "Direct link to Manual filtering with ObservableCollection")
...
### Using DynamicData (recommended for complex scenarios)[​](#using-dynamicdata-recommended-for-complex-scenarios "Direct link to Using DynamicData (recommended for complex scenarios)")
...
## Sorting a collection[​](#sorting-a-collection "Direct link to Sorting a collection")

### Simple sorting[​](#simple-sorting "Direct link to Simple sorting")
...
### Dynamic sorting[​](#dynamic-sorting "Direct link to Dynamic sorting")
...
### With DynamicData[​](#with-dynamicdata "Direct link to With DynamicData")
...
The `DataGrid` control supports built-in grouping through `DataGridCollectionView`. See the [DataGrid grouping how-to](/docs/how-to/datagrid-how-to.md#grouping) for details.

### Using a flat list with headers[​](#using-a-flat-list-with-headers "Direct link to Using a flat list with headers")
...
### With DynamicData GroupOn[​](#with-dynamicdata-groupon "Direct link to With DynamicData GroupOn")
...
* [How to Bind to a Collection](/docs/data-binding/how-to-bind-to-a-collection.md): Basic collection binding patterns.
* [Data Templates](/docs/data-templates/introduction-to-data-templates.md): Controlling how items are rendered.
