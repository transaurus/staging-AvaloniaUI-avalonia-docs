...
## Binding to a named control[​](#binding-to-a-named-control "Direct link to Binding to a named control")
...
## Binding to an ancestor[​](#binding-to-an-ancestor "Direct link to Binding to an ancestor")
...
* [Compiled Bindings](/docs/data-binding/compiled-bindings.md): Type-safe bindings with compile-time validation.
* [Control Trees](/docs/custom-controls/control-trees.md): Logical and visual tree structure.
