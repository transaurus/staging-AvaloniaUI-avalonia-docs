...
## Enable and disable compiled bindings[​](#enable-and-disable-compiled-bindings "Direct link to Enable and disable compiled bindings")
...
### Enable and disable globally[​](#enable-and-disable-globally "Direct link to Enable and disable globally")
...
### Enable and disable per UserControl or Window[​](#enable-and-disable-per-usercontrol-or-window "Direct link to Enable and disable per UserControl or Window")

To enable compiled bindings, first define the `DataType` of the object you want to bind to. In [`DataTemplates`](/docs/data-templates/introduction-to-data-templates.md) there is a `DataType` property. For all other elements, you can set it via `x:DataType`. You will most likely set `x:DataType` in your root node, for example in a `Window` or a `UserControl`. You can also specify the `DataType` in the `Binding` directly.
...
## `DataContext` type inference[​](#datacontext-type-inference "Direct link to datacontext-type-inference")
...
### Explicit type casting[​](#explicit-type-casting "Direct link to Explicit type casting")
...
## `CompiledBinding` markup[​](#compiledbinding-markup "Direct link to compiledbinding-markup")
...
## `ReflectionBinding` markup[​](#reflectionbinding-markup "Direct link to reflectionbinding-markup")
...
## Compiled bindings from code[​](#compiled-bindings-from-code "Direct link to Compiled bindings from code")

You can also create compiled bindings in C# code using the `CompiledBinding.Create` factory method. This gives you the same compile-time safety and performance benefits as XAML compiled bindings, using LINQ expressions instead of string property paths. See [Compiled bindings from code](/docs/data-binding/binding-from-code.md#compiled-bindings-from-code) for examples.

## See also[​](#see-also "Direct link to See also")

* [Compiled bindings from code](/docs/data-binding/binding-from-code.md#compiled-bindings-from-code)
