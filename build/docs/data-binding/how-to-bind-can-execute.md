...
This guide shows you how to bind a [`Button`](/api/avalonia/controls/button.md) to a command whose `CanExecute` logic automatically enables or disables the control. The approach uses the MVVM pattern so that the view and the view model remain clearly separated.
...
### Define the view[​](#define-the-view "Direct link to Define the view")
...
### Create a simple `RelayCommand`[​](#create-a-simple-relaycommand "Direct link to create-a-simple-relaycommand")
...
### Implement the view model[​](#implement-the-view-model "Direct link to Implement the view model")
...
![App showing a button enabled and disabled based on CanExecute binding](/assets/images/bind-canexecute-c298c4ec58854143e8c3425893ead22e.gif)
...
## Tips and edge cases[​](#tips-and-edge-cases "Direct link to Tips and edge cases")
...
* [Commanding](/docs/input-interaction/commanding.md)
