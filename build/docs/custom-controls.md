...
## Types of custom controls[​](#types-of-custom-controls "Direct link to Types of custom controls")
...
### Basic controls[​](#basic-controls "Direct link to Basic controls")
...
## Creating advanced custom controls[​](#creating-advanced-custom-controls "Direct link to Creating advanced custom controls")
...
### Using a `StyledProperty` on another class[​](#using-a-styledproperty-on-another-class "Direct link to using-a-styledproperty-on-another-class")
...
### Readonly properties[​](#readonly-properties "Direct link to Readonly properties")
...
[Attached properties](/docs/custom-controls/attached-properties.md) are defined almost identically to styled properties except that they are registered using the `RegisterAttached` method and their accessors are defined as static methods.
...
### Direct `AvaloniaProperty` registrations[​](#direct-avaloniaproperty-registrations "Direct link to direct-avaloniaproperty-registrations")

As its name suggests, `RegisterDirect` isn't just used for registering readonly properties. You can also pass a *setter* to `RegisterDirect` to expose a standard C# property as an Avalonia property.
...
### Using a `DirectProperty` on another class[​](#using-a-directproperty-on-another-class "Direct link to using-a-directproperty-on-another-class")
...
### When to use direct vs styled properties[​](#when-to-use-direct-vs-styled-properties "Direct link to When to use direct vs styled properties")
...
* You can add [data validation](/docs/app-development/data-validation.md) support
...
### DataValidation support[​](#datavalidation-support "Direct link to DataValidation support")
...
* [Choosing a Custom Control Type](/docs/custom-controls/choosing-a-custom-control-type.md)
* [Defining Properties](/docs/custom-controls/defining-properties.md)
* [Defining Events](/docs/custom-controls/defining-events.md)
* [Templated Controls](/docs/custom-controls/templated-controls.md)
* [Drawing Custom Controls](/docs/custom-controls/drawing-custom-controls.md)
