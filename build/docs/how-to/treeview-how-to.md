...
## Basic Hierarchical Binding[​](#basic-hierarchical-binding "Direct link to Basic Hierarchical Binding")

Bind a [`TreeView`](/api/avalonia/controls/treeview.md) to a tree of view model objects using `HierarchicalDataTemplate`:
...
[`TreeDataTemplate`](/api/avalonia/markup/xaml/templates/treedatatemplate.md) is the key: its `ItemsSource` property tells the `TreeView` where to find child items for each node. The same template is applied recursively at every level.

### Multiple node types[​](#multiple-node-types "Direct link to Multiple node types")
...
## Lazy Loading (Load on Expand)[​](#lazy-loading-load-on-expand "Direct link to Lazy Loading (Load on Expand)")
...
## Async Lazy Loading[​](#async-lazy-loading "Direct link to Async Lazy Loading")
...
## Expanding and Collapsing Programmatically[​](#expanding-and-collapsing-programmatically "Direct link to Expanding and Collapsing Programmatically")
...
## Search and Filter[​](#search-and-filter "Direct link to Search and Filter")
...
## Drag and Drop in TreeView[​](#drag-and-drop-in-treeview "Direct link to Drag and Drop in TreeView")
...
Handle the drag events in code-behind or use behaviors. See [Drag and Drop](/docs/input-interaction/drag-and-drop.md) for the full API.

## Styling TreeViewItem[​](#styling-treeviewitem "Direct link to Styling TreeViewItem")
...
* [TreeView Control Reference](/controls/data-display/structured-data/treeview.md): Property tables and basic examples.
* [Data Templates](/docs/data-templates/introduction-to-data-templates.md): How data templates work.
* [Drag and Drop](/docs/input-interaction/drag-and-drop.md): Drag-and-drop support.
* [Collection Views](/docs/data-binding/collection-views.md): Filtering and sorting collections.
