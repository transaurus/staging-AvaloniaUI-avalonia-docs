...
## Item Templates[​](#item-templates "Direct link to Item Templates")
...
### Single selection (default)[​](#single-selection-default "Direct link to Single selection (default)")
...
### Multiple selection[​](#multiple-selection "Direct link to Multiple selection")
...
### Toggle selection[​](#toggle-selection "Direct link to Toggle selection")
...
### Always selected[​](#always-selected "Direct link to Always selected")
...
### Scroll to an item[​](#scroll-to-an-item "Direct link to Scroll to an item")
...
## Horizontal ListBox[​](#horizontal-listbox "Direct link to Horizontal ListBox")
...
## Styling ListBox Items[​](#styling-listbox-items "Direct link to Styling ListBox Items")

### Custom selection appearance[​](#custom-selection-appearance "Direct link to Custom selection appearance")
...
### Removing the selection highlight[​](#removing-the-selection-highlight "Direct link to Removing the selection highlight")
...
### Item spacing[​](#item-spacing "Direct link to Item spacing")
...
## Commands on ListBox Items[​](#commands-on-listbox-items "Direct link to Commands on ListBox Items")
...
## Empty State[​](#empty-state "Direct link to Empty State")
...
## ListBox with CheckBoxes[​](#listbox-with-checkboxes "Direct link to ListBox with CheckBoxes")
...
## Grouping Items[​](#grouping-items "Direct link to Grouping Items")
...
See [Collection Views](/docs/data-binding/collection-views.md) for details on building grouped lists.

## See Also[​](#see-also "Direct link to See Also")

* [ListBox Control Reference](/controls/data-display/collections/listbox.md): Property tables and basic examples.
* [Collection Views](/docs/data-binding/collection-views.md): Sorting, filtering, and grouping collections.
* [Performance](/docs/app-development/performance.md): Virtualization and large collection tips.
* [Data Templates](/docs/data-templates/introduction-to-data-templates.md): How templates work.
