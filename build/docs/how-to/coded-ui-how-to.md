# How to: Build a Complete App Without XAML
...
## Step 1: Create the project[​](#step-1-create-the-project "Direct link to Step 1: Create the project")
...
## Step 2: Bootstrap the application[​](#step-2-bootstrap-the-application "Direct link to Step 2: Bootstrap the application")
...
## Step 3: Build the window[​](#step-3-build-the-window "Direct link to Step 3: Build the window")
...
## Step 4: Add custom styles[​](#step-4-add-custom-styles "Direct link to Step 4: Add custom styles")
...
CounterWindow\.cs (add to constructor, before Content assignment)
...
## Step 5: Add data binding[​](#step-5-add-data-binding "Direct link to Step 5: Add data binding")
...
CounterWindow\.cs (updated constructor, string-based)
...
CounterWindow\.cs (updated constructor, compiled binding)
...
## Step 6: Add a grid layout[​](#step-6-add-a-grid-layout "Direct link to Step 6: Add a grid layout")
...
## Step 7: Add custom drawing (optional)[​](#step-7-add-custom-drawing-optional "Direct link to Step 7: Add custom drawing (optional)")
...
## Multi-window applications[​](#multi-window-applications "Direct link to Multi-window applications")
...
For a deeper look at the concepts behind each of these patterns, see [Code-Only UI](/docs/fundamentals/coded-ui.md).
...
* [Threading](/docs/app-development/threading.md)
