...
## Getting the clipboard[​](#getting-the-clipboard "Direct link to Getting the clipboard")
...
## Copy text to the clipboard[​](#copy-text-to-the-clipboard "Direct link to Copy text to the clipboard")
...
## Paste text from the clipboard[​](#paste-text-from-the-clipboard "Direct link to Paste text from the clipboard")
...
## Check clipboard content[​](#check-clipboard-content "Direct link to Check clipboard content")
...
## Copy an image to the clipboard[​](#copy-an-image-to-the-clipboard "Direct link to Copy an image to the clipboard")
...
## Paste an image from the clipboard[​](#paste-an-image-from-the-clipboard "Direct link to Paste an image from the clipboard")
...
## Copy custom data[​](#copy-custom-data "Direct link to Copy custom data")
...
## Paste custom data[​](#paste-custom-data "Direct link to Paste custom data")
...
* [Clipboard service](/docs/services/clipboard.md)
* [Drag and drop how-to](/docs/how-to/drag-and-drop-how-to.md)
