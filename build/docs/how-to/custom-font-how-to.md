...
## Add the font files to your project[​](#add-the-font-files-to-your-project "Direct link to Add the font files to your project")
...
## Option A: Use the font as a static resource[​](#option-a-use-the-font-as-a-static-resource "Direct link to Option A: Use the font as a static resource")

This approach declares the font as a named XAML resource.

### Declare the font resource[​](#declare-the-font-resource "Direct link to Declare the font resource")

1. Open **App.axaml**.
2. Add a [`FontFamily`](/api/avalonia/media/fontfamily.md) resource inside `<Application.Resources>`, using the [font URI format](/docs/styling/custom-fonts.md#font-uri-format):
...
### Apply the font[​](#apply-the-font "Direct link to Apply the font")
...
## Option B: Use an embedded font collection[​](#option-b-use-an-embedded-font-collection "Direct link to Option B: Use an embedded font collection")
...
### Create the font collection class[​](#create-the-font-collection-class "Direct link to Create the font collection class")
...
### Register the collection[​](#register-the-collection "Direct link to Register the collection")
...
### Apply the font[​](#apply-the-font-1 "Direct link to Apply the font")
...
* [Custom fonts](/docs/styling/custom-fonts.md)
