...
This guide covers common [`Grid`](/api/avalonia/controls/grid.md) layout scenarios including row and column definitions, sizing modes, spanning, shared sizing, and responsive patterns.

## Row and column definitions[​](#row-and-column-definitions "Direct link to Row and column definitions")
...
## Sizing modes[​](#sizing-modes "Direct link to Sizing modes")

### Pixel sizing[​](#pixel-sizing "Direct link to Pixel sizing")
...
### Auto sizing[​](#auto-sizing "Direct link to Auto sizing")
...
### Star sizing[​](#star-sizing "Direct link to Star sizing")
...
### MinWidth and MaxWidth constraints[​](#minwidth-and-maxwidth-constraints "Direct link to MinWidth and MaxWidth constraints")
...
## Row and column spacing[​](#row-and-column-spacing "Direct link to Row and column spacing")
...
## Spanning rows and columns[​](#spanning-rows-and-columns "Direct link to Spanning rows and columns")
...
## Default row and column values[​](#default-row-and-column-values "Direct link to Default row and column values")
...
## Form layout[​](#form-layout "Direct link to Form layout")
...
## Nested grids[​](#nested-grids "Direct link to Nested grids")
...
## Responsive layout with Grid[​](#responsive-layout-with-grid "Direct link to Responsive layout with Grid")
...
## Overlapping content[​](#overlapping-content "Direct link to Overlapping content")
...
### Partial overlap with negative margins[​](#partial-overlap-with-negative-margins "Direct link to Partial overlap with negative margins")
...
## Debugging grid layouts[​](#debugging-grid-layouts "Direct link to Debugging grid layouts")
...
* [Grid control reference](/controls/layout/panels/grid.md)
* [Layout overview](/docs/layout/layout)
* [Positioning controls](/docs/layout/positioning-controls.md)
