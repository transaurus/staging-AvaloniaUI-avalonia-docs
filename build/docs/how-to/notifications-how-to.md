# How to: Show notifications and toasts

This guide covers patterns for showing notifications, toast messages, and status bars in your Avalonia application. Because Avalonia does not include a built-in notification control, you build your own using standard layout controls such as [`ItemsControl`](/api/avalonia/controls/itemscontrol.md), `Panel`, and `Border`.

## Overlay notification panel[​](#overlay-notification-panel "Direct link to Overlay notification panel")
...
### Notification model[​](#notification-model "Direct link to Notification model")
...
### Notification service[​](#notification-service "Direct link to Notification service")
...
### XAML overlay[​](#xaml-overlay "Direct link to XAML overlay")
...
### Usage in a view model[​](#usage-in-a-view-model "Direct link to Usage in a view model")
...
## Simple status bar[​](#simple-status-bar "Direct link to Simple status bar")
...
## Confirmation banner[​](#confirmation-banner "Direct link to Confirmation banner")
...
## Tray icon notifications (desktop only)[​](#tray-icon-notifications-desktop-only "Direct link to Tray icon notifications (desktop only)")
...
## Color-coded notification types[​](#color-coded-notification-types "Direct link to Color-coded notification types")
...
* [Threading](/docs/app-development/threading.md): Understand UI thread marshalling with `Dispatcher.UIThread`.
...
* [ItemsControl](/docs/how-to/itemscontrol-how-to.md): Working with `ItemsControl` for dynamic lists.
* [Data templates](/docs/data-templates/introduction-to-data-templates.md): Customize how notification items render.
