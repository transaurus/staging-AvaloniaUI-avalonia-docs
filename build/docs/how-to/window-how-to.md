...
## Setting Window Size and Position[​](#setting-window-size-and-position "Direct link to Setting Window Size and Position")

### Fixed size on startup[​](#fixed-size-on-startup "Direct link to Fixed size on startup")
...
### Minimum and maximum size[​](#minimum-and-maximum-size "Direct link to Minimum and maximum size")
...
### Startup location[​](#startup-location "Direct link to Startup location")
...
## Window State (Minimize, Maximize, Restore)[​](#window-state-minimize-maximize-restore "Direct link to Window State (Minimize, Maximize, Restore)")
...
## Disabling Minimize and Maximize Buttons[​](#disabling-minimize-and-maximize-buttons "Direct link to Disabling Minimize and Maximize Buttons")
...
## Hiding the Title Bar (Chromeless Window)[​](#hiding-the-title-bar-chromeless-window "Direct link to Hiding the Title Bar (Chromeless Window)")
...
### Custom title bar with drag region[​](#custom-title-bar-with-drag-region "Direct link to Custom title bar with drag region")
...
## Multi-Window Application[​](#multi-window-application "Direct link to Multi-Window Application")
...
## Window Transparency[​](#window-transparency "Direct link to Window Transparency")
...
### Transparent click-through window[​](#transparent-click-through-window "Direct link to Transparent click-through window")
...
## Window Icon[​](#window-icon "Direct link to Window Icon")
