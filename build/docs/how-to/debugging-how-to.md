# How to: Debug Common Avalonia Issues

This guide covers techniques for debugging bindings, layout, styling, and rendering issues in Avalonia applications.

## Debugging Data Bindings[​](#debugging-data-bindings "Direct link to Debugging Data Bindings")

### Enable binding error logging[​](#enable-binding-error-logging "Direct link to Enable binding error logging")
...
### Common binding mistakes[​](#common-binding-mistakes "Direct link to Common binding mistakes")
...
### Verify the DataContext[​](#verify-the-datacontext "Direct link to Verify the DataContext")
...
### Use compiled bindings to catch errors at build time[​](#use-compiled-bindings-to-catch-errors-at-build-time "Direct link to Use compiled bindings to catch errors at build time")
...
## Debugging Layout Issues[​](#debugging-layout-issues "Direct link to Debugging Layout Issues")

### Make layout visible[​](#make-layout-visible "Direct link to Make layout visible")
...
### Check for zero-size elements[​](#check-for-zero-size-elements "Direct link to Check for zero-size elements")
...
### Use DevTools[​](#use-devtools "Direct link to Use DevTools")
...
## Debugging Styles[​](#debugging-styles "Direct link to Debugging Styles")

### Style not applying[​](#style-not-applying "Direct link to Style not applying")
...
### Verify a style selector[​](#verify-a-style-selector "Direct link to Verify a style selector")
...
## Debugging Rendering[​](#debugging-rendering "Direct link to Debugging Rendering")

### Control not visible[​](#control-not-visible "Direct link to Control not visible")
...
### Rendering artifacts[​](#rendering-artifacts "Direct link to Rendering artifacts")
...
## Debugging Performance[​](#debugging-performance "Direct link to Debugging Performance")

### Identify layout thrashing[​](#identify-layout-thrashing "Direct link to Identify layout thrashing")

If your UI is slow, a common cause is excessive layout passes. The DevTools performance tab shows layout counts.

### Check virtualization[​](#check-virtualization "Direct link to Check virtualization")
...
## Useful Debugging Tools[​](#useful-debugging-tools "Direct link to Useful Debugging Tools")
...
* [Binding Debugging](/docs/data-binding/binding-debugging.md): Detailed binding diagnostics.
* [Compiled Bindings](/docs/data-binding/compiled-bindings.md): Catch binding errors at build time.
* [Performance](/docs/app-development/performance.md): Performance optimization tips.
