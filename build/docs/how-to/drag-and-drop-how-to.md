...
## Accepting dropped files[​](#accepting-dropped-files "Direct link to Accepting dropped files")

The most common drag-and-drop scenario is accepting files that your users drag from the OS file manager.

### XAML setup[​](#xaml-setup "Direct link to XAML setup")
...
### Code-behind handler[​](#code-behind-handler "Direct link to Code-behind handler")
...
## Accepting dropped text[​](#accepting-dropped-text "Direct link to Accepting dropped text")
...
## Initiating a drag operation[​](#initiating-a-drag-operation "Direct link to Initiating a drag operation")
...
## Drag between lists[​](#drag-between-lists "Direct link to Drag between lists")
...
### Source list[​](#source-list "Direct link to Source list")
...
### Target list[​](#target-list "Direct link to Target list")
...
## Setting the drag cursor[​](#setting-the-drag-cursor "Direct link to Setting the drag cursor")
...
## Custom data formats[​](#custom-data-formats "Direct link to Custom data formats")
...
## Data formats reference[​](#data-formats-reference "Direct link to Data formats reference")
...
## Edge cases and troubleshooting[​](#edge-cases-and-troubleshooting "Direct link to Edge cases and troubleshooting")
...
* [Drag and Drop](/docs/input-interaction/drag-and-drop.md): Conceptual overview of the drag-and-drop system.
* [Gestures](/docs/input-interaction/gestures.md): Touch and pointer gesture recognizers.
* [Storage Provider](/docs/services/storage/storage-provider.md): File access APIs used with `IStorageItem`.
