...
## Setting the theme globally[​](#setting-the-theme-globally "Direct link to Setting the theme globally")
...
## Switching themes at runtime[​](#switching-themes-at-runtime "Direct link to Switching themes at runtime")
...
### Toggle command in a view model[​](#toggle-command-in-a-view-model "Direct link to Toggle command in a view model")
...
### Three-way selection: light, dark, system[​](#three-way-selection-light-dark-system "Direct link to Three-way selection: light, dark, system")
...
## Persisting the theme choice[​](#persisting-the-theme-choice "Direct link to Persisting the theme choice")
...
See [Data persistence how-to](/docs/how-to/data-persistence-how-to.md) for a complete `SettingsService` implementation you can use to read and write user preferences.

## Theme-aware colors with ThemeDictionaries[​](#theme-aware-colors-with-themedictionaries "Direct link to Theme-aware colors with ThemeDictionaries")
...
## ThemeVariantScope for mixed themes[​](#themevariantscope-for-mixed-themes "Direct link to ThemeVariantScope for mixed themes")
...
## Detecting the current theme[​](#detecting-the-current-theme "Direct link to Detecting the current theme")
...
## Responding to theme changes[​](#responding-to-theme-changes "Direct link to Responding to theme changes")
...
## Custom theme variants[​](#custom-theme-variants "Direct link to Custom theme variants")
...
* [Theme variants](/docs/styling/theme-variants.md): Full reference for the theme variant system.
* [Resource dictionary](/docs/app-development/resource-dictionary.md): How resource lookup and merging work.
* [Themes](/docs/styling/themes.md): `FluentTheme` and `SimpleTheme` configuration.
* [Data persistence how-to](/docs/how-to/data-persistence-how-to.md): Saving settings across sessions.
