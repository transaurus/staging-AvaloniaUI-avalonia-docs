# How to: Implement common MVVM patterns
...
## Setting up CommunityToolkit.Mvvm[​](#setting-up-communitytoolkitmvvm "Direct link to Setting up CommunityToolkit.Mvvm")
...
## Observable properties[​](#observable-properties "Direct link to Observable properties")
...
### Basic command[​](#basic-command "Direct link to Basic command")
...
### Async command[​](#async-command "Direct link to Async command")
...
## View model communication[​](#view-model-communication "Direct link to View model communication")

### Using a messenger[​](#using-a-messenger "Direct link to Using a messenger")
...
### Request/response pattern[​](#requestresponse-pattern "Direct link to Request/response pattern")
...
## View model with constructor injection[​](#view-model-with-constructor-injection "Direct link to View model with constructor injection")
...
## ObservableCollection patterns[​](#observablecollection-patterns "Direct link to ObservableCollection patterns")

### Replace vs. add[​](#replace-vs-add "Direct link to Replace vs. add")
...
### Filtered collection[​](#filtered-collection "Direct link to Filtered collection")
...
For more information about displaying validation errors in your views, see [Data validation](/docs/data-binding/binding-validation.md).
...
* [INotifyPropertyChanged](/docs/data-binding/inotifypropertychanged.md)
* [Dependency injection](/docs/app-development/dependency-injection.md)
* [Data validation](/docs/data-binding/binding-validation.md)
