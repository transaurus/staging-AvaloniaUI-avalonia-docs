...
## DatePicker Basics[​](#datepicker-basics "Direct link to DatePicker Basics")
...
### Setting an initial date[​](#setting-an-initial-date "Direct link to Setting an initial date")
...
## Custom Date Formats[​](#custom-date-formats "Direct link to Custom Date Formats")
...
## Hiding Date Parts[​](#hiding-date-parts "Direct link to Hiding Date Parts")
...
## TimePicker[​](#timepicker "Direct link to TimePicker")
...
### 12-hour vs 24-hour clock[​](#12-hour-vs-24-hour-clock "Direct link to 12-hour vs 24-hour clock")
...
### Minute increments[​](#minute-increments "Direct link to Minute increments")
...
### Binding the selected time[​](#binding-the-selected-time "Direct link to Binding the selected time")
...
## CalendarDatePicker[​](#calendardatepicker "Direct link to CalendarDatePicker")
...
### Display format[​](#display-format "Direct link to Display format")
...
### Blackout dates[​](#blackout-dates "Direct link to Blackout dates")
...
## Calendar Control[​](#calendar-control "Direct link to Calendar Control")
...
### Selection modes[​](#selection-modes "Direct link to Selection modes")
...
### Display modes[​](#display-modes "Direct link to Display modes")
...
### Date range limits[​](#date-range-limits "Direct link to Date range limits")
...
### Blackout dates in code[​](#blackout-dates-in-code "Direct link to Blackout dates in code")
...
## Date Formatting in Display[​](#date-formatting-in-display "Direct link to Date Formatting in Display")
...
## Combining Date and Time[​](#combining-date-and-time "Direct link to Combining Date and Time")
...
## Key Properties Reference[​](#key-properties-reference "Direct link to Key Properties Reference")

### DatePicker[​](#datepicker "Direct link to DatePicker")
...
### TimePicker[​](#timepicker-1 "Direct link to TimePicker")
...
* [DatePicker Control Reference](/controls/input/date-and-time/datepicker.md): Property tables.
* [TimePicker Control Reference](/controls/input/date-and-time/timepicker.md): Time selection control.
* [Calendar Control Reference](/controls/input/date-and-time/calendar.md): Full calendar display.
* [Data Validation](/docs/data-binding/binding-validation.md): Validating bound values.
