...
## Choosing a navigation pattern[​](#choosing-a-navigation-pattern "Direct link to Choosing a navigation pattern")

Before you start, consider which pattern fits your requirements:

| Pattern                                                                                | Best for                                     |
| -------------------------------------------------------------------------------------- | -------------------------------------------- |
| [`ContentControl`](/api/avalonia/controls/contentcontrol.md) with data templates       | Small apps with a few fixed pages            |
| [`TransitioningContentControl`](/api/avalonia/controls/transitioningcontentcontrol.md) | Same as above, but with animated transitions |
...
## View switching with ContentControl[​](#view-switching-with-contentcontrol "Direct link to View switching with ContentControl")
...
When `CurrentPage` changes, the `ContentControl` looks up the matching [`DataTemplate`](/api/avalonia/markup/xaml/templates/datatemplate.md) and displays the corresponding view automatically. This works because Avalonia walks up the visual tree looking for a `DataTemplate` whose `DataType` matches the object assigned to `Content`.
...
## View switching with transitions[​](#view-switching-with-transitions "Direct link to View switching with transitions")
...
## Tab-based navigation[​](#tab-based-navigation "Direct link to Tab-based navigation")
...
## Sidebar navigation[​](#sidebar-navigation "Direct link to Sidebar navigation")
...
## Navigation with back stack[​](#navigation-with-back-stack "Direct link to Navigation with back stack")
...
## View locator pattern[​](#view-locator-pattern "Direct link to View locator pattern")
...
* [Page transitions](/docs/graphics-animation/page-transitions.md): Transition animations between views.
* [Data templates](/docs/data-templates/introduction-to-data-templates.md): How data templates resolve views.
* [View locator](/docs/data-templates/view-locator.md): Automatic view-model to view mapping.
* [The MVVM pattern](/docs/fundamentals/the-mvvm-pattern.md): View model architecture.
