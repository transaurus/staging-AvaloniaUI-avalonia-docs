# How to: Save and Load Application Settings
...
## JSON file settings[​](#json-file-settings "Direct link to JSON file settings")
...
### Using with a view model[​](#using-with-a-view-model "Direct link to Using with a view model")
...
## Saving window position and size[​](#saving-window-position-and-size "Direct link to Saving window position and size")
...
## Recent files list[​](#recent-files-list "Direct link to Recent files list")
...
## Platform-specific storage paths[​](#platform-specific-storage-paths "Direct link to Platform-specific storage paths")
...
## Bookmarked storage (mobile and sandbox)[​](#bookmarked-storage-mobile-and-sandbox "Direct link to Bookmarked storage (mobile and sandbox)")
...
See [Bookmarks](/docs/services/storage/bookmarks.md) for full details on the bookmark API.

## See also[​](#see-also "Direct link to See also")

* [Storage Provider](/docs/services/storage/storage-provider.md): File and folder access across platforms.
* [Bookmarks](/docs/services/storage/bookmarks.md): Persisting file access across sessions on sandboxed platforms.
* [Storage Item](/docs/services/storage/storage-item.md): Working with `IStorageFile` and `IStorageFolder` instances.
* [Window Management](/docs/app-development/window-management.md): Window lifecycle, positioning, and state.
* [Dependency Injection](/docs/app-development/dependency-injection.md): Registering services like `SettingsService` in your application.
