# How to: Work with Expander

This guide covers common [`Expander`](/api/avalonia/controls/expander.md) scenarios including basic usage, accordion patterns, animated expansion, binding state, and custom headers.

## Basic expander[​](#basic-expander "Direct link to Basic expander")
...
## Initially expanded[​](#initially-expanded "Direct link to Initially expanded")
...
## Binding `IsExpanded`[​](#binding-isexpanded "Direct link to binding-isexpanded")
...
## Expand direction[​](#expand-direction "Direct link to Expand direction")

The [`ExpandDirection`](/api/avalonia/controls/expanddirection.md) property controls which direction the content expands relative to the header:
...
## Custom header with icon[​](#custom-header-with-icon "Direct link to Custom header with icon")
...
## Accordion pattern (single open)[​](#accordion-pattern-single-open "Direct link to Accordion pattern (single open)")
...
## Animated content transition[​](#animated-content-transition "Direct link to Animated content transition")
...
You can substitute `CrossFade` with other transition types such as `PageSlide` or `CompositePageTransition`. See [Page transitions](/docs/graphics-animation/page-transitions.md) for a full list of built-in options.

## Responding to expand and collapse events[​](#responding-to-expand-and-collapse-events "Direct link to Responding to expand and collapse events")
...
## Styling the expander[​](#styling-the-expander "Direct link to Styling the expander")

### Remove the border[​](#remove-the-border "Direct link to Remove the border")
...
### Custom expand icon[​](#custom-expand-icon "Direct link to Custom expand icon")
...
* [Page transitions](/docs/graphics-animation/page-transitions.md): Transition types you can use for content animation.
* [Introduction to data binding](/docs/data-binding/introduction-to-data-binding.md): Fundamentals of binding properties like `IsExpanded` to your view model.
