...
This guide covers common [`Slider`](/api/avalonia/controls/slider.md) scenarios including range configuration, value display, tick marks, vertical orientation, and two-way data binding.

## Basic slider with value display[​](#basic-slider-with-value-display "Direct link to Basic slider with value display")
...
[`TickPlacement`](/api/avalonia/controls/tickplacement.md) options:
...
## Small and large change[​](#small-and-large-change "Direct link to Small and large change")
...
Set the [`Orientation`](/api/avalonia/layout/orientation.md) property to `Vertical`. You should also set an explicit `Height` so the slider does not collapse:
...
## Integer-only slider[​](#integer-only-slider "Direct link to Integer-only slider")
...
## Slider with labels[​](#slider-with-labels "Direct link to Slider with labels")
...
## Color preview slider[​](#color-preview-slider "Direct link to Color preview slider")
...
## Disabled and read-only states[​](#disabled-and-read-only-states "Direct link to Disabled and read-only states")
...
## Styling the slider[​](#styling-the-slider "Direct link to Styling the slider")

### Custom track and thumb colors[​](#custom-track-and-thumb-colors "Direct link to Custom track and thumb colors")
...
### Wider track[​](#wider-track "Direct link to Wider track")
...
* [Slider](/controls/input/selectors/slider.md): Full property and event reference for the `Slider` control.
* [Binding to controls](/docs/data-binding/binding-to-controls.md): Bind one control's property to another using `#name` syntax.
* [Data validation](/docs/app-development/data-validation.md): Add validation rules to slider-bound properties.
* [Accessibility](/docs/app-development/accessibility.md): Keyboard and screen-reader considerations for interactive controls.
