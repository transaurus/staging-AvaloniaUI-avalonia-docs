...
## Basic Text Binding[​](#basic-text-binding "Direct link to Basic Text Binding")
...
## Placeholder Text[​](#placeholder-text "Direct link to Placeholder Text")
...
## Password Input[​](#password-input "Direct link to Password Input")
...
## Read-Only and Disabled[​](#read-only-and-disabled "Direct link to Read-Only and Disabled")
...
## Text Selection[​](#text-selection "Direct link to Text Selection")

### Select all on focus[​](#select-all-on-focus "Direct link to Select all on focus")
...
### With data annotations[​](#with-data-annotations "Direct link to With data annotations")
...
When validation fails, the TextBox displays a red border and error message. See [Validation in Data Binding](/docs/data-binding/binding-validation.md) for details.

### Restricting input characters[​](#restricting-input-characters "Direct link to Restricting input characters")
...
## Max Length[​](#max-length "Direct link to Max Length")
...
## Text Changed Event[​](#text-changed-event "Direct link to Text Changed Event")
...
For debounced search (avoiding filtering on every keystroke), see [Performance](/docs/app-development/performance.md#debounce-rapid-input).

## Inner Content (Left/Right)[​](#inner-content-leftright "Direct link to Inner Content (Left/Right)")
...
## Undo and Redo[​](#undo-and-redo "Direct link to Undo and Redo")
...
### Custom appearance[​](#custom-appearance "Direct link to Custom appearance")
...
### Removing the focus border[​](#removing-the-focus-border "Direct link to Removing the focus border")
...
* [TextBox Control Reference](/controls/input/text-input/textbox.md): Property summary.
* [Validation in Data Binding](/docs/data-binding/binding-validation.md): Data annotation and INotifyDataErrorInfo validation.
* [Data Binding Syntax](/docs/data-binding/data-binding-syntax.md): Binding modes and parameters.
