...
## Loading Images from Assets[​](#loading-images-from-assets "Direct link to Loading Images from Assets")
...
## Loading Images from a File Path[​](#loading-images-from-a-file-path "Direct link to Loading Images from a File Path")
...
## Loading Images from a URL[​](#loading-images-from-a-url "Direct link to Loading Images from a URL")
...
## Stretch Modes[​](#stretch-modes "Direct link to Stretch Modes")

The [`Stretch`](/api/avalonia/media/stretch.md) property controls how the image fills its bounds:
...
## Circular Image (Avatar)[​](#circular-image-avatar "Direct link to Circular Image (Avatar)")
...
## Image with Fallback[​](#image-with-fallback "Direct link to Image with Fallback")
...
## Image Interpolation[​](#image-interpolation "Direct link to Image Interpolation")
...
## DrawingImage (Vector Graphics)[​](#drawingimage-vector-graphics "Direct link to DrawingImage (Vector Graphics)")
...
## PathIcon[​](#pathicon "Direct link to PathIcon")
...
## RenderTargetBitmap (Screenshots)[​](#rendertargetbitmap-screenshots "Direct link to RenderTargetBitmap (Screenshots)")
...
* [Image Control Reference](/controls/media/image.md): Property tables.
* [PathIcon Control Reference](/controls/media/pathicon.md): Vector icon control.
* [DrawingImage Control Reference](/controls/media/drawingimage.md): Vector image source.
* [How to Bind Image Files](/docs/data-binding/how-to-bind-image-files.md): Binding images in data templates.
* [Image Interpolation](/docs/graphics-animation/image-interpolation.md): Bitmap rendering quality.
* [Assets](/docs/fundamentals/assets.md): Asset loading and URI schemes.
