...
## Showing a Dialog Window[​](#showing-a-dialog-window "Direct link to Showing a Dialog Window")
...
## Creating a Dialog Window[​](#creating-a-dialog-window "Direct link to Creating a Dialog Window")
...
### Alternative: Close from code-behind[​](#alternative-close-from-code-behind "Direct link to Alternative: Close from code-behind")
...
## Returning Complex Results[​](#returning-complex-results "Direct link to Returning Complex Results")
...
## Getting the Parent Window[​](#getting-the-parent-window "Direct link to Getting the Parent Window")
...
## File and Folder Dialogs[​](#file-and-folder-dialogs "Direct link to File and Folder Dialogs")
...
See [Storage Provider](/docs/services/storage/storage-provider.md) for the full API.

## Preventing Dialog Close[​](#preventing-dialog-close "Direct link to Preventing Dialog Close")
...
## Overlay Dialogs (In-Window)[​](#overlay-dialogs-in-window "Direct link to Overlay Dialogs (In-Window)")
...
* [Window Management](/docs/app-development/window-management.md): Show, ShowDialog, and window lifecycle.
* [Storage Provider](/docs/services/storage/storage-provider.md): File and folder picker dialogs.
* [Commanding](/docs/input-interaction/commanding.md): Binding buttons to commands.
