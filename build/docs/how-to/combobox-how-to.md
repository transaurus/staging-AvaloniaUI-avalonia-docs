...
This guide covers common [`ComboBox`](/api/avalonia/controls/combobox.md) scenarios including binding to collections, creating custom item templates, working with enums, and using [`AutoCompleteBox`](/api/avalonia/controls/autocompletebox.md) for type-to-search functionality.

## Basic binding[​](#basic-binding "Direct link to Basic binding")
...
## Custom item template[​](#custom-item-template "Direct link to Custom item template")
...
### With display names[​](#with-display-names "Direct link to With display names")
...
## Binding to `SelectedValue`[​](#binding-to-selectedvalue "Direct link to binding-to-selectedvalue")
...
## Static items in XAML[​](#static-items-in-xaml "Direct link to Static items in XAML")
...
## Editable combo box (`AutoCompleteBox`)[​](#editable-combo-box-autocompletebox "Direct link to editable-combo-box-autocompletebox")
...
### Custom dropdown width[​](#custom-dropdown-width "Direct link to Custom dropdown width")
...
### Custom placeholder style[​](#custom-placeholder-style "Direct link to Custom placeholder style")
...
* [How to bind to a collection](/docs/data-binding/how-to-bind-to-a-collection.md): Collection binding basics.
* [Introduction to data templates](/docs/data-templates/introduction-to-data-templates.md): Customizing how items are displayed.
