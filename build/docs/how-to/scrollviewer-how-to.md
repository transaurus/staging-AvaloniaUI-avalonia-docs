# How to: Work with ScrollViewer

This guide covers common [`ScrollViewer`](/api/avalonia/controls/scrollviewer.md) scenarios including controlling scroll behavior, programmatic scrolling, responding to scroll events, and handling nested scroll regions.
...
## Scrollbar visibility[​](#scrollbar-visibility "Direct link to Scrollbar visibility")
...
## Programmatic scrolling[​](#programmatic-scrolling "Direct link to Programmatic scrolling")

### Scroll to a specific position[​](#scroll-to-a-specific-position "Direct link to Scroll to a specific position")
...
### Scroll to top or bottom[​](#scroll-to-top-or-bottom "Direct link to Scroll to top or bottom")
...
### Bring a child element into view[​](#bring-a-child-element-into-view "Direct link to Bring a child element into view")
...
## Respond to scroll events[​](#respond-to-scroll-events "Direct link to Respond to scroll events")

### Monitor scroll position changes[​](#monitor-scroll-position-changes "Direct link to Monitor scroll position changes")
...
### Observe the offset property[​](#observe-the-offset-property "Direct link to Observe the offset property")
...
## Implement infinite scrolling[​](#implement-infinite-scrolling "Direct link to Implement infinite scrolling")
...
## Handle nested ScrollViewers[​](#handle-nested-scrollviewers "Direct link to Handle nested ScrollViewers")
...
## Use scroll snap points[​](#use-scroll-snap-points "Direct link to Use scroll snap points")
...
## Create a sticky header layout[​](#create-a-sticky-header-layout "Direct link to Create a sticky header layout")
...
* [Performance optimization](/docs/app-development/performance.md)
* [ItemsControl how-to](/docs/how-to/itemscontrol-how-to.md)
