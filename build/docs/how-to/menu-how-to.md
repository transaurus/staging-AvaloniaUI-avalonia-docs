...
This guide covers [`Menu`](/api/avalonia/controls/menu.md) and [`ContextMenu`](/api/avalonia/controls/contextmenu.md) patterns in Avalonia, including commands, keyboard shortcuts, dynamic menus, checked items, submenus, and right-click context menus.

## Basic menu bar[​](#basic-menu-bar "Direct link to Basic menu bar")
...
Use a `Separator` element between [`MenuItem`](/api/avalonia/controls/menuitem.md) entries to create a visual divider that groups related actions.

## Menu with keyboard shortcuts[​](#menu-with-keyboard-shortcuts "Direct link to Menu with keyboard shortcuts")
...
### Platform-aware shortcuts[​](#platform-aware-shortcuts "Direct link to Platform-aware shortcuts")
...
## Menu with icons[​](#menu-with-icons "Direct link to Menu with icons")
...
## Checked menu items[​](#checked-menu-items "Direct link to Checked menu items")
...
## Submenus[​](#submenus "Direct link to Submenus")
...
## Dynamic menus from a collection[​](#dynamic-menus-from-a-collection "Direct link to Dynamic menus from a collection")
...
### Showing an empty-state message[​](#showing-an-empty-state-message "Direct link to Showing an empty-state message")
...
### Updating dynamic menus[​](#updating-dynamic-menus "Direct link to Updating dynamic menus")
...
### Passing the clicked item[​](#passing-the-clicked-item "Direct link to Passing the clicked item")
...
### Disabling items based on state[​](#disabling-items-based-on-state "Direct link to Disabling items based on state")
...
## Context menu in code[​](#context-menu-in-code "Direct link to Context menu in code")
...
## Opening and closing events[​](#opening-and-closing-events "Direct link to Opening and closing events")
...
## `ContextFlyout` alternative[​](#contextflyout-alternative "Direct link to contextflyout-alternative")
...
## [`NativeMenu`](/api/avalonia/controls/nativemenu.md) (macOS)[​](#nativemenu-macos "Direct link to nativemenu-macos")
...
* [Hotkeys](/docs/input-interaction/keyboard-and-hotkeys.md): Registering keyboard shortcuts and key bindings.
* [Commanding](/docs/input-interaction/commanding.md): Using commands with controls.
* [Data binding to commands](/docs/data-binding/binding-to-commands.md): Binding commands in MVVM patterns.
