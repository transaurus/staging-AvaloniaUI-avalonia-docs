...
## Basic Bound DataGrid[​](#basic-bound-datagrid "Direct link to Basic Bound DataGrid")
...
### Basic grouping[​](#basic-grouping "Direct link to Basic grouping")
...
### Multiple group levels[​](#multiple-group-levels "Direct link to Multiple group levels")
...
### Customizing the group header[​](#customizing-the-group-header "Direct link to Customizing the group header")
...
### Expanding and collapsing groups programmatically[​](#expanding-and-collapsing-groups-programmatically "Direct link to Expanding and collapsing groups programmatically")
...
## Column Types[​](#column-types "Direct link to Column Types")
...
## Template Columns[​](#template-columns "Direct link to Template Columns")
...
### Editable template column[​](#editable-template-column "Direct link to Editable template column")
...
### Single selection[​](#single-selection "Direct link to Single selection")
...
### Handling edit events[​](#handling-edit-events "Direct link to Handling edit events")
...
## Column Width Modes[​](#column-width-modes "Direct link to Column Width Modes")
...
## Row Details[​](#row-details "Direct link to Row Details")
...
## Grid Lines and Alternating Rows[​](#grid-lines-and-alternating-rows "Direct link to Grid Lines and Alternating Rows")
...
## Frozen Columns[​](#frozen-columns "Direct link to Frozen Columns")
...
## Styling Rows Conditionally[​](#styling-rows-conditionally "Direct link to Styling Rows Conditionally")
...
* [DataGrid Control Reference](/controls/data-display/structured-data/datagrid.md): Setup and property tables.
* [TreeDataGrid](/controls/data-display/structured-data/treedatagrid.md): For hierarchical data display.
* [Binding to Collections](/docs/data-binding/how-to-bind-to-a-collection.md): ObservableCollection patterns.
* [Performance Optimization](/docs/app-development/performance.md#collection-performance): Batch updates and virtualization for large collections.
