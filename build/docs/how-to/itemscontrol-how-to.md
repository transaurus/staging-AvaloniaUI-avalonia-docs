# How to: Work with ItemsControl and ItemsRepeater

This guide covers using [`ItemsControl`](/api/avalonia/controls/itemscontrol.md) and `ItemsRepeater` for custom collection layouts that go beyond what [`ListBox`](/api/avalonia/controls/listbox.md) offers.

## When to Use Each Control[​](#when-to-use-each-control "Direct link to When to Use Each Control")
...
## ItemsControl Basics[​](#itemscontrol-basics "Direct link to ItemsControl Basics")
...
### Custom panel[​](#custom-panel "Direct link to Custom panel")
...
## ItemsRepeater[​](#itemsrepeater "Direct link to ItemsRepeater")
...
### Stack layout[​](#stack-layout "Direct link to Stack layout")
...
### Horizontal stack[​](#horizontal-stack "Direct link to Horizontal stack")
...
### Wrap layout (UniformGridLayout)[​](#wrap-layout-uniformgridlayout "Direct link to Wrap layout (UniformGridLayout)")
...
## Adding Click Handling to ItemsRepeater[​](#adding-click-handling-to-itemsrepeater "Direct link to Adding Click Handling to ItemsRepeater")
...
## Customizing Containers with PreparingContainer[​](#customizing-containers-with-preparingcontainer "Direct link to Customizing Containers with PreparingContainer")
...
* [Performance](/docs/app-development/performance.md): Virtualization and collection performance.
* [Data Templates](/docs/data-templates/introduction-to-data-templates.md): How templates work.
* [ListBox How-To](/docs/how-to/listbox-how-to.md): When selection behavior is needed.
