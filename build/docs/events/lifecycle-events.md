...
## Lifecycle event order[​](#lifecycle-event-order "Direct link to Lifecycle event order")
...
## AttachedToVisualTree / DetachedFromVisualTree[​](#attachedtovisualtree--detachedfromvisualtree "Direct link to AttachedToVisualTree / DetachedFromVisualTree")
...
## Loaded / Unloaded[​](#loaded--unloaded "Direct link to Loaded / Unloaded")
...
### Loaded vs AttachedToVisualTree[​](#loaded-vs-attachedtovisualtree "Direct link to Loaded vs AttachedToVisualTree")
...
## DataContextChanged[​](#datacontextchanged "Direct link to DataContextChanged")
...
## Typical initialization patterns[​](#typical-initialization-patterns "Direct link to Typical initialization patterns")

### Loading data in a view[​](#loading-data-in-a-view "Direct link to Loading data in a view")
...
* [Events Overview](/docs/events/index): How the routed event system works.
* [Application Lifetimes](/docs/fundamentals/application-lifetimes.md): Application-level lifecycle events.
* [UI Composition](/docs/fundamentals/ui-composition.md): How controls are composed in the visual tree.
