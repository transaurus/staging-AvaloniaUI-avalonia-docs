...
## Pointer events[​](#pointer-events "Direct link to Pointer events")
...
### Handling pointer events[​](#handling-pointer-events "Direct link to Handling pointer events")
...
### Key properties on `PointerEventArgs`[​](#key-properties-on-pointereventargs "Direct link to key-properties-on-pointereventargs")
...
### Pointer capture[​](#pointer-capture "Direct link to Pointer capture")
...
## Keyboard events[​](#keyboard-events "Direct link to Keyboard events")
...
### Handling keyboard events[​](#handling-keyboard-events "Direct link to Handling keyboard events")
...
### Key properties on `KeyEventArgs`[​](#key-properties-on-keyeventargs "Direct link to key-properties-on-keyeventargs")
...
## Tunneling (preview) events[​](#tunneling-preview-events "Direct link to Tunneling (preview) events")
...
Gesture events bubble up the tree. For more complex gestures (pinch, pull, scroll), see [Gestures](/docs/input-interaction/gestures.md).
...
## Common input patterns[​](#common-input-patterns "Direct link to Common input patterns")

### Drag detection[​](#drag-detection "Direct link to Drag detection")
...
### Keyboard shortcuts on a window[​](#keyboard-shortcuts-on-a-window "Direct link to Keyboard shortcuts on a window")
...
For declarative keyboard shortcuts, consider using [KeyBindings and HotKeys](/docs/input-interaction/keyboard-and-hotkeys.md) instead of handling `KeyDown` manually.

## See also[​](#see-also "Direct link to See also")

* [Events Overview](/docs/events/index): How routed events work in Avalonia.
* [Pointer Input](/docs/input-interaction/pointer.md): Detailed pointer input reference.
* [Keyboard and Hotkeys](/docs/input-interaction/keyboard-and-hotkeys.md): Keyboard shortcuts and key bindings.
* [Gestures](/docs/input-interaction/gestures.md): Touch and multi-pointer gesture recognition.
* [Focus](/docs/input-interaction/focus.md): How keyboard focus works.
