...
## How Avalonia runs on Windows[​](#how-avalonia-runs-on-windows "Direct link to How Avalonia runs on Windows")
...
## Window transparency and Mica[​](#window-transparency-and-mica "Direct link to Window transparency and Mica")
...
For more details, see [Window Management](/docs/app-development/window-management.md).

## Custom title bars[​](#custom-title-bars "Direct link to Custom title bars")
...
For more details, see [Window Management](/docs/app-development/window-management.md#custom-title-bar).

## Dark mode and system theme detection[​](#dark-mode-and-system-theme-detection "Direct link to Dark mode and system theme detection")
...
For more details, see [Window Management](/docs/app-development/window-management.md#working-with-screens).

## Embedding native Win32 controls[​](#embedding-native-win32-controls "Direct link to Embedding native Win32 controls")
...
For more details, see [Native Platform Interop](/docs/app-development/native-interop.md).

## Embedding Avalonia in Windows Forms[​](#embedding-avalonia-in-windows-forms "Direct link to Embedding Avalonia in Windows Forms")
...
## System tray integration[​](#system-tray-integration "Direct link to System tray integration")
...
For more details, see [TrayIcon](/controls/navigation/trayicon.md).
...
For more details, see [Accessibility](/docs/app-development/accessibility.md).

## Platform-specific services on Windows[​](#platform-specific-services-on-windows "Direct link to Platform-specific services on Windows")
...
* [Packaging for Windows](/tools/parcel/packaging-for-windows.md) (NSIS installer, code signing)
* [WPF migration guide](/docs/migration/wpf.md)
* [Native Platform Interop](/docs/app-development/native-interop.md)
* [Window Management](/docs/app-development/window-management.md)
* [Platform Settings](/docs/services/platform-settings.md)
* [Keyboard and hotkeys](/docs/input-interaction/keyboard-and-hotkeys.md)
* [Accessibility](/docs/app-development/accessibility.md)
