...
## Setting up an Avalonia project for WebAssembly[​](#setting-up-an-avalonia-project-for-webassembly "Direct link to Setting up an Avalonia project for WebAssembly")
...
5. In the console output you will see HTTP and HTTPS links to open the app. To run the app:
...
For information on publishing and deploying your WebAssembly app, see [Deploying WebAssembly](/docs/deployment/webassembly.md).

## JavaScript interop[​](#javascript-interop "Direct link to JavaScript interop")
...
### Calling JavaScript from C#[​](#calling-javascript-from-c "Direct link to Calling JavaScript from C#")
...
### Calling C# from JavaScript[​](#calling-c-from-javascript "Direct link to Calling C# from JavaScript")
...
### Accessing global functions[​](#accessing-global-functions "Direct link to Accessing global functions")
...
### Type marshalling[​](#type-marshalling "Direct link to Type marshalling")
...
* [Deploying WebAssembly](/docs/deployment/webassembly.md)
