...
## How Avalonia runs on macOS[​](#how-avalonia-runs-on-macos "Direct link to How Avalonia runs on macOS")
...
### Accessing the full macOS API surface[​](#accessing-the-full-macos-api-surface "Direct link to Accessing the full macOS API surface")
...
## Application name and identity[​](#application-name-and-identity "Direct link to Application name and identity")
...
### Where the name comes from[​](#where-the-name-comes-from "Direct link to Where the name comes from")
...
| "About" menu item        | Header text of your [`NativeMenuItem`](/api/avalonia/controls/nativemenuitem.md) | You control this text entirely.                                |
...
### Setting the application name[​](#setting-the-application-name "Direct link to Setting the application name")
...
## Native menu bar[​](#native-menu-bar "Direct link to Native menu bar")

macOS applications have a menu bar at the top of the screen, separate from the application window. Avalonia supports this through [`NativeMenu`](/api/avalonia/controls/nativemenu.md), which renders as a native macOS menu bar.

### Application menu[​](#application-menu "Direct link to Application menu")
...
### Replacing the About dialog[​](#replacing-the-about-dialog "Direct link to Replacing the About dialog")
...
### Window menus[​](#window-menus "Direct link to Window menus")
...
### Dock menu[​](#dock-menu "Direct link to Dock menu")
...
## macOS platform conventions[​](#macos-platform-conventions "Direct link to macOS platform conventions")
...
### Standard shortcuts[​](#standard-shortcuts "Direct link to Standard shortcuts")
...
### PlatformHotkeyConfiguration[​](#platformhotkeyconfiguration "Direct link to PlatformHotkeyConfiguration")
...
## Embedding native views[​](#embedding-native-views "Direct link to Embedding native views")
...
### Embedding Avalonia in a native macOS app[​](#embedding-avalonia-in-a-native-macos-app "Direct link to Embedding Avalonia in a native macOS app")
...
## URL protocol handlers[​](#url-protocol-handlers "Direct link to URL protocol handlers")
...
### Running as an app bundle during development[​](#running-as-an-app-bundle-during-development "Direct link to Running as an app bundle during development")
...
Then place a valid `Info.plist` in the `Contents` directory. See the [macOS deployment guide](/docs/deployment/macos.md) for `Info.plist` details.

## Mac Catalyst alternative[​](#mac-catalyst-alternative "Direct link to Mac Catalyst alternative")

Avalonia also supports running iOS apps on macOS through Apple's Mac Catalyst framework. This is a different approach from the Avalonia Native backend described on this page. Mac Catalyst requires a Mac to build and depends on the `maccatalyst` .NET workload, so you lose the ability to cross-compile from Windows or Linux. It is primarily useful when your app depends heavily on UIKit APIs or when embedding Avalonia inside a MAUI hybrid application. For most Avalonia apps, the default macOS backend described above is the recommended choice. See [Mac Catalyst](/docs/platform-specific-guides/ios.md#mac-catalyst) in the iOS platform guide for details.

## See also[​](#see-also "Direct link to See also")

* [Deploying on macOS](/docs/deployment/macos.md)
* [iOS platform guide](/docs/platform-specific-guides/ios.md) (includes Mac Catalyst)
* [NativeMenu control reference](/controls/menus/nativemenu.md)
* [Keyboard and hotkeys](/docs/input-interaction/keyboard-and-hotkeys.md)
