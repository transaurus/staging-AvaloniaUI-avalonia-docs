...
Linux users: use the official Microsoft .NET SDK
...
### Install the Android SDK[​](#install-the-android-sdk "Direct link to Install the Android SDK")
...
If you use *JetBrains Rider* then follow the [Rider Xamarin setup guide](https://www.jetbrains.com/help/rider/Xamarin.html).
...
* [Deploying on Android](/docs/deployment/android.md) (emulator, device, and publishing)
* [Configure Android debugging in Visual Studio Code on Linux](/tools/visual-studio-code/configure-vscode-debug-linux.md)
