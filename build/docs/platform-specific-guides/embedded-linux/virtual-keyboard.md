...
* [`VirtualKeyboardScope`](/controls/layout/containers/virtualkeyboardscope.md) - A container that manages keyboard visibility and input methods
* [`VirtualKeyboard`](/controls/input/text-input/virtualkeyboard.md) - The actual keyboard control that can be placed manually
...
### Include the control theme[​](#include-the-control-theme "Direct link to Include the control theme")
...
### Using VirtualKeyboardScope (Recommended)[​](#using-virtualkeyboardscope-recommended "Direct link to Using VirtualKeyboardScope (Recommended)")
...
### Using VirtualKeyboard Directly[​](#using-virtualkeyboard-directly "Direct link to Using VirtualKeyboard Directly")
...
## Managing input methods[​](#managing-input-methods "Direct link to Managing input methods")
...
### In XAML[​](#in-xaml "Direct link to In XAML")
...
### Retrieving available input methods[​](#retrieving-available-input-methods "Direct link to Retrieving available input methods")
...
## Input method identifiers[​](#input-method-identifiers "Direct link to Input method identifiers")

The virtual keyboard component supports a wide range of input method identifiers for different languages. See the [virtual keyboard control](/controls/input/text-input/virtualkeyboard.md) page for a list of supported identifiers.

## TextInputOptions[​](#textinputoptions "Direct link to TextInputOptions")
...
* [VirtualKeyboard control](/controls/input/text-input/virtualkeyboard.md)
* [VirtualKeyboardScope control](/controls/layout/containers/virtualkeyboardscope.md)
