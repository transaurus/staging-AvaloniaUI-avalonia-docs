...
### Basic usage in markup extension syntax[​](#basic-usage-in-markup-extension-syntax "Direct link to Basic usage in markup extension syntax")
...
### Specifying type arguments[​](#specifying-type-arguments "Direct link to Specifying type arguments")
...
### Nested markup extensions[​](#nested-markup-extensions "Direct link to Nested markup extensions")
...
### XML syntax[​](#xml-syntax "Direct link to XML syntax")
...
### Complex property setters[​](#complex-property-setters "Direct link to Complex property setters")
...
### XML combining syntax[​](#xml-combining-syntax "Direct link to XML combining syntax")
...
### Additional details[​](#additional-details "Direct link to Additional details")
...
## OnFormFactor Markup Extension[​](#onformfactor-markup-extension "Direct link to OnFormFactor Markup Extension")
