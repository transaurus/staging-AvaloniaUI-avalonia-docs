...
## Display output: framebuffer vs DRM[​](#display-output-framebuffer-vs-drm "Direct link to Display output: framebuffer vs DRM")
...
### Linux framebuffer (`/dev/fb0`)[​](#linux-framebuffer-devfb0 "Direct link to linux-framebuffer-devfb0")
...
### Direct Rendering Manager (DRM/KMS)[​](#direct-rendering-manager-drmkms "Direct link to Direct Rendering Manager (DRM/KMS)")
...
### Which to choose[​](#which-to-choose "Direct link to Which to choose")
...
## The single-view application lifetime[​](#the-single-view-application-lifetime "Direct link to The single-view application lifetime")
...
## Enabling DRM output[​](#enabling-drm-output "Direct link to Enabling DRM output")
...
## Display scaling[​](#display-scaling "Direct link to Display scaling")
...
## Verifying your DRM setup[​](#verifying-your-drm-setup "Direct link to Verifying your DRM setup")
...
## Touch input[​](#touch-input "Direct link to Touch input")
...
For applications that need an on-screen keyboard (kiosks, point-of-sale systems, or any device without a physical keyboard), see the [Virtual Keyboard](/docs/platform-specific-guides/embedded-linux/virtual-keyboard.md) guide.

## See also[​](#see-also "Direct link to See also")

* [Running on Raspberry Pi](/docs/platform-specific-guides/embedded-linux/raspberry-pi.md) for a step-by-step hardware tutorial
* [Virtual Keyboard](/docs/platform-specific-guides/embedded-linux/virtual-keyboard.md) for on-screen keyboard support
* [Deploying to Embedded Linux](/docs/deployment/embedded-linux.md)
* [Desktop Linux](/docs/platform-specific-guides/linux.md) for X11 and Wayland environments
