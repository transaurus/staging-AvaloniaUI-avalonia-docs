...
## When to choose code-only[​](#when-to-choose-code-only "Direct link to When to choose code-only")
...
## Bootstrapping a code-only application[​](#bootstrapping-a-code-only-application "Direct link to Bootstrapping a code-only application")
...
### Using application lifetimes[​](#using-application-lifetimes "Direct link to Using application lifetimes")
...
For full details on lifetime options, see [Application lifetimes](/docs/fundamentals/application-lifetimes.md).

## Creating controls[​](#creating-controls "Direct link to Creating controls")
...
## Building layouts[​](#building-layouts "Direct link to Building layouts")
...
## Applying styles[​](#applying-styles "Direct link to Applying styles")
...
## Data binding from code[​](#data-binding-from-code "Direct link to Data binding from code")
...
### Reactive patterns[​](#reactive-patterns "Direct link to Reactive patterns")
...
For complete coverage of binding from code, see [Binding from code](/docs/data-binding/binding-from-code.md).

## Custom drawing[​](#custom-drawing "Direct link to Custom drawing")
...
## Threading considerations[​](#threading-considerations "Direct link to Threading considerations")
...
For complete threading guidance, see [Threading](/docs/app-development/threading.md).

## F# and Avalonia.FuncUI[​](#f-and-avaloniafuncui "Direct link to F# and Avalonia.FuncUI")
...
### C# compared to F# for coded UI[​](#c-compared-to-f-for-coded-ui "Direct link to C# compared to F# for coded UI")
...
* [Creating data templates in code](/docs/data-templates/creating-data-templates-in-code.md)
* [How To: Build a Complete App Without XAML](/docs/how-to/coded-ui-how-to.md)
