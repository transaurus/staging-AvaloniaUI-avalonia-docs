...
## Avalonia's approach to code sharing[​](#avalonias-approach-to-code-sharing "Direct link to Avalonia's approach to code sharing")
...
* **Styles and themes**
* **Platform services** such as [file pickers](/docs/services/storage/storage-provider.md), [clipboard](/docs/services/clipboard.md), [launcher](/docs/services/launcher.md), [dark mode detection](/docs/services/platform-settings.md), and [safe area handling](/docs/services/insets-manager.md)
...
## Structuring your solution[​](#structuring-your-solution "Direct link to Structuring your solution")
...
The core project contains the vast majority of your code. Platform-specific projects are thin entry points that reference the core. See [Setting up a cross-platform solution](/docs/app-development/cross-platform-solution-setup.md) for a full walkthrough.

## Handling platform differences[​](#handling-platform-differences "Direct link to Handling platform differences")
...
### OnPlatform and OnFormFactor[​](#onplatform-and-onformfactor "Direct link to OnPlatform and OnFormFactor")
...
`OnPlatform` targets a specific operating system, while `OnFormFactor` targets a device category such as Desktop or Mobile. See [Platform-specific XAML](/docs/platform-specific-guides/xaml.md) for the full syntax.
...
This works everywhere without changes to your project structure. See [Platform-specific .NET](/docs/platform-specific-guides/dotnet.md) for the full API reference.

### Conditional compilation[​](#conditional-compilation "Direct link to Conditional compilation")
...
This requires your project to multi-target (for example, `net8.0;net8.0-ios;net8.0-android`). See [Platform-specific .NET](/docs/platform-specific-guides/dotnet.md) for setup details.

### Interface abstraction[​](#interface-abstraction "Direct link to Interface abstraction")
...
Register each implementation with your dependency injection container so that shared code can consume it without knowing which platform it runs on. See [Platform-specific .NET](/docs/platform-specific-guides/dotnet.md) for a complete example and [Dependency injection](/docs/app-development/dependency-injection.md) for DI setup.
...
* [Setting up a cross-platform solution](/docs/app-development/cross-platform-solution-setup.md)
* [Platform-specific .NET](/docs/platform-specific-guides/dotnet.md)
* [Platform-specific XAML](/docs/platform-specific-guides/xaml.md)
* [Dependency injection](/docs/app-development/dependency-injection.md)
