...
### Navigating the logical tree[​](#navigating-the-logical-tree "Direct link to Navigating the logical tree")
...
### Navigating the visual tree[​](#navigating-the-visual-tree "Direct link to Navigating the visual tree")
...
## Differences between the trees[​](#differences-between-the-trees "Direct link to Differences between the trees")
...
## When to use which tree[​](#when-to-use-which-tree "Direct link to When to use which tree")
...
## Examining trees at runtime[​](#examining-trees-at-runtime "Direct link to Examining trees at runtime")
...
## Template parts and the visual tree[​](#template-parts-and-the-visual-tree "Direct link to Template parts and the visual tree")
...
### Adding custom overlay content[​](#adding-custom-overlay-content "Direct link to Adding custom overlay content")
...
* [UI composition](/docs/fundamentals/ui-composition.md): How controls compose into a UI.
* [Control trees](/docs/custom-controls/control-trees.md): Visual and logical trees in custom control development.
* [Events overview](/docs/events.md): How events route through the visual tree.
* [Templated controls](/docs/custom-controls/templated-controls.md): Building controls with templates.
