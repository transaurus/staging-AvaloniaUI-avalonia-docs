...
## The rendering pipeline[​](#the-rendering-pipeline "Direct link to The rendering pipeline")
...
### Frame lifecycle[​](#frame-lifecycle "Direct link to Frame lifecycle")
...
### Layout: Measure and Arrange[​](#layout-measure-and-arrange "Direct link to Layout: Measure and Arrange")
...
### Scene graph and composition[​](#scene-graph-and-composition "Direct link to Scene graph and composition")
...
## Platform abstraction[​](#platform-abstraction "Direct link to Platform abstraction")
...
## The property system[​](#the-property-system "Direct link to The property system")
...
Property values are resolved through a precedence system. See [Property Value Precedence](/docs/properties/value-precedence.md) for the full priority order.

## The styling system[​](#the-styling-system "Direct link to The styling system")
...
## The visual and logical trees[​](#the-visual-and-logical-trees "Direct link to The visual and logical trees")
...
See [Visual and Logical Trees](/docs/fundamentals/visual-and-logical-trees.md) for detailed coverage.

## Threading model[​](#threading-model "Direct link to Threading model")
...
See [Threading](/docs/app-development/threading.md) for the full threading model.

## See also[​](#see-also "Direct link to See also")

* [Cross-platform architecture](/docs/fundamentals/cross-platform-architecture.md): Solution structure and platform-specific code patterns.
* [Visual and logical trees](/docs/fundamentals/visual-and-logical-trees.md): How the two trees work and when to use each.
* [Property system](/docs/properties.md): StyledProperty, DirectProperty, and AttachedProperty.
* [Threading](/docs/app-development/threading.md): Dispatcher and async patterns.
* [Performance optimization](/docs/app-development/performance.md): Layout, rendering, and binding performance tips.
