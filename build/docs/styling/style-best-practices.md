...
## Use style classes instead of inline properties[​](#use-style-classes-instead-of-inline-properties "Direct link to Use style classes instead of inline properties")
...
## Use DynamicResource for theme-aware values[​](#use-dynamicresource-for-theme-aware-values "Direct link to Use DynamicResource for theme-aware values")
...
## Keep templates minimal[​](#keep-templates-minimal "Direct link to Keep templates minimal")
...
## Organize styles by scope[​](#organize-styles-by-scope "Direct link to Organize styles by scope")
...
## Avoid !important-style hacks[​](#avoid-important-style-hacks "Direct link to Avoid !important-style hacks")
...
## Transitions for state changes[​](#transitions-for-state-changes "Direct link to Transitions for state changes")
...
## Test across themes[​](#test-across-themes "Direct link to Test across themes")
