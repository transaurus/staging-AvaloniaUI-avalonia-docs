...
*Pseudoclasses* in Avalonia, similar to those in CSS, are keywords exposed by a `Control` that indicate a distinct control state. These states are used in [style selectors](/docs/styling/style-selectors.md) to conditionally style controls. For example, a [`Button`](/api/avalonia/controls/button.md) could have a different appearance while it is being pressed, or a `TextBox` while it is disabled.
...
## Common pseudoclasses[​](#common-pseudoclasses "Direct link to Common pseudoclasses")
...
## Using pseudoclasses in selectors[​](#using-pseudoclasses-in-selectors "Direct link to Using pseudoclasses in selectors")
...
## Creating custom pseudoclasses[​](#creating-custom-pseudoclasses "Direct link to Creating custom pseudoclasses")
...
![](/assets/images/custom-pseudoclass-1a43f78323816a718fef649b6367486d.gif)
