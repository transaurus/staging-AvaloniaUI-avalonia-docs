...
## Font URI format[​](#font-uri-format "Direct link to Font URI format")
...
## Static resource fonts[​](#static-resource-fonts "Direct link to Static resource fonts")
...
## Embedded font collections[​](#embedded-font-collections "Direct link to Embedded font collections")

An [`EmbeddedFontCollection`](/api/avalonia/media/fonts/embeddedfontcollection.md) registers a directory of font files under a custom URI scheme. This lets you reference fonts by family name directly in XAML without declaring individual resource keys.
...
## Pre-built font packages[​](#pre-built-font-packages "Direct link to Pre-built font packages")
...
## Customizing font matching[​](#customizing-font-matching "Direct link to Customizing font matching")
...
### Custom character matching[​](#custom-character-matching "Direct link to Custom character matching")
...
### Controlling synthetic typefaces[​](#controlling-synthetic-typefaces "Direct link to Controlling synthetic typefaces")
...
## Supported font formats[​](#supported-font-formats "Direct link to Supported font formats")
...
### Font not appearing (falls back to default)[​](#font-not-appearing-falls-back-to-default "Direct link to Font not appearing (falls back to default)")
...
* [Typography](/docs/styling/typography.md): Font size, weight, style, letter spacing, line height, and text decorations.
* [How to add a custom font](/docs/how-to/custom-font-how-to.md)
* [Assets](/docs/fundamentals/assets.md)
