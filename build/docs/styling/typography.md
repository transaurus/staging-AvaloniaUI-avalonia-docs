...
Avalonia provides a set of properties for controlling how text appears in your application. These properties are defined on [`TextElement`](/api/avalonia/controls/documents/textelement.md) as inherited attached properties, so you can set them on any control to affect all text within its visual tree through [property value inheritance](/docs/properties/property-value-inheritance.md).

## TextElement attached properties[​](#textelement-attached-properties "Direct link to TextElement attached properties")
...
| --------------------------- | --------------------------------------------------- | ---------------- | -------------------------------------------------------------- |
| `TextElement.FontFamily`    | [`FontFamily`](/api/avalonia/media/fontfamily.md)   | Platform default | The typeface used to render text.                              |
| `TextElement.FontSize`      | `double`                                            | `12`             | The size of text in device-independent pixels.                 |
| `TextElement.FontWeight`    | [`FontWeight`](/api/avalonia/media/fontweight.md)   | `Normal`         | The thickness of character strokes.                            |
| `TextElement.FontStyle`     | [`FontStyle`](/api/avalonia/media/fontstyle.md)     | `Normal`         | Whether text is upright, italic, or oblique.                   |
| `TextElement.FontStretch`   | [`FontStretch`](/api/avalonia/media/fontstretch.md) | `Normal`         | The width of characters relative to their normal aspect ratio. |
...
## Font weight[​](#font-weight "Direct link to Font weight")
...
## Font style[​](#font-style "Direct link to Font style")
...
## Font stretch[​](#font-stretch "Direct link to Font stretch")
...
## Line height and line spacing[​](#line-height-and-line-spacing "Direct link to Line height and line spacing")
...
## Text decorations[​](#text-decorations "Direct link to Text decorations")

Text decorations draw lines on or around text. Avalonia provides four presets through the [`TextDecorations`](/api/avalonia/media/textdecorations.md) class, and supports fully customized decorations through the [`TextDecoration`](/api/avalonia/media/textdecoration.md) class.

### Preset decorations[​](#preset-decorations "Direct link to Preset decorations")
...
### Custom decorations[​](#custom-decorations "Direct link to Custom decorations")

For control over color, thickness, offset, and dash pattern, define a `TextDecoration` directly.

| Property              | Type                                                                      | Description                                                                             |
| --------------------- | ------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| `Location`            | [`TextDecorationLocation`](/api/avalonia/media/textdecorationlocation.md) | Where the line is drawn: `Underline`, `Strikethrough`, `Overline`, or `Baseline`.       |
| `Stroke`              | `IBrush`                                                                  | The brush used to paint the decoration line.                                            |
| `StrokeThickness`     | `double`                                                                  | The thickness of the decoration line.                                                   |
| `StrokeThicknessUnit` | [`TextDecorationUnit`](/api/avalonia/media/textdecorationunit.md)         | The unit for thickness: `FontRecommended` (default), `FontRenderingEmSize`, or `Pixel`. |
...
## OpenType font features[​](#opentype-font-features "Direct link to OpenType font features")
...
For a full list of common tags and usage examples, see [Custom fonts: OpenType font features](/docs/styling/custom-fonts.md#opentype-font-features).

## Creating a type scale with style classes[​](#creating-a-type-scale-with-style-classes "Direct link to Creating a type scale with style classes")

Avalonia does not include built-in heading styles like HTML's `<h1>` through `<h6>`. You can create your own type scale using [style classes](/docs/styling/style-classes.md), giving you full control over the sizes, weights, and spacing that match your application's design.
...
This approach works well with [sharing styles](/docs/styling/sharing-styles.md) across your application. Define the type scale once, then use it consistently everywhere.

## Setting typography from code[​](#setting-typography-from-code "Direct link to Setting typography from code")
...
* [Custom fonts](/docs/styling/custom-fonts.md): Embedding and loading custom font files.
* [Text options](/docs/graphics-animation/text-options.md): Controlling text rendering, hinting, and baseline alignment.
* [TextBlock](/controls/data-display/text-display/textblock.md): The primary control for displaying formatted text.
* [TextTrimming](/reference/text/texttrimming): How text is truncated when it overflows.
* [Property value inheritance](/docs/properties/property-value-inheritance.md): How font properties propagate through the visual tree.
* [`TextElement` API reference](/api/avalonia/controls/documents/textelement.md)
* [Style classes](/docs/styling/style-classes.md): Applying named style classes to controls.
* [`FontWeight` API reference](/api/avalonia/media/fontweight.md)
