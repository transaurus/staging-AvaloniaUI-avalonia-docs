...
* Familiarity with [styles](/docs/styling/styles.md) and [XAML](/docs/fundamentals/avalonia-xaml.md) basics.

## What is a control template?[​](#what-is-a-control-template "Direct link to What is a control template?")
...
## Step 1: Create a basic button template[​](#step-1-create-a-basic-button-template "Direct link to Step 1: Create a basic button template")
...
## Step 2: Add visual states with pseudo-classes[​](#step-2-add-visual-states-with-pseudo-classes "Direct link to Step 2: Add visual states with pseudo-classes")
...
### Common pseudo-classes[​](#common-pseudo-classes "Direct link to Common pseudo-classes")
...
## Step 3: Add animations[​](#step-3-add-animations "Direct link to Step 3: Add animations")
...
## Step 4: Use template parts[​](#step-4-use-template-parts "Direct link to Step 4: Use template parts")
...
## Step 5: Putting it all together[​](#step-5-putting-it-all-together "Direct link to Step 5: Putting it all together")
...
## Tips for custom templates[​](#tips-for-custom-templates "Direct link to Tips for custom templates")
...
* [Control themes](/docs/styling/control-themes.md): How themes use templates for all controls.
* [Style selectors](/docs/styling/style-selectors.md): Selector syntax for targeting controls and states.
* [Pseudo-classes](/docs/styling/pseudoclasses.md): All available pseudo-classes.
