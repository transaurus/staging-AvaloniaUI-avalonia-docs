...
The Avalonia style system is a mechanism that shares property settings between controls. Avalonia provides three primary mechanisms for styling controls:

## Styles[​](#styles "Direct link to Styles")

* [Styles](/docs/styling/styles.md) are similar to CSS styles and are usually used to style controls based on their content or purpose within the application; for example creating a style for header text blocks.

## Control themes[​](#control-themes "Direct link to Control themes")

* [Control themes](/docs/styling/control-themes.md) are similar to WPF/UWP styles and are usually used to apply a theme to controls.

## Container queries[​](#container-queries "Direct link to Container queries")

* [Container queries](/docs/styling/container-queries.md) are a collection of styles that are applied based on the size of a container.
...
## How styles are written[​](#how-styles-are-written "Direct link to How styles are written")
...
The Avalonia **style selector syntax** is analogous to that used by CSS (cascading style sheets). For detailed reference information, see the [style selector syntax](/docs/styling/style-selector-syntax.md) reference.

## Example[​](#example "Direct link to Example")

This is an example of how a style is written and applied to a control element, with a [style class](/docs/styling/style-classes.md) to help selection:
...
## Where to put styles[​](#where-to-put-styles "Direct link to Where to put styles")
...
## The selector[​](#the-selector "Direct link to The selector")
...
A full list of selectors can be found in the [style selector syntax](/docs/styling/style-selector-syntax.md) reference.
...
For more information on setters, see [property setters](/docs/styling/property-setters.md).

## Nested styles[​](#nested-styles "Direct link to Nested styles")

Styles can be nested in other styles. To nest a style, include the child style as a child of the parent `<Style>` element, and start the selector with the [`Nesting selector (^)`](/docs/styling/style-selector-syntax.md):
...
## Style key[​](#style-key "Direct link to Style key")
...
## Styles and resources[​](#styles-and-resources "Direct link to Styles and resources")
...
For guidance on how to use resources in your application, see [resource dictionaries](/docs/app-development/resource-dictionary.md).
...
* [Property setters](/docs/styling/property-setters.md)
