...
## Conditional classes[​](#conditional-classes "Direct link to Conditional classes")
...
## Conditional styling patterns[​](#conditional-styling-patterns "Direct link to Conditional styling patterns")
...
### Toggle appearance based on a bound property[​](#toggle-appearance-based-on-a-bound-property "Direct link to Toggle appearance based on a bound property")
...
### Using a converter for non-boolean conditions[​](#using-a-converter-for-non-boolean-conditions "Direct link to Using a converter for non-boolean conditions")
...
### Combining pseudo-classes with style classes[​](#combining-pseudo-classes-with-style-classes "Direct link to Combining pseudo-classes with style classes")
...
### Custom pseudo-classes in your controls[​](#custom-pseudo-classes-in-your-controls "Direct link to Custom pseudo-classes in your controls")
...
## Classes in code[​](#classes-in-code "Direct link to Classes in code")
