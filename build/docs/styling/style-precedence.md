...
## Value sources (highest to lowest priority)[​](#value-sources-highest-to-lowest-priority "Direct link to Value sources (highest to lowest priority)")
...
The property system checks each level in order and returns the first value it finds. For the full API details, see [Property value precedence](/docs/properties/value-precedence.md).

## Why your style might not apply[​](#why-your-style-might-not-apply "Direct link to Why your style might not apply")
...
## Style declaration order[​](#style-declaration-order "Direct link to Style declaration order")
...
## Pseudo-class triggers vs base styles[​](#pseudo-class-triggers-vs-base-styles "Direct link to Pseudo-class triggers vs base styles")
...
## Animations override everything[​](#animations-override-everything "Direct link to Animations override everything")
...
## Inherited values[​](#inherited-values "Direct link to Inherited values")
...
## Debugging precedence issues[​](#debugging-precedence-issues "Direct link to Debugging precedence issues")

Use DevTools (press `F12` at runtime) to inspect property values. The **Properties** panel shows the current value and its source, so you can identify which level is providing the active value.

## See also[​](#see-also "Direct link to See also")

* [Property value precedence](/docs/properties/value-precedence.md)
* [Styles](/docs/styling/styles.md)
* [Pseudoclasses](/docs/styling/pseudoclasses.md)
* [Styling best practices](/docs/styling/style-best-practices.md)
