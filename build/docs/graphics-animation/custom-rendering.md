...
## Overriding render[​](#overriding-render "Direct link to Overriding render")
...
## DrawingContext operations[​](#drawingcontext-operations "Direct link to DrawingContext operations")
...
### Drawing with state[​](#drawing-with-state "Direct link to Drawing with state")
...
Use [`FormattedText`](/api/avalonia/media/formattedtext.md) to measure and render a single run of text:
...
### Drawing images[​](#drawing-images "Direct link to Drawing images")
...
## RenderTargetBitmap[​](#rendertargetbitmap "Direct link to RenderTargetBitmap")
...
## ICustomDrawOperation for SkiaSharp[​](#icustomdrawoperation-for-skiasharp "Direct link to ICustomDrawOperation for SkiaSharp")
...
## GPU interop with composition surfaces[​](#gpu-interop-with-composition-surfaces "Direct link to GPU interop with composition surfaces")
...
### Importing GPU images[​](#importing-gpu-images "Direct link to Importing GPU images")
...
### Supported handle types[​](#supported-handle-types "Direct link to Supported handle types")
...
## CompositionCustomVisualHandler[​](#compositioncustomvisualhandler "Direct link to CompositionCustomVisualHandler")

[`CompositionCustomVisualHandler`](/api/avalonia/rendering/composition/compositioncustomvisualhandler.md) provides per-frame callbacks that run directly on the render thread, without blocking the UI thread. This is useful for smooth, continuous animations or real-time visualizations where UI-thread overhead is a concern.

For simpler scenarios where UI-thread callbacks are acceptable, use [`TopLevel.RequestAnimationFrame`](/docs/fundamentals/top-level.md#requestanimationframe) instead.

### Setting up a custom visual handler[​](#setting-up-a-custom-visual-handler "Direct link to Setting up a custom visual handler")
...
### Communicating between threads[​](#communicating-between-threads "Direct link to Communicating between threads")
...
### When to use CompositionCustomVisualHandler[​](#when-to-use-compositioncustomvisualhandler "Direct link to When to use CompositionCustomVisualHandler")
...
* [TopLevel.RequestAnimationFrame](/docs/fundamentals/top-level.md#requestanimationframe): Per-frame callbacks on the UI thread.
* [Composition Animations](/docs/graphics-animation/composition-animations.md): Render-thread property animations using the composition API.
* [Shapes and Geometries](/docs/graphics-animation/shapes-and-geometries.md): Built-in shape controls and geometry types.
* [Drawing Controls](/docs/custom-controls/drawing-custom-controls.md): Creating custom controls that draw themselves.
* [Brushes](/docs/graphics-animation/brushes.md): Available brush types for filling and stroking.
* [Effects](/docs/graphics-animation/effects.md): Shadows, blur, and visual effects.
