# Render transforms vs layout transforms
...
## Render transforms[​](#render-transforms "Direct link to Render transforms")
...
### Common render transform types[​](#common-render-transform-types "Direct link to Common render transform types")
...
## Layout transforms[​](#layout-transforms "Direct link to Layout transforms")
...
### Common layout transform use cases[​](#common-layout-transform-use-cases "Direct link to Common layout transform use cases")
...
* [Transforms](/docs/graphics-animation/transforms.md): Full transform reference.
* [Animations](/docs/graphics-animation/animations.md): Keyframe and transition animations.
* [Performance](/docs/app-development/performance.md): Layout performance tips.
