...
## SolidColorBrush[​](#solidcolorbrush "Direct link to SolidColorBrush")
...
### Creating in code[​](#creating-in-code "Direct link to Creating in code")
...
## LinearGradientBrush[​](#lineargradientbrush "Direct link to LinearGradientBrush")

Fills an area with a gradient that transitions between colors along a line. For a focused guide on linear gradients, see [Gradients](/docs/graphics-animation/gradients.md).
...
| [`GradientStops`](/api/avalonia/media/gradientstops.md) | A collection of `GradientStop` objects defining colors and positions.                          |
...
### Gradient directions[​](#gradient-directions "Direct link to Gradient directions")
...
## RadialGradientBrush[​](#radialgradientbrush "Direct link to RadialGradientBrush")
...
## ConicGradientBrush[​](#conicgradientbrush "Direct link to ConicGradientBrush")
...
### Key properties[​](#key-properties-2 "Direct link to Key properties")
...
## ImageBrush[​](#imagebrush "Direct link to ImageBrush")
...
### Key properties[​](#key-properties-3 "Direct link to Key properties")
...
### Tiling example[​](#tiling-example "Direct link to Tiling example")
...
## VisualBrush[​](#visualbrush "Direct link to VisualBrush")
...
### Key properties[​](#key-properties-4 "Direct link to Key properties")
...
## Common brush properties[​](#common-brush-properties "Direct link to Common brush properties")
...
## OpacityMask[​](#opacitymask "Direct link to OpacityMask")
...
## Using brushes as resources[​](#using-brushes-as-resources "Direct link to Using brushes as resources")
...
## Brushes in code[​](#brushes-in-code "Direct link to Brushes in code")
...
* [Gradients](/docs/graphics-animation/gradients.md): Focused guide on linear gradient usage.
* [Drawing Graphics](/docs/graphics-animation/drawing-graphics.md): Shapes and geometries.
* [Image Interpolation](/docs/graphics-animation/image-interpolation.md): Bitmap rendering quality settings.
