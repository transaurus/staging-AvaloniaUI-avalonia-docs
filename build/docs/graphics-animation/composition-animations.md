...
## When to use composition animations[​](#when-to-use-composition-animations "Direct link to When to use composition animations")
...
For style-driven scenarios, [Keyframe Animations](/docs/graphics-animation/keyframe-animations.md) and [Control Transitions](/docs/graphics-animation/control-transitions.md) are simpler and more appropriate.

## Core concepts[​](#core-concepts "Direct link to Core concepts")

### CompositionVisual and Compositor[​](#compositionvisual-and-compositor "Direct link to CompositionVisual and Compositor")

Every Avalonia control has a corresponding [`CompositionVisual`](/api/avalonia/rendering/composition/compositionvisual.md) on the render thread. You obtain it with `ElementComposition.GetElementVisual()`:
...
The [`Compositor`](/api/avalonia/rendering/composition/compositor.md) is the factory object that creates animations and animation collections. Access it from any `CompositionVisual`:
...
### Animatable Properties[​](#animatable-properties "Direct link to Animatable Properties")
...
## Explicit animations[​](#explicit-animations "Direct link to Explicit animations")
...
### Slide-in example[​](#slide-in-example "Direct link to Slide-in example")
...
### Fade-in example[​](#fade-in-example "Direct link to Fade-in example")
...
## Implicit animations[​](#implicit-animations "Direct link to Implicit animations")
...
### Smooth repositioning example[​](#smooth-repositioning-example "Direct link to Smooth repositioning example")
...
## Integrating with XAML via attached properties[​](#integrating-with-xaml-via-attached-properties "Direct link to Integrating with XAML via attached properties")
...
### Attached property[​](#attached-property "Direct link to Attached property")
...
* [Keyframe Animations](/docs/graphics-animation/keyframe-animations.md)
* [Control Transitions](/docs/graphics-animation/control-transitions.md)
* [Custom Rendering](/docs/graphics-animation/custom-rendering.md)
