...
Transforms modify the position, size, rotation, or skew of visual elements without changing their layout. Avalonia supports render transforms (applied after layout) and layout transforms (applied during layout via [`LayoutTransformControl`](/api/avalonia/controls/layouttransformcontrol.md)).

## RenderTransform[​](#rendertransform "Direct link to RenderTransform")
...
### RenderTransformOrigin[​](#rendertransformorigin "Direct link to RenderTransformOrigin")
...
## Transform types[​](#transform-types "Direct link to Transform types")

### RotateTransform[​](#rotatetransform "Direct link to RotateTransform")
...
### ScaleTransform[​](#scaletransform "Direct link to ScaleTransform")
...
### SkewTransform[​](#skewtransform "Direct link to SkewTransform")
...
### TranslateTransform[​](#translatetransform "Direct link to TranslateTransform")
...
### MatrixTransform[​](#matrixtransform "Direct link to MatrixTransform")
...
### TransformGroup[​](#transformgroup "Direct link to TransformGroup")
...
## LayoutTransformControl[​](#layouttransformcontrol "Direct link to LayoutTransformControl")
...
## Animating transforms[​](#animating-transforms "Direct link to Animating transforms")
...
For more information on animations, see [Keyframe Animations](/docs/graphics-animation/keyframe-animations.md) and [Control Transitions](/docs/graphics-animation/control-transitions.md).

## Transforms in code[​](#transforms-in-code "Direct link to Transforms in code")
...
* [Keyframe Animations](/docs/graphics-animation/keyframe-animations.md): Animate transforms over time.
* [Control Transitions](/docs/graphics-animation/control-transitions.md): Apply transitions when property values change.
