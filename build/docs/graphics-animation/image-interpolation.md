...
## Interpolation modes[​](#interpolation-modes "Direct link to Interpolation modes")
...
## Setting the interpolation mode[​](#setting-the-interpolation-mode "Direct link to Setting the interpolation mode")

### Per-control setting[​](#per-control-setting "Direct link to Per-control setting")
...
## Edge mode (antialiasing)[​](#edge-mode-antialiasing "Direct link to Edge mode (antialiasing)")
...
## Creating a global setting[​](#creating-a-global-setting "Direct link to Creating a global setting")
...
* [Text Options](/docs/graphics-animation/text-options.md): Text rendering quality options via `TextOptions`.
