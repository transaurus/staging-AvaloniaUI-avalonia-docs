...
## Using easing functions[​](#using-easing-functions "Direct link to Using easing functions")
...
## Built-in easing functions[​](#built-in-easing-functions "Direct link to Built-in easing functions")
...
### Quadratic[​](#quadratic "Direct link to Quadratic")
...
| [`CubicEaseOut`](/api/avalonia/animation/easings/cubiceaseout.md) | Fast start         |
| `CubicEaseInOut`                                                  | Slow start and end |

### Quartic[​](#quartic "Direct link to Quartic")
...
### Quintic[​](#quintic "Direct link to Quintic")
...
### Exponential[​](#exponential "Direct link to Exponential")
...
### Circular[​](#circular "Direct link to Circular")
...
| [`BackEaseOut`](/api/avalonia/animation/easings/backeaseout.md) | Overshoots target, then settles back   |
...
| [`ElasticEaseOut`](/api/avalonia/animation/easings/elasticeaseout.md) | Oscillation at the end   |
| `ElasticEaseInOut`                                                    | Oscillation at both ends |

## Choosing an easing function[​](#choosing-an-easing-function "Direct link to Choosing an easing function")
...
## SplineEasing (Custom Cubic Bezier)[​](#splineeasing-custom-cubic-bezier "Direct link to SplineEasing (Custom Cubic Bezier)")
...
## SpringEasing[​](#springeasing "Direct link to SpringEasing")
...
### Spring parameters[​](#spring-parameters "Direct link to Spring parameters")
...
## Custom easing functions[​](#custom-easing-functions "Direct link to Custom easing functions")
...
* [Keyframe Animations](/docs/graphics-animation/keyframe-animations.md): Using keyframes and easing in animations.
* [Control Transitions](/docs/graphics-animation/control-transitions.md): Automatic transitions on property changes.
