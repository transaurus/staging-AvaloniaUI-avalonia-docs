...
## How hit testing works[​](#how-hit-testing-works "Direct link to How hit testing works")
...
## IsHitTestVisible[​](#ishittestvisible "Direct link to IsHitTestVisible")
...
## Background and hit testing[​](#background-and-hit-testing "Direct link to Background and hit testing")
...
This rule applies at every level, including the `Window` itself. Setting `Background="{x:Null}"` with `TransparencyLevelHint="Transparent"` lets pointer events pass through empty areas to OS windows underneath. Setting `Background="Transparent"` looks the same but captures all input. See [Transparent click-through window](/docs/how-to/window-how-to.md#transparent-click-through-window) for a complete example.

## Programmatic hit testing[​](#programmatic-hit-testing "Direct link to Programmatic hit testing")

### InputHitTest[​](#inputhittest "Direct link to InputHitTest")
...
### Finding the element under the pointer[​](#finding-the-element-under-the-pointer "Direct link to Finding the element under the pointer")
...
## Hit testing in custom controls[​](#hit-testing-in-custom-controls "Direct link to Hit testing in custom controls")
...
### Custom hit test geometry[​](#custom-hit-test-geometry "Direct link to Custom hit test geometry")
...
## Hit testing order[​](#hit-testing-order "Direct link to Hit testing order")
...
## Practical patterns[​](#practical-patterns "Direct link to Practical patterns")

### Click-through overlay[​](#click-through-overlay "Direct link to Click-through overlay")
...
### Detecting clicks on a canvas drawing[​](#detecting-clicks-on-a-canvas-drawing "Direct link to Detecting clicks on a canvas drawing")
...
## Performance with many elements[​](#performance-with-many-elements "Direct link to Performance with many elements")
...
* [Pointer Input](/docs/input-interaction/pointer.md): Pointer events and position.
* [Custom Rendering](/docs/graphics-animation/custom-rendering.md): Drawing with DrawingContext.
* [Shapes and Geometries](/docs/graphics-animation/shapes-and-geometries.md): Geometry types for hit regions.
* [Performance Optimization](/docs/app-development/performance.md): General performance guidance.
