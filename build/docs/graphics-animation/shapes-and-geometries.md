...
## Shape controls[​](#shape-controls "Direct link to Shape controls")
...
## Common shape properties[​](#common-shape-properties "Direct link to Common shape properties")
...
### Dashed lines[​](#dashed-lines "Direct link to Dashed lines")
...
### RectangleGeometry[​](#rectanglegeometry "Direct link to RectangleGeometry")
...
### EllipseGeometry[​](#ellipsegeometry "Direct link to EllipseGeometry")
...
### LineGeometry[​](#linegeometry "Direct link to LineGeometry")
...
### PathGeometry[​](#pathgeometry "Direct link to PathGeometry")
...
### Segment types[​](#segment-types "Direct link to Segment types")
...
### CombinedGeometry[​](#combinedgeometry "Direct link to CombinedGeometry")
...
### GeometryGroup[​](#geometrygroup "Direct link to GeometryGroup")
...
## Path mini-language[​](#path-mini-language "Direct link to Path mini-language")
...
## Building geometry from code[​](#building-geometry-from-code "Direct link to Building geometry from code")
...
### StreamGeometryContext methods[​](#streamgeometrycontext-methods "Direct link to StreamGeometryContext methods")
...
## Geometry methods[​](#geometry-methods "Direct link to Geometry methods")
...
## Using geometries as resources[​](#using-geometries-as-resources "Direct link to Using geometries as resources")
...
* [Drawing Graphics](/docs/graphics-animation/drawing-graphics.md): Overview of the Avalonia graphics system.
* [Brushes](/docs/graphics-animation/brushes.md): Fill and stroke brushes.
* [Effects](/docs/graphics-animation/effects.md): Box shadows, clipping, and opacity masks.
* [Adding Icons](/docs/graphics-animation/adding-icons.md): Using icon fonts and vector icons.
