...
### Circular clip[​](#circular-clip "Direct link to Circular clip")
...
### Rounded rectangle clip[​](#rounded-rectangle-clip "Direct link to Rounded rectangle clip")
...
### Custom shape clip[​](#custom-shape-clip "Direct link to Custom shape clip")
...
### Using stream geometry syntax[​](#using-stream-geometry-syntax "Direct link to Using stream geometry syntax")
...
## Clipping with CornerRadius[​](#clipping-with-cornerradius "Direct link to Clipping with CornerRadius")
...
## Opacity masking[​](#opacity-masking "Direct link to Opacity masking")
...
### Gradient fade[​](#gradient-fade "Direct link to Gradient fade")
...
### Horizontal fade[​](#horizontal-fade "Direct link to Horizontal fade")
...
### Radial mask[​](#radial-mask "Direct link to Radial mask")
...
### VisualBrush mask[​](#visualbrush-mask "Direct link to VisualBrush mask")
...
## Clipping in custom controls[​](#clipping-in-custom-controls "Direct link to Clipping in custom controls")
...
### Geometry clip in code[​](#geometry-clip-in-code "Direct link to Geometry clip in code")
...
* [Shapes and Geometries](/docs/graphics-animation/shapes-and-geometries.md): Geometry types for clip regions.
* [Brushes](/docs/graphics-animation/brushes.md): Brush types for opacity masks.
* [Custom Rendering](/docs/graphics-animation/custom-rendering.md): DrawingContext reference.
