...
## UI virtualization[​](#ui-virtualization "Direct link to UI virtualization")
...
### How virtualization works[​](#how-virtualization-works "Direct link to How virtualization works")
...
### Ensuring virtualization is active[​](#ensuring-virtualization-is-active "Direct link to Ensuring virtualization is active")
...
### ItemsRepeater for custom layouts[​](#itemsrepeater-for-custom-layouts "Direct link to ItemsRepeater for custom layouts")
...
### Buffer factor for smooth scrolling[​](#buffer-factor-for-smooth-scrolling "Direct link to Buffer factor for smooth scrolling")
...
### Variable-height items[​](#variable-height-items "Direct link to Variable-height items")
...
### Reduce control template complexity[​](#reduce-control-template-complexity "Direct link to Reduce control template complexity")

Complex controls like [`TextBox`](/api/avalonia/controls/textbox.md) contain a deep visual tree (borders, scroll viewers, watermark layers). When you create thousands of them, template instantiation and measurement dominate startup time.
...
## Layout performance[​](#layout-performance "Direct link to Layout performance")

### Avoid deep nesting[​](#avoid-deep-nesting "Direct link to Avoid deep nesting")
...
### Use Grid instead of nested StackPanels[​](#use-grid-instead-of-nested-stackpanels "Direct link to Use Grid instead of nested StackPanels")
...
### Minimize InvalidateArrange / InvalidateMeasure[​](#minimize-invalidatearrange--invalidatemeasure "Direct link to Minimize InvalidateArrange / InvalidateMeasure")
...
## Rendering performance[​](#rendering-performance "Direct link to Rendering performance")

### Hide unused controls with IsVisible[​](#hide-unused-controls-with-isvisible "Direct link to Hide unused controls with IsVisible")
...
### Use ClipToBounds judiciously[​](#use-cliptobounds-judiciously "Direct link to Use ClipToBounds judiciously")

`ClipToBounds="True"` creates a clip layer. Only use it when child content actually exceeds the control bounds.

### Reduce hit-testing cost[​](#reduce-hit-testing-cost "Direct link to Reduce hit-testing cost")

When a pointer event occurs, Avalonia walks the visual tree and tests each element. With hundreds or thousands of children in a `Canvas` or `Panel`, this linear walk adds a noticeable delay between clicking and receiving the event. Set `IsHitTestVisible="False"` on elements that do not need pointer interaction, and consider an overlay-based hit-test strategy or custom rendering for scenes with many objects. See [Hit Testing: Performance with many elements](/docs/graphics-animation/hit-testing.md#performance-with-many-elements) for patterns and code examples.
...
### Reduce visual complexity[​](#reduce-visual-complexity "Direct link to Reduce visual complexity")
...
### BitmapCache[​](#bitmapcache "Direct link to BitmapCache")
...
### BitmapInterpolationMode[​](#bitmapinterpolationmode "Direct link to BitmapInterpolationMode")
...
### GPU resource cache size[​](#gpu-resource-cache-size "Direct link to GPU resource cache size")
...
## Data binding performance[​](#data-binding-performance "Direct link to Data binding performance")

### Use compiled bindings[​](#use-compiled-bindings "Direct link to Use compiled bindings")
...
### Avoid unnecessary bindings[​](#avoid-unnecessary-bindings "Direct link to Avoid unnecessary bindings")
...
### Use OneTime bindings for static data[​](#use-onetime-bindings-for-static-data "Direct link to Use OneTime bindings for static data")
...
## Collection performance[​](#collection-performance "Direct link to Collection performance")

### Use ObservableCollection for small-to-medium lists[​](#use-observablecollection-for-small-to-medium-lists "Direct link to Use ObservableCollection for small-to-medium lists")

`ObservableCollection<T>` notifies the UI of individual item additions and removals efficiently.

### Batch large updates[​](#batch-large-updates "Direct link to Batch large updates")
...
### Incremental loading[​](#incremental-loading "Direct link to Incremental loading")
...
### Use DynamicData for large reactive collections[​](#use-dynamicdata-for-large-reactive-collections "Direct link to Use DynamicData for large reactive collections")
...
## Async and threading[​](#async-and-threading "Direct link to Async and threading")

### Keep the UI thread free[​](#keep-the-ui-thread-free "Direct link to Keep the UI thread free")
...
### Debounce rapid input[​](#debounce-rapid-input "Direct link to Debounce rapid input")
...
### Use DispatcherPriority.Background for deferred work[​](#use-dispatcherprioritybackground-for-deferred-work "Direct link to Use DispatcherPriority.Background for deferred work")
...
### Avalonia DevTools[​](#avalonia-devtools "Direct link to Avalonia DevTools")

Press **F12** in debug builds to open DevTools. The **Performance** tab shows frame timing information.

### dotTrace and dotMemory[​](#dottrace-and-dotmemory "Direct link to dotTrace and dotMemory")

JetBrains profiling tools work with Avalonia applications. Use them to identify hot paths and memory leaks.

### Diagnostic overlays[​](#diagnostic-overlays "Direct link to Diagnostic overlays")
...
* [Threading Model](/docs/app-development/threading.md): UI thread and Dispatcher usage.
* [Compiled Bindings](/docs/data-binding/compiled-bindings.md): Compile-time binding validation and performance.
* [Collection Views](/docs/data-binding/collection-views.md): Efficient collection filtering and sorting.
* [Hit Testing](/docs/graphics-animation/hit-testing.md): Hit-test mechanics and performance with many elements.
