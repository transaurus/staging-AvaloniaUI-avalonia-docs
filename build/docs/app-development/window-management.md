...
## Creating windows[​](#creating-windows "Direct link to Creating windows")
...
### Opening a window[​](#opening-a-window "Direct link to Opening a window")
...
### Opening a modal dialog[​](#opening-a-modal-dialog "Direct link to Opening a modal dialog")
...
### Closing with a result[​](#closing-with-a-result "Direct link to Closing with a result")
...
## Window properties[​](#window-properties "Direct link to Window properties")
...
## Window sizing[​](#window-sizing "Direct link to Window sizing")
...
### Saving and restoring window position[​](#saving-and-restoring-window-position "Direct link to Saving and restoring window position")
...
## Multi-window patterns[​](#multi-window-patterns "Direct link to Multi-window patterns")

### Tracking open windows[​](#tracking-open-windows "Direct link to Tracking open windows")
...
### Finding the parent window from a control[​](#finding-the-parent-window-from-a-control "Direct link to Finding the parent window from a control")
...
## Preventing window close[​](#preventing-window-close "Direct link to Preventing window close")
...
## Custom title bar[​](#custom-title-bar "Direct link to Custom title bar")
...
For more details on the `ElementRole` values, see the [custom title bar how-to](/docs/how-to/window-how-to.md#custom-title-bar-with-drag-region).

## Window events[​](#window-events "Direct link to Window events")
...
## Working with screens[​](#working-with-screens "Direct link to Working with screens")
...
### Querying screens[​](#querying-screens "Direct link to Querying screens")
...
### Screen properties[​](#screen-properties "Direct link to Screen properties")
...
### Responding to screen changes[​](#responding-to-screen-changes "Direct link to Responding to screen changes")
...
* [Main Window](/docs/fundamentals/main-window.md): The primary application window.
* [Application Lifetimes](/docs/fundamentals/application-lifetimes.md): How the application lifecycle manages windows.
