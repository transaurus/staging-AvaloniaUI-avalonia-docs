...
[Clone the ](https://github.com/AvaloniaUI/AvaloniaUI.QuickGuides/tree/main/Localization/)

<!-- -->

[Localization](https://github.com/AvaloniaUI/AvaloniaUI.QuickGuides/tree/main/Localization/)

<!-- -->

[ sample](https://github.com/AvaloniaUI/AvaloniaUI.QuickGuides/tree/main/Localization/)

## Add ResX files to the project[​](#add-resx-files-to-the-project "Direct link to Add ResX files to the project")
...
## Set the culture[​](#set-the-culture "Direct link to Set the culture")
...
## Use localized text in the view[​](#use-localized-text-in-the-view "Direct link to Use localized text in the view")
...
## Runtime language switching[​](#runtime-language-switching "Direct link to Runtime language switching")
...
## Right-to-left (RTL) support[​](#right-to-left-rtl-support "Direct link to Right-to-left (RTL) support")

Avalonia supports right-to-left layouts through the [`FlowDirection`](/api/avalonia/media/flowdirection.md) property. Setting `FlowDirection` to `RightToLeft` mirrors the layout of child controls, which is essential for languages such as Arabic, Hebrew, and Persian.
...
## Culture-aware formatting[​](#culture-aware-formatting "Direct link to Culture-aware formatting")
...
* [Resources](/docs/app-development/resources.md): Application resources.
* [Custom Fonts](/docs/styling/custom-fonts.md): Loading fonts for different scripts.
