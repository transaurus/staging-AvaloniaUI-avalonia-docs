...
## UI thread exceptions[​](#ui-thread-exceptions "Direct link to UI thread exceptions")

### Dispatcher.UnhandledException[​](#dispatcherunhandledexception "Direct link to Dispatcher.UnhandledException")
...
### Dispatcher.UnhandledExceptionFilter[​](#dispatcherunhandledexceptionfilter "Direct link to Dispatcher.UnhandledExceptionFilter")
...
### Global try-catch in Main[​](#global-try-catch-in-main "Direct link to Global try-catch in Main")
...
## Background thread exceptions[​](#background-thread-exceptions "Direct link to Background thread exceptions")

### Unobserved task exceptions[​](#unobserved-task-exceptions "Direct link to Unobserved task exceptions")
...
### AppDomain.UnhandledException[​](#appdomainunhandledexception "Direct link to AppDomain.UnhandledException")
...
## Recommended strategy[​](#recommended-strategy "Direct link to Recommended strategy")
...
* [Application Lifetimes](/docs/fundamentals/application-lifetimes.md): Desktop and mobile lifetime models.
