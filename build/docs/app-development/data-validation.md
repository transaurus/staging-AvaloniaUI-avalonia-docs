...
## Validating a property[​](#validating-a-property "Direct link to Validating a property")
...
* [DataAnnotations - ValidationPlugin](/docs/app-development/data-validation.md#dataannotations---validationplugin)
* [INotifyDataErrorInfo - ValidationPlugin](/docs/app-development/data-validation.md#inotifydataerrorinfo---validationplugin)
* [Exception - ValidationPlugin](/docs/app-development/data-validation.md#exception---validationplugin)

### DataAnnotations - ValidationPlugin[​](#dataannotations---validationplugin "Direct link to DataAnnotations - ValidationPlugin")
...
### INotifyDataErrorInfo - ValidationPlugin[​](#inotifydataerrorinfo---validationplugin "Direct link to INotifyDataErrorInfo - ValidationPlugin")
...
Some libraries like the `CommunityToolkit.Mvvm` use `DataAnnotations` for their validation. This may result in conflicts with the [DataAnnotations - ValidationPlugin](/docs/app-development/data-validation.md#dataannotations---validationplugin). Please see [Manage ValidationPlugins](/docs/app-development/data-validation.md#manage-validationplugins) how to solve this issue.

### Exception - ValidationPlugin[​](#exception---validationplugin "Direct link to Exception - ValidationPlugin")
...
## Customize the appearance of the validation message[​](#customize-the-appearance-of-the-validation-message "Direct link to Customize the appearance of the validation message")

To display the validation messages, Avalonia has a control called [`DataValidationErrors`](/api/avalonia/controls/datavalidationerrors.md). This control is typically placed inside the `ControlTemplate` of all `Controls` that supports data validation, like `TextBox`, `Slider` and other. You can create your own `Style` of the `DataValidationErrors`-control to customize the representation of the error messages.
...
## Manage ValidationPlugins[​](#manage-validationplugins "Direct link to Manage ValidationPlugins")
...
* [Data Binding](/docs/data-binding/introduction-to-data-binding.md): Binding data to controls.
