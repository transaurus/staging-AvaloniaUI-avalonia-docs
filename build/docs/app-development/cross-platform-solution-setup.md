...
## Populating the solution[​](#populating-the-solution "Direct link to Populating the solution")
...
[Ensure you've installed the Avalonia Templates.](/docs/get-started.md#installing-avalonia-templates)

### Core project[​](#core-project "Direct link to Core project")
...
### Desktop project[​](#desktop-project "Direct link to Desktop project")

This project enables the app to run on Windows, macOS, and Linux platforms, with an output type of `WinExe`.

### Android project[​](#android-project "Direct link to Android project")
...
### iOS project[​](#ios-project "Direct link to iOS project")
...
### Browser project[​](#browser-project "Direct link to Browser project")
...
## Core project[​](#core-project-1 "Direct link to Core project")
...
## Platform-specific application projects[​](#platform-specific-application-projects "Direct link to Platform-specific application projects")
