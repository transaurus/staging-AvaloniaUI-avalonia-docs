...
## Defining resources[​](#defining-resources "Direct link to Defining resources")
...
## Using resources[​](#using-resources "Direct link to Using resources")
...
## Merged dictionaries[​](#merged-dictionaries "Direct link to Merged dictionaries")
...
### MergeResourceInclude vs ResourceInclude[​](#mergeresourceinclude-vs-resourceinclude "Direct link to MergeResourceInclude vs ResourceInclude")
...
## Theme-variant resources[​](#theme-variant-resources "Direct link to Theme-variant resources")
...
## Accessing resources from code[​](#accessing-resources-from-code "Direct link to Accessing resources from code")
...
## Updating resources at runtime[​](#updating-resources-at-runtime "Direct link to Updating resources at runtime")
...
* [Resource Dictionary](/docs/app-development/resource-dictionary.md): Step-by-step guide to creating and organizing resource dictionaries.
* [Theme Variants](/docs/styling/theme-variants.md): How theme-aware resources work.
* [Styles](/docs/styling/styles.md): Using resources within style definitions.
* [Sharing Styles](/docs/styling/sharing-styles.md): Organizing and sharing style resources.
