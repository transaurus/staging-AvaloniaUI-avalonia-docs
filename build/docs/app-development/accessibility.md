...
## How accessibility works in Avalonia[​](#how-accessibility-works-in-avalonia "Direct link to How accessibility works in Avalonia")
...
## AutomationProperties[​](#automationproperties "Direct link to AutomationProperties")
...
### LabeledBy[​](#labeledby "Direct link to LabeledBy")
...
### AutomationId[​](#automationid "Direct link to AutomationId")
...
### AcceleratorKey and AccessKey[​](#acceleratorkey-and-accesskey "Direct link to AcceleratorKey and AccessKey")
...
### ControlTypeOverride[​](#controltypeoverride "Direct link to ControlTypeOverride")
...
### LandmarkType[​](#landmarktype "Direct link to LandmarkType")
...
### HeadingLevel[​](#headinglevel "Direct link to HeadingLevel")
...
### LiveSetting[​](#livesetting "Direct link to LiveSetting")
...
### ItemStatus[​](#itemstatus "Direct link to ItemStatus")
...
### ItemType[​](#itemtype "Direct link to ItemType")
...
### AccessibilityView[​](#accessibilityview "Direct link to AccessibilityView")
...
## Keyboard accessibility[​](#keyboard-accessibility "Direct link to Keyboard accessibility")

Accessible applications must be fully operable with a keyboard alone:

### Tab navigation[​](#tab-navigation "Direct link to Tab navigation")
...
See [Focus](/docs/input-interaction/focus.md) for the full keyboard navigation model, including `KeyboardNavigation.TabNavigation` modes and `XYFocus` directional navigation.
...
The underscore prefix creates an access key (Alt+S on Windows/Linux). See [Keyboard and Hotkeys](/docs/input-interaction/keyboard-and-hotkeys.md) for details.

### Focus indicators[​](#focus-indicators "Direct link to Focus indicators")
...
## Creating custom automation peers[​](#creating-custom-automation-peers "Direct link to Creating custom automation peers")
...
### Key methods to override[​](#key-methods-to-override "Direct link to Key methods to override")
...
## Data validation errors[​](#data-validation-errors "Direct link to Data validation errors")
...
## Accessibility checklist[​](#accessibility-checklist "Direct link to Accessibility checklist")
...
| Linux          | [AT-SPI2](/docs/platform-specific-guides/linux.md#accessibility) | Full support    |
| iOS            | UIAccessibility                                                  | Supported       |
| Android        | AccessibilityNodeInfo                                            | Supported       |
| Browser (WASM) | ARIA attributes                                                  | Partial support |

On Linux, Avalonia automatically exposes the accessibility tree over D-Bus when AT-SPI2 is available. Screen readers such as Orca can discover and interact with all standard Avalonia controls. See the [Linux platform guide](/docs/platform-specific-guides/linux.md#accessibility) for setup and testing instructions.

## See also[​](#see-also "Direct link to See also")

* [Focus](/docs/input-interaction/focus.md): Keyboard focus navigation and tab ordering.
* [Keyboard and Hotkeys](/docs/input-interaction/keyboard-and-hotkeys.md): Keyboard shortcuts and access keys.
* [Custom Controls](/docs/custom-controls.md): Building custom controls with proper accessibility support.
* [Desktop Linux](/docs/platform-specific-guides/linux.md#accessibility): Testing accessibility with Orca and Accerciser on Linux.
