...
## Step 0: Context and initial code[​](#step-0-context-and-initial-code "Direct link to Step 0: Context and initial code")
...
* Furthermore, if `MainViewModel` is instantiated in many places, *every* instantiation of `MainViewModel` would also need to be updated should the dependencies of `MainViewModel` ever change (such as the addition of new dependencies, or changing which implementation of a dependency to use).
...
## Step 1: Install the NuGet package for DI[​](#step-1-install-the-nuget-package-for-di "Direct link to Step 1: Install the NuGet package for DI")
...
## Step 2: Add ServiceCollectionExtensions[​](#step-2-add-servicecollectionextensions "Direct link to Step 2: Add ServiceCollectionExtensions")
...
## Step 3: Modify App.axaml.cs[​](#step-3-modify-appaxamlcs "Direct link to Step 3: Modify App.axaml.cs")
...
* [Data Binding](/docs/data-binding/introduction-to-data-binding.md): Binding view models to views.
