...
## Declaring resources[​](#declaring-resources "Direct link to Declaring resources")
...
## Resource dictionary files[​](#resource-dictionary-files "Direct link to Resource dictionary files")
...
![Add New Item dialog showing Avalonia resource dictionary templates](</img/gitbook-import/assets/image (8) (1) (2).png>)
...
### Static resource[​](#static-resource "Direct link to Static resource")
...
## Resource priority[​](#resource-priority "Direct link to Resource priority")
...
## Include and merge resources[​](#include-and-merge-resources "Direct link to Include and merge resources")
...
![Solution Explorer showing resource dictionary file included in a project](</img/gitbook-import/assets/image (1) (4).png>)
...
![Merged resource dictionary structure in a styles file](</img/gitbook-import/assets/image (1) (3).png>)
...
## Merged resources priority[​](#merged-resources-priority "Direct link to Merged resources priority")
...
## Consuming resources from code[​](#consuming-resources-from-code "Direct link to Consuming resources from code")
...
* [Resources Overview](/docs/app-development/resources.md): Understanding resource types and lookup behavior.
* [Theme Variants](/docs/styling/theme-variants.md): Using theme-aware resources.
