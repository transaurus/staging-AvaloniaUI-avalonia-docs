...
[Accelerate](/tools.md) [XPF](/xpf.md)
...
* [`NativeWebView`](/controls/web/nativewebview.md) - A control for embedding web content directly in your application UI
* [`NativeWebDialog`](/controls/web/nativewebdialog.md) - A separate dialog window that hosts web content
...
The WebView component is available with both [Avalonia Accelerate](/tools.md) and [Avalonia XPF](/xpf.md). For XPF-specific installation and usage, see the [XPF section](#xpf) below.

## Installation[​](#installation "Direct link to Installation")

See the [Installation Guide](/tools/installing-accelerate.md) for step-by-step instructions on how to install Accelerate components.
...
### NativeWebView[​](#nativewebview "Direct link to NativeWebView")
...
#### Bidirectional JavaScript execution[​](#bidirectional-javascript-execution "Direct link to Bidirectional JavaScript execution")

In some situations it's necessary to execute arbitrary JavaScript code from the web view control. `NativeWebView` provides [`InvokeScript` async method](/controls/web/nativewebview.md#invokescript):
...
![NativeWebView control displaying web content in an Avalonia window](/assets/images/webview-3c0d3c4924121d3c60bf0df7988597cb.png)

### NativeWebDialog[​](#nativewebdialog "Direct link to NativeWebDialog")
...
### WebAuthenticationBroker[​](#webauthenticationbroker "Direct link to WebAuthenticationBroker")
...
## Platform prerequisites[​](#platform-prerequisites "Direct link to Platform prerequisites")
...
\* For Linux, use NativeWebDialog instead of NativeWebView \*\* Uses NativeWebDialog implementation \*\*\* Android support is experimental \*\*\*\* Requires CORS configuration for the redirect page. .NET 10 is also necessary to run this library in browser.
...
#### macOS/iOS[​](#macosios "Direct link to macOS/iOS")
...
## Native browser interop[​](#native-browser-interop "Direct link to Native browser interop")
...
### Getting handle[​](#getting-handle "Direct link to Getting handle")

To access native browser functionality, you first need to obtain the platform-specific handle from your WebView control.

#### For WebView controls[​](#for-webview-controls "Direct link to For WebView controls")
...
#### For WebView dialogs[​](#for-webview-dialogs "Direct link to For WebView dialogs")
...
### Interop[​](#interop "Direct link to Interop")
...
Both adapters operate with classic COM interop. *IDL* definition files can be found in the `Microsoft.Web.WebView2` nuget package (in case of WebView2), Windows SDK (in case of WebView1) or on the internet.
...
#### MacOS/iOS[​](#macosios-1 "Direct link to MacOS/iOS")
...
#### GTK Linux[​](#gtk-linux "Direct link to GTK Linux")
...
## XPF[​](#xpf "Direct link to XPF")

The WebView component is also available for [Avalonia XPF](/xpf.md) applications. All WebView functionality, APIs, and platform prerequisites described above apply to XPF as well, with the differences noted below.

### Installation[​](#installation-1 "Direct link to Installation")

First, make sure you have installed the XPF NuGet feed as per the [instructions](/xpf/version-info/versioning.md).
