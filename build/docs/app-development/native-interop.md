...
## Platform-specific code patterns[​](#platform-specific-code-patterns "Direct link to Platform-specific code patterns")

For simple platform branching, use runtime detection or conditional compilation. See [Cross-Platform Architecture](/docs/fundamentals/cross-platform-architecture.md) for these patterns.
...
## Accessing native window handles[​](#accessing-native-window-handles "Direct link to Accessing native window handles")
...
Avalonia supports embedding native UI controls within the Avalonia visual tree using [`NativeControlHost`](/api/avalonia/controls/nativecontrolhost.md). This lets you use platform-specific controls (e.g., a native web browser, media player, or map view) inside an Avalonia layout.

### NativeControlHost[​](#nativecontrolhost "Direct link to NativeControlHost")
...
### Limitations of native embedding[​](#limitations-of-native-embedding "Direct link to Limitations of native embedding")
...
## P/Invoke and native libraries[​](#pinvoke-and-native-libraries "Direct link to P/Invoke and native libraries")
...
For Native AOT deployment, use `LibraryImport` instead of `DllImport` to ensure the marshalling code is generated at compile time. See [Native AOT Deployment](/docs/deployment/native-aot.md) for details.

### Loading platform-specific native libraries[​](#loading-platform-specific-native-libraries "Direct link to Loading platform-specific native libraries")
...
## Platform-specific services with dependency injection[​](#platform-specific-services-with-dependency-injection "Direct link to Platform-specific services with dependency injection")
...
See [Dependency Injection](/docs/app-development/dependency-injection.md) for the full setup.

## Using Microsoft.Maui.Essentials[​](#using-microsoftmauiessentials "Direct link to Using Microsoft.Maui.Essentials")
...
## Custom rendering with SkiaSharp[​](#custom-rendering-with-skiasharp "Direct link to Custom rendering with SkiaSharp")
...
* [Cross-Platform Architecture](/docs/fundamentals/cross-platform-architecture.md): Solution structure and platform branching patterns.
* [Platform-Specific .NET](/docs/platform-specific-guides/dotnet.md): Runtime detection and conditional compilation.
* [Dependency Injection](/docs/app-development/dependency-injection.md): Registering platform services.
* [Native AOT Deployment](/docs/deployment/native-aot.md): AOT considerations for native interop.
